...
export const STRINGS = {
  en: {
    ...
    'hero.card.tabBill': 'Estimated bill',
    'hero.card.tabCompare': 'Across India',
    'hero.card.cmpLink': 'Compare all DISCOM rates',
    'hero.card.sub': '250 units · 2 kW · LMV-1 domestic',
    'hero.card.cmpBasis': 'Each state at its own current fuel surcharge',
    ...
    'hero.card.foot': 'Live engine · matched to the paisa on real UPPCL bills',
    'hero.card.cmpTitle': 'What 250 units costs across India',
    'hero.card.up': 'Uttar Pradesh',
    'hero.card.dl': 'Delhi',
    'hero.card.ka': 'Karnataka',
    'hero.card.mh': 'Maharashtra',
    // Calculator form
