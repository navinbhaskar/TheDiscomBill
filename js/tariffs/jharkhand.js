  ...
  discoms: [
    {
      ...
      categories: [
        {
          id: "domestic",
          // Domestic electricity duty: 6% of energy. CEA records duty on the energy charge only for this state.
          ...
          additionalCharges: [{ name: "Electricity Duty", type: "percent_energy", rate: 6 }],
