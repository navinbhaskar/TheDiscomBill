...
export default {
    ...
    'a11y.skipToCalculator': 'கணிப்பானுக்குச் செல்',
    'states.lead': 'உங்கள் மாநிலத்தின் கட்டணப் பக்கத்தைத் திறங்கள் — அடுக்கு விகிதங்கள், நிலையான கட்டணங்கள், ஒவ்வொரு DISCOM — அல்லது <a href="/tariffs/states/">அனைத்து DISCOM-களின் முழு பட்டியலை</a> பாருங்கள்.',
    ...
    'alert.nav.latest': 'சமீபத்திய புதுப்பிப்புகள்',
    'alert.nav.loading': 'ஏற்றுகிறது...',
    'alert.nav.seeAll': 'அனைத்து அலர்ட்களையும் காண்க',
    'alert.nav.openPage': 'அலர்ட்கள் பக்கத்தைத் திற',
    'alert.nav.failed': 'சமீபத்திய அலர்ட்களை ஏற்ற முடியவில்லை. முழுப் பட்டியல் இன்னும் திறக்கும்.',
    'alert.nav.menuLabel': 'சமீபத்திய பொது அலர்ட்கள்',
    'alerts.title': 'மின்சார அலர்ட்கள்',
    'alerts.lead': 'TheDiscomBill-ல் கண்காணிக்கப்படும் ஒவ்வொரு கட்டண ஆணையும் எரிபொருள் கூடுதல் கட்டண அறிவிப்பும், புதியவை முதலில். பொது ஒழுங்குமுறை புதுப்பிப்புகள் மட்டும் — உங்கள் தனிப்பட்ட கணக்கு அறிவிப்புகள் அல்ல.',
    'alerts.filterLabel': 'பொது மின்சார அலர்ட்களை வடிகட்டு',
    'alerts.search': 'தேடு',
    'alerts.searchPh': 'FPPA, டெல்லி, MSEDCL...',
    'alerts.state': 'மாநிலம்',
    'alerts.allStates': 'அனைத்து மாநிலங்கள்',
    'alerts.category': 'வகை',
    'alerts.allCategories': 'அனைத்து வகைகள்',
    'alerts.priority': 'முன்னுரிமை',
    'alerts.all': 'அனைத்தும்',
    'alerts.important': 'முக்கியம்',
    'alerts.info': 'தகவல்',
    'alerts.reset': 'மீட்டமை',
    'alerts.empty': 'இந்த வடிகட்டுகளுக்கு பொருந்தும் அறிவிப்புகள் இல்லை.',
    'alerts.clearFilters': 'வடிகட்டுகளை நீக்கு',
    ...
    'tools.g1.title': 'என் பில் சரியாக உள்ளதா?',
    'tools.g1.sub': 'பில்லைப் பதிவேற்றி உடனே சரிபார்க்கவும், அல்லது தெரியாத எந்தக் கட்டணத்தையும் இங்கே பாருங்கள்.',
    'tools.g2.title': 'செலவு எவ்வளவு ஆகும்?',
    'tools.g2.sub': 'பில் வருவதற்கு முன்பே கணக்கிடுங்கள் — சாதனவாரியாக, கட்டணவாரியாக, அல்லது ஒவ்வொரு குடியிருப்பாளருக்கும்.',
    'tools.g3.title': 'சோலார் பயனுள்ளதா?',
    'tools.g3.sub': 'அமைப்பின் அளவை தீர்மானியுங்கள், மானியத்தைச் சரிபாருங்கள், உங்கள் பில்லில் திரும்பப் பெறும் காலத்தைப் பாருங்கள்.',
    'ql.services': 'சேவைகள்',
    'ql.learn': 'அறிந்துகொள்ள',
    'ql.compare': 'டிஸ்காம் கட்டண ஒப்பீடு',
    'ql.advancedCalc': 'மேம்பட்ட பில் கணிப்பான்',
    ...
    'ql.tenantMeter': 'குடியிருப்பாளர் துணை-மீட்டர் கால்குலேட்டர்',
    'ql.checkBill': 'என் பில்லைச் சரிபார்க்க (பதிவேற்று)',
    'nav.solarSubsidy': 'சோலார் மானிய சரிபார்ப்பு',
    'nav.solarOnGridHybrid': 'ஆன்-கிரிட் vs ஹைப்ரிட் சோலார்',
    ...
    'ql.meterDisplay': 'ஸ்மார்ட் மீட்டர் வழிகாட்டி',
    'ql.billReviewGroup': 'உங்கள் பில்லை ஆய்வு செய்யுங்கள்',
    'ql.ocrCheck': 'உடனடி பில் சுய சரிபார்ப்பு (OCR)',
    'ql.billReview': 'நிபுணர் பில் மதிப்பாய்வு',
    'ql.guides': 'வலைப்பதிவுகள் & கட்டுரைகள்',
    'ql.glossary': 'பில் சொற்களஞ்சியம்',
    'ql.understandBill': 'உங்கள் பில்லைப் புரிந்துகொள்ளுங்கள்',
    'tools.d.understandBill': 'நீங்கள் மாற்றக்கூடிய ஒரு மாதிரி பில்',
    'tools.d.smartMeter': 'ஒவ்வொன்றாகப் பார்க்கக்கூடிய மீட்டர் டிஸ்ப்ளே',
    'tools.d.onGridHybrid': 'அளவு தீர்மானிப்பதற்கு முன் — எந்த அமைப்பு',
    'ql.methodology': 'முறையியல் & துல்லியம்',
    'ql.contact': 'தொடர்பு கொள்ள',
    'ql.privacy': 'தனியுரிமைக் கொள்கை',
    'ql.cookies': 'குக்கீ கொள்கை',
    'ql.install': 'ஆஃப்லைன் ஆப்பை நிறுவுக',
    // /tariffs/ — மாநிலம் & டிஸ்காம் தேர்வுப் பக்கம் (இயக்க நேரத்தில் மொழிபெயர்க்கப்படுகிறது)
    'tariffs.h1': 'மின் கட்டண விகிதங்கள்',
    'tariffs.intro': 'இந்தியாவின் எந்த டிஸ்காமுக்கும் தற்போதைய எனர்ஜி ஸ்லாப், நிலைக் கட்டணம் மற்றும் வரிகளைப் பாருங்கள். உங்கள் மாநிலத்தையும் டிஸ்காமையும் தேர்வு செய்து, நுகர்வோர் பிரிவு வாரியான முழு கட்டணப் பட்டியலைக் காணுங்கள் — எங்கள் பில் கால்குலேட்டர் இயங்குவதும் இதே விகிதங்களில்தான்.',
    'tariffs.state': 'மாநிலம் / யூனியன் பிரதேசம்',
    'tariffs.discom': 'டிஸ்காம்',
    'tariffs.note': 'இந்த விகிதங்கள் பொதுவில் கிடைக்கும் SERC / டிஸ்காம் கட்டண ஆணைகளிலிருந்து தொகுக்கப்பட்டவை, குறிப்புக்காக மட்டுமே. ஒவ்வொரு கட்டண ஆணையிலும் ஸ்லாப், நிலைக் கட்டணம், மின் வரி மற்றும் எரிபொருள் கூடுதல் கட்டணம் (FPPA) மாறும்; உட்பிரிவு, ஃபேஸ் மற்றும் நகரத்திற்கு ஏற்பவும் வேறுபடலாம். உங்கள் அதிகாரப்பூர்வ பில் அல்லது டிஸ்காம் இணையதளத்தில் உறுதிப்படுத்திய பிறகு, சரியான தொகைக்கு <a href="/#calculator">பில் கால்குலேட்டரை</a> பயன்படுத்துங்கள்.',
    ...
    'footer.newConnection': 'புதிய இணைப்பு',
    ...
    'hero.sub': 'உங்கள் பில் எவ்வளவு வர வேண்டும், அதில் ஒவ்வொரு கட்டணத்தின் பொருள் என்ன, உங்கள் பில் சரியாக உள்ளதா.',
    'hero.cta': 'என் பில்லைக் கணக்கிடு',
    'hero.cta2': 'என் பில்லில் பிழை உள்ளதா?',
    ...
    'hero.stat.records': 'கட்டணப் பதிவுகள்',
    ...
    'states.region.north': 'வட இந்தியா',
    'states.region.south': 'தென் இந்தியா',
    'states.region.west': 'மேற்கு இந்தியா',
    'states.region.central': 'மத்திய இந்தியா',
    'states.region.east': 'கிழக்கு இந்தியா',
    'states.region.northeast': 'வடகிழக்கு இந்தியா',
    'states.discom': 'DISCOM',
    'states.discoms': 'DISCOM-கள்',
    'states.perUnit': '/யூனிட்',
    'trust.title': 'உங்கள் நம்பகமான மின் கட்டண கால்குலேட்டர்',
    'trust.orders': 'கட்டணங்கள் வெளியிடப்பட்ட SERC கட்டண ஆணைகளிலிருந்து — <a href="/orders/">ஒவ்வொரு ஆதாரமும் பட்டியலிடப்பட்டுள்ளது</a>',
    'trust.free': 'பயன்படுத்த இலவசம் — ஒவ்வொரு கால்குலேட்டரும் கணக்கு இன்றி இயங்கும்',
    'trust.local': 'உங்கள் கட்டணம் உங்கள் உலாவியிலேயே கணக்கிடப்படுகிறது; படம் நீங்கள் அனுமதித்தால் மட்டுமே OCR-க்கு அனுப்பப்படும்',
    'cap.title': 'பில்லில் உள்ள ஒவ்வொரு கட்டணமும் கணக்கில்',
    'discoms.popular': 'முக்கிய டிஸ்காம்கள்',
    'discoms.viewAll': 'அனைத்து 65-ஐயும் காண →',
    'hero.trust1': 'ஒவ்வொரு கட்டண அடுக்கும் SERC & DISCOM ஆணைகளுடன் சரிபார்க்கப்பட்டது — ஒவ்வொரு பக்கமும் அதன் கட்டண ஆண்டையும் சரிபார்ப்புத் தேதியையும் காட்டுகிறது',
    // Hero sample-bill cards
    'hero.card.cmpLink': 'கட்டணங்கள்',
    'hero.card.energy': 'மின்சக்தி கட்டணம்',
    'hero.card.fixed': 'நிலைக் கட்டணம்',
    'hero.card.duty': 'மின் வரி',
    'hero.card.credit': 'FPPA கிரெடிட்',
    'hero.card.ppac': 'எரிபொருள் கூடுதல் கட்டணம் (PPAC)',
    'hero.card.fac': 'எரிபொருள் கூடுதல் கட்டணம் (FAC)',
    'hero.card.wheeling': 'வீலிங் கட்டணம்',
    'hero.card.none': 'அறிவிக்கப்படவில்லை',
    'hero.card.noneLevied': 'விதிக்கப்படவில்லை',
    'hero.card.rounding': 'முழுமையாக்கல்',
    'hero.card.totalPayable': 'மொத்தத் தொகை',
    'hero.card.foot': 'லைவ் இன்ஜின் · நேரடியாக கட்டண ஆணையிலிருந்து',
    'hero.card.sub0': '250 யூனிட் · 2 kW · LMV-1 வீட்டு',
    'hero.card.sub1': '250 யூனிட் · 2 kW · LT-I வீட்டு',
    'hero.card.sub2': '250 யூனிட் · 2 kW · LT-1 வீட்டு',
    'hero.card.sub3': '250 யூனிட் · 2 kW · LT-I(B) குடியிருப்பு',
    'hero.card.sub4': '250 யூனிட் · 2 kW · LT-IA வீட்டு',
    'hero.card.note0': 'உ.பி.-ன் எரிபொருள் கட்டணம் மாதாந்திரம் — ஜூலை 2026-ல் கிரெடிட்.',
    'hero.card.note1': 'டெல்லியின் PPAC ஜூன் 2026 முதல் மாதாந்திரம் — BRPL-ன் 17.94%.',
    'hero.card.tax': 'மின் வரி',
    'hero.card.note2': 'கர்நாடகாவில் ஒரே வீட்டுக் கட்டணம், தனி எரிபொருள் வரி இல்லை — ஆனால் மின் வரி தனியாக வசூலிக்கப்படுகிறது.',
    'hero.card.note3': '16% வரியும் வீலிங்கும் — ஐந்திலும் இதுவே அதிகம்.',
    'hero.card.note4': 'தமிழ்நாடு LT-IA வீடுகளுக்கு நிலைக் கட்டணம் இல்லை, வீட்டு உபயோகத்திற்கு மின் வரியும் இல்லை.',
    // Calculator form
    ...
    'label.purpose': 'இணைப்பு எதற்காக?',
    'purpose.home': 'வீடு',
    'purpose.business': 'கடை / வணிகம்',
    ...
    'small.sanctioned': 'உங்கள் பழைய பில்லின் மேல் வலது பக்கத்தில் <strong>“Connected / Sanctioned Load”</strong> பாருங்கள். இந்த வரம்பை மீறினால் உ.பி., டெல்லி, மகாராஷ்டிரா போன்ற மாநிலங்களில் கூடுதல்-தேவை அபராதம் விதிக்கப்படும்.',
    ...
    'adv.title': 'மேம்பட்ட பில்லிங் விருப்பங்கள்',
    ...
    'sol.advanced': 'அனுமானங்கள்',
    'sol.cost': 'அமைப்பின் விலை (₹ / kW)',
    'sol.costHint': 'மானியத்திற்கு முந்தைய முழு நிறுவல் விலை. பொதுவாக ₹50,000–65,000/kW.',
    'sol.empty': 'உங்கள் சோலார் மதிப்பீட்டைக் காண மாதாந்திர மின் கட்டணத்தை உள்ளிடுங்கள்.',
    'sol.heroLabel': '25 ஆண்டுகளில் நிகர சேமிப்பு',
    'sol.heroSystem': 'அமைப்பு',
    'sol.monthlyHint': 'தெரிந்தால் இங்கே உள்ளிடுங்கள் — பில்லிலிருந்து கணக்கிட்ட எண்ணை இது மாற்றும்.',
    'sol.paysFor': 'முதலீடு திரும்பும் காலம்',
    'sol.gen': 'ஆண்டு மின் உற்பத்தி (யூனிட்)',
    'sol.grossCost': 'ஆரம்ப செலவு',
    'sol.centralSub': 'PM சூர்ய கர் மானியம்',
    'sol.stateSub2': 'மாநில மானியம்',
    'sol.netCost': 'உங்களுக்கான நிகர விலை',
    'sol.monthlySave': 'ஆண்டு சேமிப்பு',
    'sol.payback': 'முதலீடு திரும்பும் காலம்',
    'sol.lifetime': '25 ஆண்டுகளில் நிகர சேமிப்பு',
    'sol.co2': 'தவிர்க்கப்படும் CO₂',
    'nav.solar': 'சோலார்',
    'nav.solarSavings': 'கூரை சோலார் சேமிப்பு கணிப்பான்',
    'nav.solarSize': 'சோலார் பேனல் அளவு கணிப்பான்',
    'nav.solarBattery': 'சோலார் பேட்டரி பேக்அப் கணிப்பான்',
    'sol.projTitle': 'ஆண்டுவாரியான சேமிப்பு கணிப்பு',
    'sol.projYear': 'ஆண்டு',
    'sol.projAnnual': 'ஆண்டு சேமிப்பு',
    'sol.projCumul': 'மொத்த சேமிப்பு',
    'sol.projNet': 'நிகர நிலை',
    'sol.projStatus': 'நிலை',
    'sol.projNote': 'மின் கட்டணம் ஆண்டுக்கு ~5% உயரும், பேனல் உற்பத்தி ஆண்டுக்கு ~0.7% குறையும் என்ற அனுமானத்தில் — எனவே மேலே உள்ள நேரடி எண்கள் சற்று கவனமான மதிப்பீடுகள். நிகர நிலை = மொத்த சேமிப்பு − மானியத்திற்குப் பிந்தைய நிகர சிஸ்டம் செலவு.',
    ...
    'btn.clear': '<svg class="br-ic" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M3 12a9 9 0 1 0 9-9 9.75 9.75 0 0 0-6.74 2.74L3 8"/><path d="M3 3v5h5"/></svg> அழித்து மீட்டமை',
    ...
    'about.p1b': 'கால்குலேட்டரைத் தாண்டி, <a href="/tariffs/">ஒவ்வொரு மாநிலத்தின் தற்போதைய கட்டண விகிதங்கள்</a>, <a href="/smart-meter/">ஸ்மார்ட் மீட்டர் படிக்கும் வழிகாட்டி</a>, <a href="/check-my-bill/">பில் புகைப்படத்திலிருந்து உடனடி சரிபார்ப்பு</a>, மேலும் <a href="/solar-calculator/">கூரை சோலார்</a>, <a href="/ev-charging-calculator/">EV சார்ஜிங்</a> கால்குலேட்டர்கள் — அனைத்தும் இலவசம், ஆங்கிலம், இந்தி, மராத்தி, தமிழில்.',
    ...
    'about.stat.languages': 'மொழிகள்',
    'about.howTitle': 'கால்குலேட்டர் எவ்வாறு செயல்படுகிறது',
    ...
    'about.disclaimer': '<strong>⚠ மதிப்பீடு, பில் அல்ல:</strong> உங்கள் மாநில மின்சார ஒழுங்குமுறை ஆணையம் வெளியிட்ட கட்டண ஆணையை, உங்கள் டிஸ்காம் பயன்படுத்தும் அதே ஸ்லாப் அடிப்படை முறையில் TheDiscomBill கணக்கிடுகிறது; எங்கள் கணக்கீடு இயந்திரம் உண்மையான நுகர்வோர் பில்களுடன் சரிபார்க்கப்படுகிறது — ஆதாரங்களுக்கும் சரிபார்ப்புக்கும் <a href="/methodology/">முறையியல் &amp; துல்லியம்</a> பக்கத்தைப் பாருங்கள். இருப்பினும், உங்கள் இணைப்புக்கே உரிய விவரங்கள் இதற்குத் தெரியாது: மீட்டர் ரீடிங் தேதிகள், பில்லிங் காலம், நிலுவைத் தொகை, முந்தைய சரிசெய்தல்கள், வைப்புத் தொகை வட்டி, சலுகைகள் அல்லது உள்ளூர் கூடுதல் கட்டணங்கள் — எனவே டிஸ்காமின் தொகை வேறுபடலாம். சில ரூபாய் வித்தியாசம் ரவுண்டிங்; பெரிய வித்தியாசம் கேட்கப்பட வேண்டியது, <a href="/ta/guides/bill-wrong-how-to-complain-and-win/">புகார் அளிப்பது எப்படி என்பதை இந்த வழிகாட்டி விளக்குகிறது</a>. புதிய கட்டண ஆணைகள் வரும்போது விகிதங்கள் புதுப்பிக்கப்படுகின்றன; அதிகாரப்பூர்வ பில் உங்கள் டிஸ்காமுடையதே. TheDiscomBill சுயேச்சையானது; எந்த மின் நிறுவனத்துடனோ அரசு அமைப்புடனோ இணைந்தது அல்ல.',
    // Breadcrumb (shared)
    'bc.home': 'முகப்பு',
    'bc.compare': 'கட்டண ஒப்பீடு',
    ...
    'cmp.h2': 'மின்சார கட்டண ஒப்பீடு {year} (முக்கிய நிறுவனங்கள்)',
    ...
    'cmp.cc.sub': 'மேலே உள்ள அட்டவணை 1 kW-இல் ஒரு வழக்கமான மாதத்தை அனுமானிக்கிறது. எந்த இரு விநியோகஸ்தர்களையும் தேர்ந்தெடுத்து — பெரியவை மட்டுமல்ல — முழு விவரத்துடன் சம அடிப்படையில் பில் மதிப்பீட்டுக்கு உங்கள் பயன்பாடு மற்றும் சுமையை உள்ளிடுங்கள்.',
    ...
    'meth.s1.p2': 'புதிய ஆணை அல்லது FPPA சுற்றறிக்கை வெளியானதும், கருவியின் தொடர்புடைய விகிதங்கள் அதற்கேற்ப புதுப்பிக்கப்படும். ஒழுங்குமுறை ஆணையங்கள் ஒரே நாட்காட்டியில் திருத்துவதில்லை என்பதால் கட்டண ஆண்டுகள் மாநிலவாரியாக வேறுபடும்: ஒவ்வொரு DISCOM பக்கமும் அந்த நிறுவனத்திற்கு <strong>அமலில் உள்ள கட்டண ஆண்டையும்</strong> நாங்கள் கடைசியாகச் சரிபார்த்த தேதியையும் காட்டுகிறது; <a href="/database/">கட்டணத் தரவுத்தளம்</a> அனைத்தையும் ஒருங்கே பட்டியலிடுகிறது. FPPA தனியாக மாதந்தோறும் புதுப்பிக்கப்படுகிறது.',
    ...
    'ev.title': 'EV சார்ஜிங் செலவு கணிப்பான்',
    'ev.intro': 'வீட்டில் EV சார்ஜ் செய்வதற்கு <strong>உண்மையில்</strong> எவ்வளவு செலவாகிறது? உங்கள் வாகனத்தைத் தேர்ந்தெடுத்து, மாதாந்திர கிமீ மற்றும் உங்கள் கட்டணத்தை உள்ளிடுங்கள் — ஒரு சார்ஜுக்கான செலவு, கிமீக்கான செலவு, மாதாந்திர சார்ஜிங் பில் மற்றும் பெட்ரோலுடன் ஒப்பிடும்போது சரியாக எவ்வளவு மிச்சம் என்பதைப் பாருங்கள்.',
    'ev.chip1': 'உண்மையான சார்ஜிங் இழப்பு சேர்த்து',
    'ev.chip2': 'பெட்ரோல் ஒப்பீடு உள்ளடக்கம்',
    'ev.chip3': 'இலவசம் · பதிவு தேவையில்லை',
    'ev.select': 'உங்கள் EV',
    'ev.battery': 'பேட்டரி (kWh)',
    'ev.range': 'நிஜ உலக ரேஞ்ச் (கிமீ)',
    'ev.km': 'மாதம் ஓட்டும் தூரம் (கிமீ)',
    'ev.rate': 'உங்கள் கட்டணம் (₹/யூனிட்)',
    'ev.rateLink': 'உங்கள் DISCOM கட்டணத்தைக் காண →',
    'ev.advanced': 'மேம்பட்டவை',
    'ev.loss': 'சார்ஜிங் இழப்பு (%)',
    'ev.lossHint': 'AC சார்ஜிங்கில் ~8–12% வெப்பமாக வீணாகிறது; அதற்கும் நீங்கள்தான் கட்டணம் செலுத்துகிறீர்கள்.',
    'ev.publicRate': 'பொது DC கட்டணம் (₹/யூனிட்)',
    'ev.petrol': 'பெட்ரோல் விலை (₹/லிட்டர்)',
    'ev.mileage': 'பெட்ரோல் மைலேஜ் (கிமீ/லிட்டர்)',
    'ev.rCng': 'அதே கிமீக்கு CNG',
    'ev.cngMileage': 'CNG மைலேஜ் (கிமீ/கிலோ)',
    'ev.cngHint': 'நகரத்துக்கு நகரம் பெரிதும் மாறும் — உங்கள் பம்பில் சரிபார்க்கவும். CNG-ஐ மறைக்க 0 என அமைக்கவும்.',
    'ev.cng': 'CNG விலை (₹/கிலோ)',
    'ev.empty': 'சார்ஜிங் செலவைப் பார்க்க ஒரு EV-ஐத் தேர்ந்தெடுத்து மாதாந்திர கிமீ-ஐ உள்ளிடுங்கள்.',
    'ev.heroLabel': 'உங்கள் EV இயக்கச் செலவு',
    'ev.perKmUnit': ' ஒரு கிமீக்கு',
    'ev.vsPetrol': 'பெட்ரோலுடன் ஒப்பிட',
    'ev.rCharge': 'ஒரு சார்ஜுக்கான செலவு',
    'ev.depth': 'வழக்கமான சார்ஜ் அளவு',
    'ev.rRange100': '₹100 சார்ஜிங்கில் ரேஞ்ச்',
    'ev.rUnits': 'பில்லில் கூடும் யூனிட்கள்',
    'ev.rMonthly': 'மாதாந்திர சார்ஜிங் செலவு',
    'ev.rPetrol': 'அதே கிமீக்கு பெட்ரோல்',
    'ev.rSaveMo': 'பெட்ரோலுடன் ஒப்பிட மிச்சம்',
    'ev.rSaveYr': 'ஆண்டு மிச்சம்',
    'ev.rTime33': 'சார்ஜ் நேரம் · 15A சாக்கெட் (3.3 kW)',
    'ev.rTime72': 'சார்ஜ் நேரம் · வால்பாக்ஸ் (7.2 kW)',
    'ev.rPublic': 'பொது DC விரைவு சார்ஜிங்',
    'ev.chartTitle': 'மாதாந்திர செலவு ஒப்பீடு',
    'ev.share': 'இந்த மதிப்பீட்டை WhatsApp-இல் பகிரவும்',
    'ev.note': 'வீட்டுச் சார்ஜிங் உங்கள் வீட்டு அடுக்கு கட்டணத்தில்தான் பில் ஆகும் — EV யூனிட்கள் உங்கள் வழக்கமான பயன்பாட்டுக்கு <em>மேல்</em> சேர்வதால், துல்லியத்திற்கு உங்கள் மேல் அடுக்கு விகிதத்தைப் பயன்படுத்துங்கள் (எங்கள் <a href="/tariffs/states/">கட்டணப் பக்கங்களில்</a> உள்ளது). டெல்லி, மகாராஷ்டிரா, கர்நாடகா, உத்தரப் பிரதேசம் உள்ளிட்ட சில மாநிலங்களில் தனி EV-சார்ஜிங் வகைகள் அல்லது இரவு நேர அடிப்படையிலான தள்ளுபடிகள் உள்ளன, அவை கட்டணத்தை மேலும் குறைக்கும். 7.2 kW வால்பாக்ஸ் பொருத்த பொதுவாக DISCOM-இடமிருந்து அனுமதிக்கப்பட்ட சுமையை உயர்த்த வேண்டும் — பொருத்தும் முன் சரிபார்க்கவும். ஒரு சார்ஜுக்கான செலவும் நேரமும் நீங்கள் தேர்ந்தெடுத்த சார்ஜ் அளவைப் பொறுத்தது (பேட்டரி ஆரோக்கியத்திற்காக பெரும்பாலானோர் 80% அருகில் நிறுத்துகிறார்கள்); மாதாந்திர செலவு நீங்கள் ஓட்டும் தூரத்தைப் பொறுத்தது, எனவே ஸ்லைடர் அதை மாற்றாது.',
};
