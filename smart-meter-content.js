...
export const SMG = {
  ...
  cards: {
    calc: {
      icon: 'calc', t: { en: 'Work out what that should cost', hi: 'इसकी कीमत कितनी बनती है', mr: 'याची किंमत किती होते', ta: 'இதன் விலை என்ன' },
    ...
    check: {
      icon: 'doc', t: { en: 'Check the bill you were sent', hi: 'आपको मिला बिल जाँचिए', mr: 'तुम्हाला आलेले बिल तपासा', ta: 'வந்த பில்லைச் சரிபாருங்கள்' },
    ...
    recharge: {
      icon: 'cash', t: { en: 'Recharge and balance, by DISCOM', hi: 'रिचार्ज और बैलेंस, डिस्कॉम के अनुसार', mr: 'रिचार्ज आणि बॅलन्स, डिस्कॉमनुसार', ta: 'ரீசார்ஜ், பேலன்ஸ் — DISCOM வாரியாக' },
  ...
  wrongCards: [
    { href: '%GUIDES%smart-meter-running-fast/', icon: 'trend',
    ...
    { href: '%GUIDES%smart-meter-recharge-failed/', icon: 'cash',
    ...
    { href: '%GUIDES%smart-meter-prepaid-disconnection/', icon: 'plug',
    ...
    { href: '%GUIDES%smart-meter-balance-check/', icon: 'gauge',
