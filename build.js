...
const assets = [
  ...
  'compare', 'electricity-cost-calculator', 'solar-calculator', 'tariffs', 'guides', 'glossary', 'methodology', 'services', 'bill-check', 'bill-review', 'expert', 'admin', 'login', 'my-bills', 'new-connection', 'complaint', 'sanctioned-load-optimizer', 'solar-subsidy-checker', 'tenant-submeter-calculator', 'check-my-bill', 'tenant-submeter-calculator',
