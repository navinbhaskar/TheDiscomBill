...
export const GUIDES = [
  ...
  },
  {
    ...
    `,
    titleHi: 'PM सूर्य घर: आवेदन किस वजह से अटकता है',
    metaTitleHi: 'PM सूर्य घर पात्रता — स्वीकृत भार, नाम मिलान और उनका समाधान',
    descriptionHi: 'सब्सिडी की गणना से पहले जो जाँचें आपका PM सूर्य घर आवेदन तय करती हैं: प्लांट के आकार के मुक़ाबले स्वीकृत भार, कनेक्शन पर दर्ज नाम, स्वामित्व और मीटर की स्थिति — और हर एक को ठीक करने वाला डिस्कॉम अनुरोध।',
    introHi: `<strong>PM सूर्य घर</strong> पर ज़्यादातर गाइड सब्सिडी समझाती हैं। जो जाँचें सब्सिडी की
      गणना से <em>पहले</em> होती हैं, उन्हें लगभग कोई नहीं समझाता — और आवेदन असल में वहीं अटकते हैं।
      दो वजहें सबसे आम हैं: आपका <strong>स्वीकृत भार कम से कम उतना होना चाहिए जितना बड़ा प्लांट</strong>
      आप लगवा रहे हैं, और <strong>बिजली कनेक्शन पर दर्ज नाम</strong> उस नाम से मिलना चाहिए जिससे आप
      आवेदन और बैंकिंग कर रहे हैं। दोनों ठीक हो सकते हैं, दोनों सोलर पोर्टल पर नहीं बल्कि आपके डिस्कॉम
      में ठीक होते हैं, और आवेदन से पहले ठीक कराना बाद में कराने से कहीं सस्ता पड़ता है।`,
    sectionsHi: `
      <section class="seo-section">
        <h2>जाँचें, उसी क्रम में जिसमें वे अटकाती हैं</h2>
        <div class="comparison-table-wrapper"><table class="comparison-table">
          <thead><tr><th>जाँच</th><th>इसका मतलब</th><th>कहाँ ठीक होगी</th></tr></thead>
          <tbody>
            <tr><td><strong>स्वीकृत भार ≥ प्लांट आकार</strong></td><td>3 kW के प्लांट के लिए आम तौर पर कनेक्शन पर कम से कम 3 kW स्वीकृत भार चाहिए।</td><td>डिस्कॉम — भार वृद्धि</td></tr>
            <tr><td><strong>नाम मिलान</strong></td><td>कनेक्शन पर दर्ज उपभोक्ता का नाम आपकी पहचान और बैंक रिकॉर्ड से मिलना चाहिए — वर्तनी सहित।</td><td>डिस्कॉम — नाम परिवर्तन</td></tr>
            <tr><td><strong>उपभोक्ता आप ही हैं</strong></td><td>कनेक्शन अब भी पिछले मालिक या किसी रिश्तेदार के नाम है, तो उस पर आवेदन आपका नहीं बनता।</td><td>डिस्कॉम — कनेक्शन हस्तांतरण</td></tr>
            <tr><td><strong>चालू, नियमित कनेक्शन</strong></td><td>घरेलू कनेक्शन ठीक स्थिति में हो — कटा हुआ न हो और बकाया न हो।</td><td>डिस्कॉम — पहले बकाया चुकाएँ</td></tr>
            <tr><td><strong>छत आपके नियंत्रण में</strong></td><td>जिस छत पर प्लांट लगेगा, उसका स्वामित्व या लिखित अनुमति।</td><td>सोसाइटी / मालिक की NOC</td></tr>
          </tbody>
        </table></div>
        <p class="fs-legend">सटीक शब्दावली राज्य के अनुसार बदलती है और आपका डिस्कॉम तय करता है, हम नहीं।
        इसे जाँच का स्वरूप मानिए — अंतिम सूची वही है जो आवेदन के समय आपका डिस्कॉम दिखाता है।</p>
      </section>

      <section class="seo-section">
        <h2>प्लांट के मुक़ाबले स्वीकृत भार — और इसे ठीक कराने की क़ीमत</h2>
        <p>यही जाँच लोगों को सबसे ज़्यादा चौंकाती है, क्योंकि पैनल ख़रीदने में कहीं नहीं लगता कि आपका
        बिजली अनुबंध भी इसमें शामिल है। तर्क सीधा है: छत का प्लांट अपनी पूरी रेटेड बिजली आपके कनेक्शन
        से वापस भेज सकता है, इसलिए कनेक्शन कम से कम उतने का अनुबंधित होना चाहिए।</p>
        <p>भार कम पड़ रहा हो तो उपाय है डिस्कॉम में <strong>भार वृद्धि</strong> का अनुरोध। यह सामान्य
        प्रक्रिया है। मुफ़्त नहीं है — और यही हिस्सा तय करने से पहले देख लेना चाहिए, क्योंकि बढ़ा हुआ
        फिक्स्ड शुल्क <em>हर महीने, स्थायी रूप से</em> लगता है:</p>
        {{SOLAR_LOAD_TABLE}}
        <p>एक दूसरा खर्च बाद में अलग से आता है: ऊँचा स्वीकृत भार आपकी <strong>सुरक्षा जमा</strong> भी
        बढ़ा देता है, और अंतर किसी अगले बिल में एकमुश्त माँगा जाता है। सिर्फ़ अंतर देना होता है, पूरी
        राशि दोबारा नहीं — बिना जाँचे माँग चुकाने से पहले
        <a href="/guides/electricity-security-deposit-explained/">सुरक्षा जमा कैसे काम करती है</a> पढ़िए।</p>
      </section>

      <section class="seo-section">
        <h2>नाम बिल्कुल मिलना चाहिए</h2>
        <p>सब्सिडी एक बैंक खाते में जाती है, एक आवेदन के बदले, एक बिजली कनेक्शन के बदले। ये तीनों नाम
        मिलाए जाते हैं, और मेल न खाना फ़ाइल अटकने की सबसे आम वजहों में है: बैंक में पूरा नाम और कनेक्शन
        पर सिर्फ़ अक्षर, विवाह से पहले का नाम, एक अक्षर की अलग वर्तनी, या कनेक्शन अब भी माता-पिता के नाम।</p>
        <p>यहाँ दो अलग समस्याएँ छिपी हैं और दोनों के अनुरोध अलग हैं:</p>
        <ul>
          <li><strong>व्यक्ति वही, वर्तनी ग़लत</strong> — कनेक्शन पर <strong>नाम सुधार</strong>। आम तौर
          पर हल्की प्रक्रिया।</li>
          <li><strong>व्यक्ति अलग</strong> — कनेक्शन का आपके नाम <strong>हस्तांतरण</strong>। यह भारी
          प्रक्रिया है और इसमें सुरक्षा जमा भी दोबारा तय होती है, इसलिए जल्दी शुरू कीजिए।</li>
        </ul>
        <p>कुछ भी करने से पहले अपने ताज़ा बिल की वर्तनी बैंक पासबुक से मिलाइए। इसमें कोई खर्च नहीं और
        टाली जा सकने वाली अस्वीकृति की यह सबसे आम वजह है।</p>
      </section>

      <section class="seo-section">
        <h2>आपसे क्या माँगा जाएगा</h2>
        <p>दस्तावेज़ों की सूची हर डिस्कॉम तय करता है और बदलती रहती है; आपके डिस्कॉम का अपना पोर्टल ही
        अंतिम सूची है। लगभग हर जगह जो माँगा जाता है वह चार समूहों में आता है:</p>
        <ul>
          <li><strong>पहचान</strong> — आवेदक का सरकारी पहचान दस्तावेज़।</li>
          <li><strong>कनेक्शन</strong> — हाल का बिजली बिल, जिस पर उपभोक्ता संख्या, स्वीकृत भार और वह
          नाम होता है जिसे मिलना है।</li>
          <li><strong>परिसर</strong> — स्वामित्व प्रमाण, या मालिक न होने पर छत के उपयोग की अनुमति।</li>
          <li><strong>बैंक खाता</strong> — सब्सिडी अंतरण के लिए, उसी नाम से।</li>
        </ul>
        <p>जो कोई आपसे संपर्क करके "सब्सिडी पास करा देंगे" कहे, उसे दस्तावेज़ मत भेजिए। सब्सिडी
        आधिकारिक प्रक्रिया से आपके ही खाते में आती है, और विक्रेताओं की सूची राष्ट्रीय पोर्टल पर
        प्रकाशित है।</p>
      </section>

      <section class="seo-section">
        <h2>पहले डिस्कॉम में ठीक कराइए, फिर आवेदन कीजिए</h2>
        <p>ऊपर के तीनों उपाय — भार वृद्धि, नाम सुधार, कनेक्शन हस्तांतरण — डिस्कॉम के अनुरोध हैं, सोलर
        पोर्टल के नहीं। अपना राज्य और डिस्कॉम चुनकर सीधे उसके आधिकारिक पोर्टल पर जाइए:</p>
        <p class="seo-cta-row"><a class="seo-cta" href="/services/">मेरे डिस्कॉम की सेवाएँ खोलें</a></p>
        <p>सबसे कम समय लगने वाला क्रम: बिल पर नाम जाँचिए, चाहे गए प्लांट के मुक़ाबले स्वीकृत भार जाँचिए,
        ज़रूरी अनुरोध लगाइए, और उसके बाद ही सोलर आवेदन शुरू कीजिए। उल्टा करने का मतलब है एक ऐसा आवेदन
        जो उस डिस्कॉम प्रक्रिया का इंतज़ार कर रहा है जो शुरू ही नहीं हुई।</p>
      </section>

      <section class="seo-section">
        <h2>फिर देखिए कि यह फ़ायदे का सौदा है या नहीं</h2>
        <p>पात्रता एक द्वार है, कारण नहीं। जब पता चल जाए कि आप आवेदन कर सकते हैं, तब असली सवाल ये हैं
        कि आपकी छत और खपत कितना बड़ा प्लांट सही ठहराती है, और सब्सिडी के बाद आपको कितना देना पड़ेगा:</p>
        <div class="seo-link-grid">
          <a class="seo-link-card" data-icon="sun" href="/solar-subsidy-checker/"><strong>सब्सिडी और पेबैक</strong><span>सब्सिडी के बाद प्लांट की लागत, और पैसा वापस आने में कितना समय</span></a>
          <a class="seo-link-card" data-icon="calc" href="/solar-panel-size-calculator/"><strong>कितना बड़ा चाहिए?</strong><span>जितना उत्पादन चाहिए उसके लिए पैनल संख्या और छत का क्षेत्रफल</span></a>
          <a class="seo-link-card" data-icon="gauge" href="/sanctioned-load-optimizer/"><strong>मेरा भार सही है?</strong><span>स्वीकृत भार की तुलना उस मांग से जो असल में दर्ज होती है</span></a>
        </div>
      </section>
    `,
    faqsHi: [
      { q: 'क्या मेरा स्वीकृत भार सोलर पैनल के आकार जितना होना ज़रूरी है?',
        a: 'आम तौर पर स्वीकृत भार कम से कम प्लांट की क्षमता जितना होना चाहिए — 2 kW पर स्वीकृत कनेक्शन पर 3 kW का सिस्टम लगवाने के लिए पहले भार वृद्धि करानी होगी। यह शर्त आपका डिस्कॉम तय करता है, और भार वृद्धि सामान्य प्रक्रिया है, लेकिन उसके बाद बढ़ा हुआ फिक्स्ड शुल्क स्थायी होता है और हर महीने लगता है।' },
      { q: 'बिजली बिल का नाम बैंक खाते से न मिले तो क्या होता है?',
        a: 'यह आवेदन अटकने की सबसे आम वजहों में है, क्योंकि सब्सिडी उसी बैंक खाते में जाती है जिसका मिलान कनेक्शन से होता है। व्यक्ति वही हो और सिर्फ़ वर्तनी अलग हो तो डिस्कॉम से नाम सुधार कराइए। कनेक्शन किसी और के नाम हो तो कनेक्शन हस्तांतरण चाहिए, जिसमें ज़्यादा समय लगता है और सुरक्षा जमा भी दोबारा तय होती है — इसे जल्दी शुरू कीजिए।' },
      { q: 'क्या भार बढ़ाने से बिल बढ़ेगा, जबकि बिजली मैं खुद बना रहा हूँ?',
        a: 'हाँ। फिक्स्ड शुल्क स्वीकृत भार पर लगता है, चाहे आप कितनी भी खपत या उत्पादन करें — इसलिए यह सबसे अच्छे उत्पादन वाले महीनों में भी लगेगा। भार बढ़ाने से पहले मासिक बढ़ोतरी निकाल लीजिए, और भार उतना ही रखिए जितना प्लांट के लिए वाक़ई ज़रूरी है।' },
      { q: 'क्या भार वृद्धि पर सुरक्षा जमा दोबारा पूरी देनी होती है?',
        a: 'नहीं — सिर्फ़ नई ज़रूरी जमा और आपकी मौजूदा जमा का अंतर। पूरी नई राशि की माँग आए तो उसे लिखित में चुनौती देना बनता है।' },
      { q: 'क्या किराए के मकान में रहते हुए PM सूर्य घर के लिए आवेदन कर सकते हैं?',
        a: 'आवेदक को बिजली उपभोक्ता होना चाहिए और छत उसके नियंत्रण में होनी चाहिए, इसलिए मकान-मालिक के नाम वाले कनेक्शन पर किरायेदार आम तौर पर आवेदन नहीं कर सकता। जहाँ व्यवस्था वाक़ई आपकी है, वहाँ पहले कनेक्शन आपके नाम कराना होगा, साथ में छत के उपयोग की मालिक से अनुमति।' },
      { q: 'ये चीज़ें आवेदन से पहले ठीक करूँ या बाद में?',
        a: 'पहले। भार वृद्धि, नाम सुधार और हस्तांतरण — तीनों डिस्कॉम प्रक्रियाएँ हैं और तीनों की अपनी समय-सीमा है; इनमें से किसी का इंतज़ार कर रहा आवेदन बस इंतज़ार ही कर रहा होता है। ताज़ा बिल पर नाम और चाहे गए प्लांट के मुक़ाबले स्वीकृत भार जाँचने में कोई खर्च नहीं और एक मिनट लगता है।' }
    ],
    titleMr: 'PM सूर्य घर: अर्ज कशामुळे अडतो',
    metaTitleMr: 'PM सूर्य घर पात्रता — मंजूर भार, नाव जुळणी आणि उपाय',
    descriptionMr: 'सबसिडीची गणना होण्याआधीच तुमचा PM सूर्य घर अर्ज ठरवणाऱ्या तपासण्या: प्लांटच्या आकाराच्या तुलनेत मंजूर भार, कनेक्शनवरील नाव, मालकी आणि मीटरची स्थिती — आणि प्रत्येक गोष्ट दुरुस्त करणारी डिस्कॉम विनंती.',
    introMr: `<strong>PM सूर्य घर</strong>वरील बहुतेक मार्गदर्शक सबसिडी समजावतात. सबसिडीची गणना
      होण्या<em>आधी</em> ज्या तपासण्या होतात, त्या जवळपास कोणीच समजावत नाही — आणि अर्ज खरे तर तिथेच
      अडतात. दोन कारणे सर्वात सामान्य आहेत: तुमचा <strong>मंजूर भार किमान तुम्ही बसवत असलेल्या
      प्लांटएवढा</strong> हवा, आणि <strong>वीज कनेक्शनवरील नाव</strong> तुम्ही ज्या नावाने अर्ज व
      बँकिंग करत आहात त्याच्याशी जुळायला हवे. दोन्ही दुरुस्त होऊ शकतात, दोन्ही सोलर पोर्टलवर नव्हे तर
      तुमच्या डिस्कॉममध्ये दुरुस्त होतात, आणि अर्जाआधी दुरुस्त करणे नंतरपेक्षा खूपच स्वस्त पडते.`,
    sectionsMr: `
      <section class="seo-section">
        <h2>तपासण्या, त्या ज्या क्रमाने अडवतात त्याच क्रमाने</h2>
        <div class="comparison-table-wrapper"><table class="comparison-table">
          <thead><tr><th>तपासणी</th><th>याचा अर्थ</th><th>कुठे दुरुस्त होते</th></tr></thead>
          <tbody>
            <tr><td><strong>मंजूर भार ≥ प्लांट आकार</strong></td><td>3 kW प्लांटसाठी साधारणपणे कनेक्शनवर किमान 3 kW मंजूर भार लागतो.</td><td>डिस्कॉम — भारवाढ</td></tr>
            <tr><td><strong>नाव जुळणी</strong></td><td>कनेक्शनवरील ग्राहकाचे नाव तुमच्या ओळखपत्र व बँक नोंदींशी जुळायला हवे — स्पेलिंगसह.</td><td>डिस्कॉम — नाव बदल</td></tr>
            <tr><td><strong>ग्राहक तुम्हीच आहात</strong></td><td>कनेक्शन अजूनही आधीच्या मालकाच्या किंवा नातेवाइकाच्या नावावर असेल, तर त्यावर अर्ज तुमचा ठरत नाही.</td><td>डिस्कॉम — कनेक्शन हस्तांतरण</td></tr>
            <tr><td><strong>चालू, नियमित कनेक्शन</strong></td><td>घरगुती कनेक्शन सुस्थितीत — खंडित नसलेले आणि थकबाकी नसलेले.</td><td>डिस्कॉम — आधी थकबाकी भरा</td></tr>
            <tr><td><strong>छत तुमच्या ताब्यात</strong></td><td>ज्या छतावर प्लांट बसणार त्याची मालकी किंवा लेखी परवानगी.</td><td>सोसायटी / मालकाचे ना-हरकत</td></tr>
          </tbody>
        </table></div>
        <p class="fs-legend">नेमकी भाषा राज्यानुसार बदलते आणि ती तुमचा डिस्कॉम ठरवतो, आम्ही नाही.
        हे तपासणीचे स्वरूप समजा — अंतिम यादी तीच जी अर्जाच्या वेळी तुमचा डिस्कॉम दाखवतो.</p>
      </section>

      <section class="seo-section">
        <h2>प्लांटच्या तुलनेत मंजूर भार — आणि तो दुरुस्त करण्याची किंमत</h2>
        <p>हीच तपासणी लोकांना सर्वाधिक चकित करते, कारण पॅनेल विकत घेताना तुमचा वीज करार यात येतो असे
        कुठेही वाटत नाही. तर्क सरळ आहे: छतावरील प्लांट त्याची पूर्ण क्षमता तुमच्या कनेक्शनमधून परत
        पाठवू शकतो, म्हणून कनेक्शन किमान तेवढ्याचे करारबद्ध हवे.</p>
        <p>भार कमी पडत असेल तर उपाय म्हणजे डिस्कॉमकडे <strong>भारवाढीची</strong> विनंती. ही नेहमीची
        प्रक्रिया आहे. मोफत मात्र नाही — आणि हाच भाग ठरवण्याआधी पाहून घ्यावा, कारण वाढलेले फिक्स्ड
        शुल्क <em>दर महिन्याला, कायमस्वरूपी</em> लागते:</p>
        {{SOLAR_LOAD_TABLE}}
        <p>दुसरा खर्च नंतर वेगळा येतो: वाढलेला मंजूर भार तुमची <strong>सुरक्षा ठेव</strong>ही वाढवतो,
        आणि फरक पुढच्या एखाद्या बिलात एकरकमी मागितला जातो. फक्त फरक भरायचा असतो, पूर्ण रक्कम पुन्हा
        नाही — न तपासता मागणी भरण्याआधी
        <a href="/guides/electricity-security-deposit-explained/">सुरक्षा ठेव कशी चालते</a> वाचा.</p>
      </section>

      <section class="seo-section">
        <h2>नाव अगदी तंतोतंत जुळायला हवे</h2>
        <p>सबसिडी एका बँक खात्यात जाते, एका अर्जाच्या विरोधात, एका वीज कनेक्शनच्या विरोधात. ही तिन्ही
        नावे ताडून पाहिली जातात, आणि न जुळणे ही फाइल अडकण्याची सामान्य कारणे आहेत: बँकेत पूर्ण नाव आणि
        कनेक्शनवर फक्त आद्याक्षर, लग्नापूर्वीचे नाव, एका अक्षराचा फरक, किंवा कनेक्शन अजूनही आई-वडिलांच्या
        नावावर.</p>
        <p>इथे दोन वेगळ्या अडचणी दडलेल्या आहेत आणि दोघांच्या विनंत्या वेगळ्या:</p>
        <ul>
          <li><strong>व्यक्ती तीच, स्पेलिंग चुकीचे</strong> — कनेक्शनवर <strong>नाव दुरुस्ती</strong>.
          साधारणपणे हलकी प्रक्रिया.</li>
          <li><strong>व्यक्ती वेगळी</strong> — कनेक्शन तुमच्या नावावर <strong>हस्तांतरित</strong> करणे.
          ही जड प्रक्रिया आहे आणि यात सुरक्षा ठेवही पुन्हा ठरते, म्हणून लवकर सुरू करा.</li>
        </ul>
        <p>काहीही करण्याआधी तुमच्या ताज्या बिलावरील स्पेलिंग बँक पासबुकशी ताडून पाहा. यात खर्च शून्य
        आणि टाळता येण्याजोग्या नकाराचे हे सर्वात सामान्य कारण आहे.</p>
      </section>

      <section class="seo-section">
        <h2>तुमच्याकडे काय मागितले जाईल</h2>
        <p>कागदपत्रांची यादी प्रत्येक डिस्कॉम ठरवतो आणि ती बदलत राहते; तुमच्या डिस्कॉमचे स्वतःचे पोर्टल
        हीच अंतिम यादी. जवळपास सगळीकडे जे मागितले जाते ते चार गटांत येते:</p>
        <ul>
          <li><strong>ओळख</strong> — अर्जदाराचे सरकारी ओळखपत्र.</li>
          <li><strong>कनेक्शन</strong> — अलीकडचे वीज बिल, ज्यावर ग्राहक क्रमांक, मंजूर भार आणि जुळायचे
          नाव असते.</li>
          <li><strong>जागा</strong> — मालकीचा पुरावा, किंवा मालक नसल्यास छत वापरण्याची परवानगी.</li>
          <li><strong>बँक खाते</strong> — सबसिडी जमा होण्यासाठी, त्याच नावाने.</li>
        </ul>
        <p>"सबसिडी मंजूर करून देतो" म्हणत संपर्क करणाऱ्या कोणालाही कागदपत्रे पाठवू नका. सबसिडी
        अधिकृत प्रक्रियेने तुमच्याच खात्यात जमा होते, आणि विक्रेत्यांची यादी राष्ट्रीय पोर्टलवर
        प्रसिद्ध आहे.</p>
      </section>

      <section class="seo-section">
        <h2>आधी डिस्कॉममध्ये दुरुस्त करा, मग अर्ज करा</h2>
        <p>वरचे तिन्ही उपाय — भारवाढ, नाव दुरुस्ती, कनेक्शन हस्तांतरण — डिस्कॉमच्या विनंत्या आहेत,
        सोलर पोर्टलच्या नाहीत. तुमचे राज्य आणि डिस्कॉम निवडून थेट त्याच्या अधिकृत पोर्टलवर जा:</p>
        <p class="seo-cta-row"><a class="seo-cta" href="/services/">माझ्या डिस्कॉमच्या सेवा उघडा</a></p>
        <p>सर्वात कमी वेळ लागणारा क्रम: बिलावरील नाव तपासा, हव्या असलेल्या प्लांटच्या तुलनेत मंजूर भार
        तपासा, लागणारी विनंती करा, आणि त्यानंतरच सोलर अर्ज सुरू करा. उलटे केले तर अर्ज अशा डिस्कॉम
        प्रक्रियेची वाट पाहत राहतो जी सुरूच झालेली नाही.</p>
      </section>

      <section class="seo-section">
        <h2>मग हे फायद्याचे आहे का ते ठरवा</h2>
        <p>पात्रता हे प्रवेशद्वार आहे, कारण नाही. अर्ज करू शकता हे कळल्यावर खरे प्रश्न असे: तुमची छत
        आणि वापर किती मोठा प्लांट समर्थनीय ठरवतो, आणि सबसिडीनंतर तुम्हाला किती भरावे लागते:</p>
        <div class="seo-link-grid">
          <a class="seo-link-card" data-icon="sun" href="/solar-subsidy-checker/"><strong>सबसिडी आणि पेबॅक</strong><span>सबसिडीनंतर प्लांटची किंमत, आणि पैसे परत यायला किती काळ</span></a>
          <a class="seo-link-card" data-icon="calc" href="/solar-panel-size-calculator/"><strong>किती मोठा लागेल?</strong><span>हव्या असलेल्या निर्मितीसाठी पॅनेल संख्या आणि छताचे क्षेत्रफळ</span></a>
          <a class="seo-link-card" data-icon="gauge" href="/sanctioned-load-optimizer/"><strong>माझा भार बरोबर आहे?</strong><span>मंजूर भाराची तुलना प्रत्यक्ष नोंदल्या जाणाऱ्या मागणीशी</span></a>
        </div>
      </section>
    `,
    faqsMr: [
      { q: 'माझा मंजूर भार सोलर पॅनेलच्या आकाराएवढा असणे आवश्यक आहे का?',
        a: 'साधारणपणे मंजूर भार किमान प्लांटच्या क्षमतेएवढा हवा — 2 kW मंजूर असलेल्या कनेक्शनवर 3 kW सिस्टिमसाठी आधी भारवाढ करावी लागेल. ही अट तुमचा डिस्कॉम ठरवतो, आणि भारवाढ ही नेहमीची प्रक्रिया आहे, पण त्यानंतरचे वाढलेले फिक्स्ड शुल्क कायमस्वरूपी असते आणि दर महिन्याला लागते.' },
      { q: 'वीज बिलावरील नाव बँक खात्याशी जुळले नाही तर काय होते?',
        a: 'अर्ज अडकण्याच्या सर्वात सामान्य कारणांपैकी हे एक आहे, कारण सबसिडी कनेक्शनशी ताडून पाहिलेल्या बँक खात्यात जमा होते. व्यक्ती तीच असून फक्त स्पेलिंगचा फरक असेल तर डिस्कॉमकडून नाव दुरुस्ती करून घ्या. कनेक्शन दुसऱ्याच्या नावावर असेल तर कनेक्शन हस्तांतरण लागते, ज्याला जास्त वेळ लागतो आणि सुरक्षा ठेवही पुन्हा ठरते — ते लवकर सुरू करा.' },
      { q: 'मी स्वतः वीज तयार करत असूनही भारवाढीने बिल वाढेल का?',
        a: 'होय. फिक्स्ड शुल्क मंजूर भारावर आकारले जाते, तुम्ही कितीही वापरा किंवा निर्माण करा — त्यामुळे सर्वोत्तम निर्मितीच्या महिन्यांतही ते लागते. भार वाढवण्याआधी मासिक वाढ काढून पाहा, आणि भार प्लांटला खरोखर लागतो तेवढाच ठेवा.' },
      { q: 'भारवाढीत सुरक्षा ठेव पुन्हा पूर्ण भरावी लागते का?',
        a: 'नाही — फक्त नव्या आवश्यक ठेवीतील आणि तुमच्याकडे आधीच असलेल्या ठेवीतील फरक. पूर्ण नवी रक्कम मागितली गेल्यास ती लेखी विचारणा करण्याजोगी आहे.' },
      { q: 'भाड्याच्या घरात राहून PM सूर्य घरसाठी अर्ज करता येतो का?',
        a: 'अर्जदार वीज ग्राहक असावा लागतो आणि छत त्याच्या ताब्यात हवी, त्यामुळे घरमालकाच्या नावावरील कनेक्शनवर भाडेकरू सहसा अर्ज करू शकत नाही. जिथे व्यवस्था खरोखर तुमची आहे, तिथे आधी कनेक्शन तुमच्या नावावर करावे लागते, सोबत मालकाची छतासाठी परवानगी.' },
      { q: 'या गोष्टी अर्जाआधी दुरुस्त कराव्यात की नंतर?',
        a: 'आधी. भारवाढ, नाव दुरुस्ती आणि हस्तांतरण — तिन्ही डिस्कॉम प्रक्रिया आहेत आणि तिन्हींना स्वतःचा कालावधी आहे; यापैकी कशाची वाट पाहणारा अर्ज फक्त वाटच पाहत राहतो. ताज्या बिलावरील नाव आणि हव्या असलेल्या प्लांटच्या तुलनेत मंजूर भार तपासायला खर्च शून्य आणि एक मिनिट लागतो.' }
    ],
    titleTa: 'PM சூர்யா கர்: விண்ணப்பம் எதனால் நிராகரிக்கப்படுகிறது',
    metaTitleTa: 'PM சூர்யா கர் தகுதி — அனுமதி சுமை, பெயர் பொருத்தம், தீர்வுகள்',
    descriptionTa: 'மானியம் கணக்கிடப்படும் முன்பே உங்கள் PM சூர்யா கர் விண்ணப்பத்தை முடிவு செய்யும் சோதனைகள்: ஆலை அளவுக்கு எதிரான அனுமதி சுமை, இணைப்பில் உள்ள பெயர், உரிமை மற்றும் மீட்டர் நிலை — ஒவ்வொன்றையும் சரிசெய்யும் டிஸ்காம் கோரிக்கையுடன்.',
    introTa: `<strong>PM சூர்யா கர்</strong> குறித்த பெரும்பாலான வழிகாட்டிகள் மானியத்தை விளக்குகின்றன.
      மானியம் கணக்கிடப்படும் <em>முன்</em> நடக்கும் சோதனைகளை யாரும் விளக்குவதில்லை — விண்ணப்பங்கள்
      உண்மையில் அங்குதான் தேங்குகின்றன. இரண்டு காரணங்கள் மிகவும் பொதுவானவை: நீங்கள் விண்ணப்பிக்கும்
      <strong>ஆலையின் அளவுக்கு குறையாமல் உங்கள் அனுமதி சுமை</strong> இருக்க வேண்டும், மேலும்
      <strong>மின் இணைப்பில் உள்ள பெயர்</strong> நீங்கள் விண்ணப்பிக்கும் மற்றும் வங்கிக் கணக்கு
      வைத்திருக்கும் பெயருடன் பொருந்த வேண்டும். இரண்டையும் சரிசெய்ய முடியும், இரண்டும் சூரிய போர்ட்டலில்
      அல்ல உங்கள் டிஸ்காமில் சரிசெய்யப்படுகின்றன, மேலும் விண்ணப்பிப்பதற்கு முன் சரிசெய்வது பின்னர்
      செய்வதை விட மிகவும் மலிவானது.`,
    sectionsTa: `
      <section class="seo-section">
        <h2>சோதனைகள், அவை தடுக்கும் வரிசையில்</h2>
        <div class="comparison-table-wrapper"><table class="comparison-table">
          <thead><tr><th>சோதனை</th><th>இதன் பொருள்</th><th>எங்கு சரிசெய்யப்படும்</th></tr></thead>
          <tbody>
            <tr><td><strong>அனுமதி சுமை ≥ ஆலை அளவு</strong></td><td>3 kW ஆலைக்கு பொதுவாக இணைப்பில் குறைந்தது 3 kW அனுமதி சுமை தேவை.</td><td>டிஸ்காம் — சுமை உயர்வு</td></tr>
            <tr><td><strong>பெயர் பொருத்தம்</strong></td><td>இணைப்பில் உள்ள நுகர்வோர் பெயர் உங்கள் அடையாள ஆவணம் மற்றும் வங்கிப் பதிவுகளுடன் பொருந்த வேண்டும் — எழுத்துக்கூட்டல் உட்பட.</td><td>டிஸ்காம் — பெயர் மாற்றம்</td></tr>
            <tr><td><strong>நுகர்வோர் நீங்களே</strong></td><td>இணைப்பு இன்னும் முந்தைய உரிமையாளர் அல்லது உறவினர் பெயரில் இருந்தால், அதில் விண்ணப்பிக்க உங்களுக்கு உரிமை இல்லை.</td><td>டிஸ்காம் — இணைப்பு மாற்றம்</td></tr>
            <tr><td><strong>இயங்கும், முறையான இணைப்பு</strong></td><td>வீட்டு இணைப்பு நல்ல நிலையில் — துண்டிக்கப்படாமல், நிலுவை இல்லாமல்.</td><td>டிஸ்காம் — முதலில் நிலுவையை செலுத்துங்கள்</td></tr>
            <tr><td><strong>உங்கள் கட்டுப்பாட்டில் கூரை</strong></td><td>ஆலை அமையும் கூரையின் உரிமை அல்லது எழுத்துப்பூர்வ அனுமதி.</td><td>சங்கம் / உரிமையாளர் தடையின்மைச் சான்று</td></tr>
          </tbody>
        </table></div>
        <p class="fs-legend">சரியான சொற்கள் மாநிலத்துக்கு மாநிலம் மாறும், அதை உங்கள் டிஸ்காம் தீர்மானிக்கிறது,
        நாங்கள் அல்ல. இதை சோதனையின் வடிவமாகக் கொள்ளுங்கள் — இறுதிப் பட்டியல் விண்ணப்பிக்கும்போது உங்கள்
        டிஸ்காம் காட்டுவதுதான்.</p>
      </section>

      <section class="seo-section">
        <h2>ஆலை அளவுக்கு எதிரான அனுமதி சுமை — அதைச் சரிசெய்யும் செலவு</h2>
        <p>இந்தச் சோதனைதான் மக்களை மிகவும் ஆச்சரியப்படுத்துகிறது, ஏனெனில் பேனல்கள் வாங்குவதில் உங்கள்
        மின் ஒப்பந்தம் சம்பந்தப்படுவதாக எதுவும் தோன்றுவதில்லை. காரணம் நேரடியானது: கூரை ஆலை தனது முழு
        திறனையும் உங்கள் இணைப்பின் வழியாகத் திருப்பி அனுப்ப முடியும், எனவே இணைப்பு குறைந்தது அந்த
        அளவுக்கு ஒப்பந்தம் செய்யப்பட்டிருக்க வேண்டும்.</p>
        <p>சுமை குறைவாக இருந்தால், தீர்வு டிஸ்காமிடம் <strong>சுமை உயர்வு</strong> கோரிக்கை. இது
        வழக்கமான நடைமுறை. இலவசம் அல்ல — இந்தப் பகுதியைத்தான் முடிவெடுப்பதற்கு முன் பார்க்க வேண்டும்,
        ஏனெனில் உயர்ந்த நிலையான கட்டணம் <em>ஒவ்வொரு மாதமும், நிரந்தரமாக</em> வசூலிக்கப்படும்:</p>
        {{SOLAR_LOAD_TABLE}}
        <p>இரண்டாவது செலவு பின்னர் தனியாக வருகிறது: உயர்ந்த அனுமதி சுமை உங்கள்
        <strong>பாதுகாப்பு வைப்புத்தொகையையும்</strong> உயர்த்துகிறது, வித்தியாசம் அடுத்த ஏதேனும் ஒரு
        பில்லில் மொத்தமாகக் கோரப்படும். வித்தியாசம் மட்டுமே செலுத்த வேண்டும், முழுத் தொகையும் மீண்டும்
        அல்ல — சரிபார்க்காமல் ஒரு கோரிக்கையைச் செலுத்தும் முன்
        <a href="/guides/electricity-security-deposit-explained/">பாதுகாப்பு வைப்புத்தொகை எப்படி இயங்குகிறது</a>
        என்பதைப் படியுங்கள்.</p>
      </section>

      <section class="seo-section">
        <h2>பெயர் அப்படியே பொருந்த வேண்டும்</h2>
        <p>மானியம் ஒரு வங்கிக் கணக்கிற்கு, ஒரு விண்ணப்பத்திற்கு எதிராக, ஒரு மின் இணைப்புக்கு எதிராக
        வழங்கப்படுகிறது. இந்த மூன்று பெயர்களும் ஒப்பிடப்படுகின்றன, பொருந்தாமை கோப்பு தேங்குவதற்கான
        பொதுவான காரணங்களில் ஒன்று: வங்கியில் முழுப் பெயர், இணைப்பில் முதலெழுத்து மட்டும்; திருமணத்திற்கு
        முந்தைய பெயர்; ஒரு எழுத்து வேறுபடும் எழுத்துப்பெயர்ப்பு; அல்லது இணைப்பு இன்னும் பெற்றோர் பெயரில்.</p>
        <p>இங்கே இரண்டு வெவ்வேறு பிரச்சினைகள் மறைந்துள்ளன, இரண்டுக்கும் வெவ்வேறு கோரிக்கைகள்:</p>
        <ul>
          <li><strong>அதே நபர், தவறான எழுத்துக்கூட்டல்</strong> — இணைப்பில்
          <strong>பெயர் திருத்தம்</strong>. பொதுவாக எளிதான நடைமுறை.</li>
          <li><strong>வேறு நபர்</strong> — இணைப்பை உங்கள் பெயருக்கு
          <strong>மாற்றுதல்</strong>. இது கனமான நடைமுறை, இதில் பாதுகாப்பு வைப்புத்தொகையும் மீண்டும்
          நிர்ணயிக்கப்படும், எனவே சீக்கிரம் தொடங்குங்கள்.</li>
        </ul>
        <p>எதையும் செய்வதற்கு முன், உங்கள் சமீபத்திய பில்லில் உள்ள எழுத்துக்கூட்டலை வங்கிப்
        பாஸ்புத்தகத்துடன் ஒப்பிடுங்கள். இதற்குச் செலவே இல்லை, தவிர்க்கக்கூடிய நிராகரிப்புக்கான மிகப்
        பொதுவான காரணம் இதுவே.</p>
      </section>

      <section class="seo-section">
        <h2>உங்களிடம் என்ன கேட்கப்படும்</h2>
        <p>ஆவணப் பட்டியல்களை ஒவ்வொரு டிஸ்காமும் நிர்ணயிக்கிறது, அவை மாறிக்கொண்டே இருக்கும்; உங்கள்
        டிஸ்காமின் சொந்த போர்ட்டல்தான் ஒரே அதிகாரப்பூர்வப் பட்டியல். கிட்டத்தட்ட எல்லா இடங்களிலும்
        கேட்கப்படுவது நான்கு பிரிவுகளில் அடங்கும்:</p>
        <ul>
          <li><strong>அடையாளம்</strong> — விண்ணப்பதாரரின் அரசு அடையாள ஆவணம்.</li>
          <li><strong>இணைப்பு</strong> — சமீபத்திய மின் பில், அதில் நுகர்வோர் எண், அனுமதி சுமை மற்றும்
          பொருந்த வேண்டிய பெயர் இருக்கும்.</li>
          <li><strong>இடம்</strong> — உரிமைச் சான்று, அல்லது உரிமையாளர் இல்லாதபோது கூரையைப் பயன்படுத்த
          அனுமதி.</li>
          <li><strong>வங்கிக் கணக்கு</strong> — மானியம் வரவு வைக்க, அதே பெயரில்.</li>
        </ul>
        <p>"மானியத்தை அனுமதி வாங்கித் தருகிறோம்" என்று தொடர்பு கொள்பவர்களுக்கு ஆவணங்களை அனுப்ப வேண்டாம்.
        மானியம் அதிகாரப்பூர்வ நடைமுறை வழியாக உங்கள் சொந்தக் கணக்கிற்கே வரும், விற்பனையாளர் பட்டியல்
        தேசியப் போர்ட்டலில் வெளியிடப்பட்டுள்ளது.</p>
      </section>

      <section class="seo-section">
        <h2>முதலில் டிஸ்காமில் சரிசெய்யுங்கள், பிறகு விண்ணப்பியுங்கள்</h2>
        <p>மேலே உள்ள மூன்று தீர்வுகளும் — சுமை உயர்வு, பெயர் திருத்தம், இணைப்பு மாற்றம் — டிஸ்காம்
        கோரிக்கைகள், சூரிய போர்ட்டலுடையவை அல்ல. உங்கள் மாநிலத்தையும் டிஸ்காமையும் தேர்ந்தெடுத்து நேராக
        அதன் அதிகாரப்பூர்வ போர்ட்டலுக்குச் செல்லுங்கள்:</p>
        <p class="seo-cta-row"><a class="seo-cta" href="/services/">என் டிஸ்காம் சேவைகளைத் திறக்கவும்</a></p>
        <p>மிகக் குறைந்த நேரம் எடுக்கும் வரிசை: பில்லில் பெயரைச் சரிபாருங்கள், விரும்பும் ஆலைக்கு
        எதிராக அனுமதி சுமையைச் சரிபாருங்கள், தேவையான கோரிக்கையை வையுங்கள், அதன் பிறகுதான் சூரிய
        விண்ணப்பத்தைத் தொடங்குங்கள். தலைகீழாகச் செய்தால், தொடங்கப்படாத ஒரு டிஸ்காம் நடைமுறைக்காகக்
        காத்திருக்கும் விண்ணப்பமாகவே அது இருக்கும்.</p>
      </section>

      <section class="seo-section">
        <h2>பிறகு இது மதிப்புள்ளதா என்று பாருங்கள்</h2>
        <p>தகுதி என்பது ஒரு வாயில், காரணம் அல்ல. விண்ணப்பிக்க முடியும் என்று தெரிந்த பிறகு உண்மையான
        கேள்விகள் இவை: உங்கள் கூரையும் நுகர்வும் எவ்வளவு பெரிய ஆலையை நியாயப்படுத்துகின்றன, மானியத்திற்குப்
        பிறகு நீங்கள் எவ்வளவு செலுத்த வேண்டியிருக்கும்:</p>
        <div class="seo-link-grid">
          <a class="seo-link-card" data-icon="sun" href="/solar-subsidy-checker/"><strong>மானியமும் திரும்பப் பெறும் காலமும்</strong><span>மானியத்திற்குப் பிறகு ஆலையின் விலை, முதலீடு திரும்ப எவ்வளவு காலம்</span></a>
          <a class="seo-link-card" data-icon="calc" href="/solar-panel-size-calculator/"><strong>எவ்வளவு பெரியது தேவை?</strong><span>விரும்பும் உற்பத்திக்கான பேனல் எண்ணிக்கையும் கூரைப் பரப்பும்</span></a>
          <a class="seo-link-card" data-icon="gauge" href="/sanctioned-load-optimizer/"><strong>என் சுமை சரியா?</strong><span>அனுமதி சுமையை உண்மையில் பதிவாகும் தேவையுடன் ஒப்பிடுங்கள்</span></a>
        </div>
      </section>
    `,
    faqsTa: [
      { q: 'என் அனுமதி சுமை சோலார் பேனல் அளவுக்குச் சமமாக இருக்க வேண்டுமா?',
        a: 'பொதுவாக அனுமதி சுமை குறைந்தது ஆலையின் திறனுக்குச் சமமாக இருக்க வேண்டும் — 2 kW அனுமதிக்கப்பட்ட இணைப்பில் 3 kW அமைப்புக்கு முதலில் சுமை உயர்வு தேவை. இந்த நிபந்தனையை உங்கள் டிஸ்காம் நிர்ணயிக்கிறது, சுமை உயர்வு வழக்கமான நடைமுறைதான், ஆனால் அதன் பிறகு வரும் உயர்ந்த நிலையான கட்டணம் நிரந்தரமானது, ஒவ்வொரு மாதமும் வசூலிக்கப்படும்.' },
      { q: 'என் மின் பில்லில் உள்ள பெயர் வங்கிக் கணக்குடன் பொருந்தவில்லை என்றால் என்ன ஆகும்?',
        a: 'விண்ணப்பம் தேங்குவதற்கான மிகப் பொதுவான காரணங்களில் இதுவும் ஒன்று, ஏனெனில் மானியம் இணைப்புடன் ஒப்பிடப்பட்ட வங்கிக் கணக்கிற்கே செலுத்தப்படுகிறது. அதே நபர், எழுத்துக்கூட்டல் மட்டும் வேறுபட்டால் டிஸ்காமிடம் பெயர் திருத்தம் கேளுங்கள். இணைப்பு வேறு ஒருவர் பெயரில் இருந்தால் இணைப்பு மாற்றம் தேவை, அதற்கு அதிக நேரம் ஆகும், பாதுகாப்பு வைப்புத்தொகையும் மீண்டும் நிர்ணயிக்கப்படும் — சீக்கிரம் தொடங்குங்கள்.' },
      { q: 'நானே மின்சாரம் உற்பத்தி செய்தாலும் சுமை உயர்வு என் பில்லை உயர்த்துமா?',
        a: 'ஆம். நிலையான கட்டணம் அனுமதி சுமையின் மீது வசூலிக்கப்படுகிறது, நீங்கள் எவ்வளவு பயன்படுத்தினாலும் உற்பத்தி செய்தாலும் — எனவே சிறந்த உற்பத்தி மாதங்களிலும் இது பொருந்தும். சுமையை உயர்த்தும் முன் மாதாந்திர அதிகரிப்பைக் கணக்கிடுங்கள், ஆலைக்கு உண்மையில் தேவையானதற்கு மேல் சுமையை வைக்க வேண்டாம்.' },
      { q: 'சுமை உயர்வுக்கு பாதுகாப்பு வைப்புத்தொகையை மீண்டும் முழுமையாகச் செலுத்த வேண்டுமா?',
        a: 'இல்லை — புதிதாகத் தேவைப்படும் தொகைக்கும் ஏற்கெனவே உங்களிடம் உள்ள வைப்புத்தொகைக்கும் இடையிலான வித்தியாசம் மட்டுமே. முழுப் புதிய தொகையும் கோரப்பட்டால் அதை எழுத்துப்பூர்வமாகக் கேள்வி கேட்பது நியாயம்.' },
      { q: 'வாடகை வீட்டில் இருந்து PM சூர்யா கர்-க்கு விண்ணப்பிக்க முடியுமா?',
        a: 'விண்ணப்பதாரர் மின் நுகர்வோராக இருக்க வேண்டும், கூரையும் அவர் கட்டுப்பாட்டில் இருக்க வேண்டும், எனவே வீட்டு உரிமையாளர் பெயரில் உள்ள இணைப்பில் வாடகைதாரர் பொதுவாக விண்ணப்பிக்க முடியாது. ஏற்பாடு உண்மையில் உங்களுடையதாக இருந்தால், முதலில் இணைப்பை உங்கள் பெயருக்கு மாற்ற வேண்டும், உரிமையாளரின் கூரை அனுமதியுடன்.' },
      { q: 'இவற்றை விண்ணப்பிப்பதற்கு முன் சரிசெய்வதா, பின்பா?',
        a: 'முன்பே. சுமை உயர்வு, பெயர் திருத்தம், இணைப்பு மாற்றம் — மூன்றும் டிஸ்காம் நடைமுறைகள், மூன்றுக்கும் தனித்தனி கால அவகாசம் உண்டு; இவற்றில் ஒன்றுக்காகக் காத்திருக்கும் விண்ணப்பம் காத்திருப்பதோடு சரி. சமீபத்திய பில்லில் பெயரையும், விரும்பும் ஆலைக்கு எதிராக அனுமதி சுமையையும் சரிபார்க்க செலவே இல்லை, ஒரு நிமிடம் போதும்.' }
    ],
    faqs: [
      {
  ...
  },
  {
    ...
    `,
    titleHi: 'MD पेनल्टी और अतिरिक्त मांग शुल्क — पूरी जानकारी',
    metaTitleHi: 'MD पेनल्टी / अतिरिक्त मांग शुल्क — राज्यवार नियम',
    descriptionHi: 'बिजली बिल पर लगने वाली अधिकतम मांग (MD) पेनल्टी क्या है, यूनिट न बदलने पर भी यह क्यों आती है, हर राज्य इसे कैसे वसूलता है (2×, 1.5×, सपाट ₹/kVA या ऊर्जा शुल्क का %), और इसे रोकने के तीन तरीके।',
    introHi: `<strong>MD पेनल्टी</strong> — बिल पर इसे अतिरिक्त मांग शुल्क, एक्सीडिंग डिमांड चार्ज या पेनल डिमांड
      चार्ज भी लिखा जाता है — तब लगती है जब बिलिंग चक्र में आपकी अधिकतम खपत-दर उस लोड से ऊपर चली जाती है
      जिसका आपने अनुबंध किया है। यह <strong>सिर्फ़ अतिरिक्त हिस्से</strong> पर लगती है, पूरी मांग पर नहीं,
      और यह उन गिनी-चुनी लाइनों में से है जो आपकी यूनिट लगभग न बदलने पर भी बिल में आ सकती है। यह पृष्ठ पहले
      तंत्र समझाता है, फिर बताता है कि राज्य-दर-राज्य नियम कैसे अलग होते हैं।`,
    sectionsHi: `
      <section class="seo-section">
        <h2>अधिकतम मांग असल में मापती क्या है</h2>
        <p>यूनिट (kWh) बताती हैं कि महीने भर में आपने कुल कितनी ऊर्जा इस्तेमाल की।
        <strong>अधिकतम मांग</strong> बताती है कि आपने उसे सबसे तेज़ किस दर से खींचा — चक्र का सबसे भारी
        अंतराल, जो लगभग हमेशा <strong>30 मिनट</strong> का रोलिंग ब्लॉक होता है, मीटर उसे दर्ज करता है और
        हर चक्र में रीसेट कर देता है।</p>
        <p>यह अंतर ही पूरी बात है। 10 kW का लोड 20 घंटे चलाना और 40 kW का लोड 5 घंटे चलाना — दोनों में
        यूनिट लगभग बराबर बन सकती हैं, लेकिन दूसरी स्थिति में नेटवर्क को 40 kW के लिए बनाना पड़ता है।
        मांग शुल्क उसी क्षमता का दाम है; ऊर्जा शुल्क बिजली का।</p>
        <p>इसलिए <strong>एक बुरा आधा घंटा पूरे महीने की MD तय कर देता है।</strong> किसी एक सोमवार को
        9:05 बजे कंप्रेसर, लिफ़्ट मोटर और एसी बैंक का एक साथ चालू हो जाना काफ़ी है। बाकी 719 घंटे आप जो भी
        करें, वह आँकड़ा नीचे नहीं आता।</p>
      </section>

      <section class="seo-section">
        <h2>स्वीकृत लोड, अनुबंधित मांग और बिल्ड डिमांड</h2>
        <p>तीन संख्याएँ लगातार आपस में गड्डमड्ड होती हैं, और पेनल्टी इसी पर निर्भर करती है कि कौन-सी कौन है:</p>
        <div class="comparison-table-wrapper"><table class="comparison-table">
          <thead><tr><th>शब्द</th><th>इसका मतलब</th><th>यह कहाँ से आता है</th></tr></thead>
          <tbody>
            <tr><td><strong>स्वीकृत लोड</strong></td><td>डिस्कॉम ने आपके लिए जितना कनेक्टेड लोड मंज़ूर किया, kW में।</td><td>आपका कनेक्शन एग्रीमेंट। बिल पर छपा होता है।</td></tr>
            <tr><td><strong>अनुबंधित मांग</strong></td><td>आपने अधिकतम जितनी मांग खींचने का अनुबंध किया, kVA में। HT कनेक्शनों पर यही संख्या मायने रखती है।</td><td>आपका एग्रीमेंट; इसे बदलना आवेदन का काम है, फ़ोन कॉल का नहीं।</td></tr>
            <tr><td><strong>दर्ज MD</strong></td><td>इस चक्र में मीटर ने जो सबसे ऊँची 30-मिनट मांग देखी।</td><td>मीटर। यह माप है, कोई निर्णय नहीं।</td></tr>
            <tr><td><strong>बिल्ड डिमांड</strong></td><td>जिस पर आपसे मांग शुल्क लिया जाता है — आमतौर पर दर्ज MD और एक न्यूनतम सीमा (HT पर अक्सर अनुबंधित मांग का 75%) में से जो ज़्यादा हो।</td><td>टैरिफ़ आदेश।</td></tr>
          </tbody>
        </table></div>
        <p>पेनल्टी तब लगती है जब <strong>दर्ज MD स्वीकृत लोड या अनुबंधित मांग से ऊपर</strong> जाती है।
        बिलिंग-डिमांड की न्यूनतम सीमा अलग नियम है और उल्टी दिशा में काम करती है: वह आपके मांग शुल्क को एक
        न्यूनतम से नीचे नहीं गिरने देती — इसीलिए लगभग बिना खपत वाले महीने में भी अच्छा-ख़ासा मांग शुल्क आ सकता है।</p>
      </section>

      <section class="seo-section">
        <h2>पेनल्टी की गणना कैसे होती है</h2>
        <p>भारत में हर रूप घूम-फिरकर एक ही आकार पर आता है:</p>
        <p><strong>पेनल्टी = (दर्ज MD − स्वीकृत मांग) × पेनल दर</strong></p>
        <p>राज्यों के बीच फ़र्क़ सिर्फ़ पेनल दर का है, और उसे लिखने के चार तरीक़े हैं:</p>
        <ul>
          <li><strong>सामान्य मांग दर का गुणक।</strong> सबसे आम। अतिरिक्त kW या kVA पर सामान्य दर का, मान लीजिए, 1.5× या 2× वसूला जाता है।</li>
          <li><strong>प्रति अतिरिक्त kVA सपाट ₹।</strong> एक तय पेनल राशि, जो आपकी सामान्य मांग दर से स्वतंत्र होती है।</li>
          <li><strong>प्रति अतिरिक्त kW, ऊर्जा शुल्क का प्रतिशत।</strong> कम प्रचलित, और इसमें पेनल्टी आपकी खपत के साथ भी बढ़ती है, सिर्फ़ ओवरशूट के साथ नहीं।</li>
          <li><strong>अतिरिक्त लोड के फिक्स्ड शुल्क पर अधिभार</strong>, मांग दर पर नहीं।</li>
        </ul>
        <p>दो बातें तय करती हैं कि बिल पर छपी संख्या आपके हिसाब से मेल खाएगी या नहीं। पहली,
        <strong>पेनल्टी सिर्फ़ अतिरिक्त हिस्से पर लगती है</strong> — स्वीकृत लोड तक का हिस्सा सामान्य दर पर
        ही बिलता है। दूसरी, ज़्यादातर राज्यों में पेनल्टी ईंधन अधिभार और बिजली शुल्क (ड्यूटी) की गणना से
        <em>पहले</em> जुड़ती है, इसलिए ₹1,000 की पेनल्टी बिल के कुल में ₹1,000 से ज़्यादा पड़ती है। हमारा
        <a href="/#calculator">बिल कैलकुलेटर</a> इसे इसी क्रम में लगाता है।</p>
      </section>

      <section class="seo-section">
        <h2>राज्यवार MD पेनल्टी नियम</h2>
        <p>यह तालिका उसी टैरिफ़ डेटा से बनती है जिस पर कैलकुलेटर चलता है, इसलिए यह साइट जो असल में वसूलती
        है उससे कभी अलग नहीं हो सकती।</p>
        {{EXCESS_DEMAND_TABLE}}
      </section>

      <section class="seo-section">
        <h2>कुछ नहीं बदला, फिर इस महीने यह क्यों आई</h2>
        <p>आम वजहें, मोटे तौर पर उसी क्रम में जिसमें वे अक्सर सही निकलती हैं:</p>
        <ol>
          <li><strong>एक नया लोड, ग़लत क्षण पर चालू।</strong> एक अतिरिक्त मोटर या एसी जो तब चालू हो जाए जब बाकी सब पहले से चल रहा हो — नया शिखर बन जाता है।</li>
          <li><strong>कुछ नहीं बदला — मौसम बदला।</strong> गर्मियों में कूलिंग और सर्दियों में हीटिंग आपकी आदत बदले बिना एक-साथ चलने वाला लोड बढ़ा देती है।</li>
          <li><strong>बिजली कटौती और उसके बाद की रीस्टार्ट।</strong> सप्लाई लौटते ही इमारत के सारे थर्मोस्टैटिक लोड एक साथ चालू होते हैं। यह MD के एकबारगी उछाल की सबसे आम वजहों में है, और इसमें आपका दोष नहीं।</li>
          <li><strong>आपका स्वीकृत लोड हमेशा से कम था।</strong> उन कनेक्शनों पर आम है जिनका आकार वर्षों पहले तय हुआ और फिर कभी नहीं बदला। यह उछाल नहीं है; आप काफ़ी समय से सीमा के ऊपर थे और अब उसका शुल्क लग रहा है।</li>
          <li><strong>kVA टैरिफ़ पर कैपेसिटर बैंक की ख़राबी।</strong> अगर आपका बिल kVA पर बनता है और पावर फ़ैक्टर गिर जाए, तो असल काम बढ़े बिना भी दर्ज मांग बढ़ जाती है। लोड बढ़ा मान लेने से पहले यह जाँच लेना बेहतर है।</li>
        </ol>
      </section>

      <section class="seo-section">
        <h2>इसे रोकने के तीन तरीक़े</h2>
        <p>उसी क्रम में जिसमें ज़्यादातर लोगों को आज़माने चाहिए:</p>
        <ol>
          <li><strong>चालू होने का समय अलग-अलग कीजिए।</strong> सबसे सस्ता उपाय, और अक्सर अकेले ही काफ़ी। अगर पेनल्टी तीन लोड के एक साथ चालू होने से आ रही है, तो उन्हें कुछ मिनटों के अंतर पर चलाने से शिखर हट जाता है और आपका असल इस्तेमाल घटता भी नहीं। सबसे बड़ी मोटर पर एक टाइम स्विच एक महीने की पेनल्टी के अंश जितना पड़ता है।</li>
          <li><strong>kVA टैरिफ़ पर हैं तो पावर फ़ैक्टर सुधारिए।</strong> ख़राब पावर फ़ैक्टर ठीक करने से दर्ज kVA मांग सीधे घटती है, और कई राज्यों में पावर-फ़ैक्टर प्रोत्साहन भी मिलता है — यानी फ़ायदा दो बार।</li>
          <li><strong>स्वीकृत लोड बढ़वाइए।</strong> यह तब सही है जब ओवरशूट कभी-कभार का नहीं, ढाँचागत हो। यह मुफ़्त नहीं है: ज़्यादा स्वीकृत लोड का मतलब हर महीने, हमेशा के लिए ज़्यादा फिक्स्ड या मांग शुल्क। आवेदन से पहले इस बढ़ोतरी की तुलना उससे कीजिए जो पेनल्टी असल में ले जा रही है — हमारा <a href="/sanctioned-load-optimizer/">स्वीकृत लोड ऑप्टिमाइज़र</a> यही तुलना करता है।</li>
        </ol>
        <p>पहले लोड बढ़वा लेना आम ग़लती है। अगर पेनल्टी बारह में से दो महीने आती है, तो फिक्स्ड शुल्क की
        स्थायी बढ़ोतरी साल भर में पेनल्टी से ज़्यादा पड़ सकती है।</p>
      </section>

      <section class="seo-section">
        <h2>अपने बिल पर इस शुल्क की जाँच</h2>
        <ol>
          <li><strong>बिल पर अपना स्वीकृत लोड या अनुबंधित मांग खोजिए</strong> और देखिए कि वह आपके एग्रीमेंट से मेल खाता है। यहाँ की लिपिकीय ग़लती सबसे पहले ख़ारिज कर लेनी चाहिए।</li>
          <li><strong>दर्ज MD खोजिए</strong> — आमतौर पर MD, Max Demand या Rec. Demand लिखा होता है, kW या kVA में।</li>
          <li><strong>घटाइए।</strong> अगर दर्ज MD स्वीकृत लोड के बराबर या उससे कम है, तो पेनल्टी की लाइन होनी ही नहीं चाहिए।</li>
          <li><strong>अतिरिक्त को ऊपर दी तालिका की पेनल दर से गुणा कीजिए</strong> और बिल की लाइन से मिलाइए।</li>
          <li><strong>इकाई जाँचिए।</strong> kVA में बताई गई सीमा के मुक़ाबले kW में जोड़ी गई पेनल्टी (या उल्टा) एक असली और बार-बार होने वाली बिलिंग ग़लती है — और ख़राब पावर फ़ैक्टर पर दोनों के बीच का फ़र्क़ बड़ा होता है।</li>
        </ol>
        <p>अगर आपका हिसाब और बिल आपस में मेल न खाएँ, तो यह उठाने लायक़ बात है —
        <a href="/check-my-bill/">बिल अपलोड कीजिए</a>, हम उसे टैरिफ़ से दोबारा जोड़ देंगे।</p>
      </section>
    `,
    faqsHi: [
      {
        q: 'क्या MD पेनल्टी और अतिरिक्त मांग शुल्क एक ही चीज़ हैं?',
        a: 'हाँ। डिस्कॉम के हिसाब से यही शुल्क MD पेनल्टी, अतिरिक्त मांग शुल्क, एक्सीडिंग डिमांड चार्ज, पेनल डिमांड चार्ज या डिमांड सरचार्ज लिखा जाता है। सबका मतलब एक है: दर्ज अधिकतम मांग आपके स्वीकृत लोड या अनुबंधित मांग से ऊपर गई, और अतिरिक्त हिस्से पर पेनल दर लग रही है।'
      },
      {
        q: 'पेनल्टी पूरी मांग पर लगती है या सिर्फ़ अतिरिक्त पर?',
        a: 'सिर्फ़ अतिरिक्त पर। स्वीकृत लोड या अनुबंधित मांग तक की मांग सामान्य दर पर ही बिलती है, और केवल उससे ऊपर के हिस्से पर पेनल दर लगती है। पूरी दर्ज मांग पर पेनल दर लगाने वाला बिल ग़लत है।'
      },
      {
        q: 'क्या सच में आधा घंटा पूरे महीने की पेनल्टी तय कर सकता है?',
        a: 'हाँ, और आमतौर पर इसी वजह से यह शुल्क अनुपात से बाहर लगता है। अधिकतम मांग चक्र का सबसे ऊँचा 30-मिनट औसत होती है, इसलिए एक बार का एक-साथ चालू होना उसे तय कर देता है और महीने में आगे कुछ भी उसे घटाता नहीं। अगले चक्र की शुरुआत में यह रीसेट हो जाती है।'
      },
      {
        q: 'क्या घरेलू कनेक्शनों पर MD पेनल्टी लगती है?',
        a: 'आमतौर पर नहीं, क्योंकि ज़्यादातर घरेलू टैरिफ़ दर्ज MD पर मांग शुल्क के बजाय स्वीकृत लोड पर फिक्स्ड शुल्क लेते हैं। यह मुख्यतः वाणिज्यिक, औद्योगिक और HT कनेक्शनों पर लागू होती है। कुछ राज्य स्वीकृत लोड पार करने वाले घरेलू कनेक्शनों पर भी अधिभार लगाते हैं, इसलिए मान लेने के बजाय अपनी अनुसूची देख लीजिए।'
      },
      {
        q: 'क्या मुझे बस स्वीकृत लोड बढ़वा लेना चाहिए?',
        a: 'तभी, जब ओवरशूट नियमित हो। ज़्यादा स्वीकृत लोड आपका फिक्स्ड या मांग शुल्क हर महीने स्थायी रूप से बढ़ा देता है, इसलिए अगर पेनल्टी कभी-कभार आती है तो चालू होने का समय अलग करना सस्ता पड़ सकता है। आवेदन से पहले दोनों की सालाना लागत की तुलना कीजिए।'
      },
      {
        q: 'क्या पेनल्टी पर बिजली शुल्क (ड्यूटी) भी लगता है?',
        a: 'ज़्यादातर राज्यों में हाँ। अतिरिक्त मांग पेनल्टी उन शुल्कों का हिस्सा होती है जिन पर ड्यूटी और ईंधन अधिभार जोड़े जाते हैं, इसलिए बिल में असल बढ़ोतरी पेनल्टी की लाइन से बड़ी होती है।'
      }
    ],
    faqs: [
      {
...

  {
    ...
    titleTa: 'நேர-அடிப்படை (ToD) மின் பட்டியலிடல் விளக்கம்',
    metaTitleTa: 'இந்தியாவில் நேர-அடிப்படை (ToD) மின் பட்டியலிடல், எளிய விளக்கம்',
    descriptionTa: 'நேர-அடிப்படை (ToD) மின் பட்டியலிடல் என்றால் என்ன, இந்தியாவில் இது யாருக்குப் பொருந்தும், ஸ்மார்ட் மீட்டர்களுடன் உச்ச மற்றும் உச்சமல்லாத விகிதங்கள் எப்படி வேலை செய்கின்றன, kVAh பட்டியலிடல் என்றால் என்ன, மற்றும் சுமையை மாற்றி பில்லைக் குறைக்க நடைமுறை வழிகள்.',
    introTa: `நேர-அடிப்படை (ToD) பட்டியலிடல் ஒரு யூனிட் மின்சாரத்தின் விலையை நீங்கள் அதை
      <strong>எப்போது</strong> நுகர்கிறீர்கள் என்பதைப் பொறுத்து மாற்றுகிறது: மாலை உச்ச நேரங்களில் அதிகமாகவும்,
      உச்சமல்லாத மற்றும் சூரிய நேரங்களில் குறைவாகவும் (பெரும்பாலும் தள்ளுபடி). இது வணிக மற்றும் தொழில்துறை
      நுகர்வோருக்கு நீண்ட காலமாகப் பொருந்தி வருகிறது, ஸ்மார்ட் மீட்டர்களுடன் இது படிப்படியாக இந்தியா முழுவதும்
      வீட்டு நுகர்வோரையும் சென்றடைகிறது.`,
    sectionsTa: `
      <section class="seo-section">
        <h2>ToD ஏன் இருக்கிறது</h2>
        <p>அனைவரும் ஒரே நேரத்தில் (மாலை) மின்சாரம் விரும்பும்போது அதை வழங்குவது விலை உயர்ந்தது, சூரிய
        உற்பத்தி கிரிட்டில் நிரம்பும்போது (நண்பகல்) மலிவானது. ToD அந்த செலவு சமிக்ஞையை உங்களுக்குக் கடத்துகிறது:
        நெகிழ்வான சுமைகளை உச்சத்திலிருந்து மாற்றினால் நீங்களும் கிரிட்டும் சேமிக்கிறீர்கள். தேசிய கட்டமைப்பின்
        கீழ், ToD கட்டணங்கள் பெரும்பாலான வணிக/தொழில்துறை நுகர்வோருக்குக் கட்டாயமானவை, ஸ்மார்ட் மீட்டர்கள்
        பொருத்தப்படும்போது வீட்டு நுகர்வோருக்கும் விரிவடைகின்றன.</p>
      </section>
      <section class="seo-section">
        <h2>விகித அமைப்பு எப்படி வேலை செய்கிறது</h2>
        <p>உங்கள் DISCOM-இன் கட்டண ஆணை நாளை பல இடைவெளிகளாகப் பிரிக்கிறது, ஒவ்வொன்றும் சாதாரண ஆற்றல்
        விகிதத்தின் மீது ஒரு கூடுதல் கட்டணம் அல்லது தள்ளுபடியுடன். ஒரு பொதுவான அமைப்பு (சரியான இடைவெளிகளும்
        சதவீதங்களும் மாநிலத்திற்கு மாநிலம் மாறுபடும் — உங்கள் DISCOM-இன் <a href="/tariffs/">கட்டணப் பக்கத்தைப்</a>
        பார்க்கவும்):</p>
        <div class="comparison-table-wrapper"><table class="comparison-table">
          <thead><tr><th>இடைவெளி</th><th>வழக்கமான நேரம்</th><th>வழக்கமான விகிதம்</th></tr></thead>
          <tbody>
            <tr><td><strong>உச்சம்</strong></td><td>~மாலை 6 – இரவு 10 (பெரும்பாலும் காலை உச்சமும்)</td><td>ஆற்றல் விகிதத்தில் +10% முதல் +20%</td></tr>
            <tr><td><strong>சாதாரணம்</strong></td><td>சூரிய/உச்ச இடைவெளிகளுக்கு வெளியே பகல் நேரம்</td><td>நிலையான ஆற்றல் விகிதம்</td></tr>
            <tr><td><strong>உச்சமல்லாத / சூரியம்</strong></td><td>நள்ளிரவு, மற்றும் ~காலை 9 – மாலை 4 சூரிய நேரம்</td><td>−10% முதல் −20% தள்ளுபடி</td></tr>
          </tbody>
        </table></div>
        <p>உங்கள் மீட்டர் ஒவ்வொரு இடைவெளியிலும் நுகர்வைப் பதிவு செய்கிறது; பில் பின்னர் சாதாரண ஆற்றல்
        கட்டணத்துடன் ஒரு ToD கூடுதல்/தள்ளுபடி வரியைக் காட்டுகிறது.</p>
      </section>
      <section class="seo-section">
        <h2>ToD vs kVAh பட்டியலிடல் — ஒன்று அல்ல</h2>
        <p>ToD <em>நேரத்தால்</em> விலையை மாற்றுகிறது. <strong>kVAh பட்டியலிடல்</strong> அளக்கப்படும் அளவை
        மாற்றுகிறது: kWh (உண்மையான ஆற்றல்) க்குப் பதிலாக நீங்கள் kVAh (தோற்ற ஆற்றல்) மீது பட்டியலிடப்படுகிறீர்கள்,
        இதில் ரியாக்டிவ் திறனும் அடங்கும். மோசமான பவர் ஃபேக்டர் kVAh-ஐ kWh-ஐ விட அதிகமாக்குகிறது, எனவே அதே
        சாதனங்கள் அதிக செலவாகும். பல DISCOM-கள் வணிக/தொழில்துறை இணைப்புகளுக்கு இரண்டையும் பயன்படுத்துகின்றன —
        ஒரு DISCOM அவற்றைப் பயன்படுத்தும் இடத்தில் எங்கள் <a href="/#calculator">கணிப்பான்</a> இரண்டையும்
        ஆதரிக்கிறது.</p>
      </section>
      <section class="seo-section">
        <h2>ToD-இன் கீழ் உண்மையில் எப்படி சேமிப்பது</h2>
        <ul>
          <li><strong>மாற்றக்கூடியதை மாற்றுங்கள்:</strong> வாஷிங் மெஷின், டிஷ்வாஷர், நீர் இறைக்கும் பம்பு,
          கீஸர் முன்-சூடாக்கல் மற்றும் EV சார்ஜிங்கை உச்சமல்லாத அல்லது சூரிய நேரங்களுக்கு மாற்றவும் (டைமர்கள்
          மற்றும் ஸ்மார்ட் பிளக்குகள் இதை தானாக்குகின்றன).</li>
          <li><strong>உச்சத்திற்கு முன் முன்-குளிர்விக்கவும்:</strong> மலிவான சூரிய இடைவெளியில் AC-ஐ
          அதிகமாக இயக்கி மாலை 6–10 மணி நேரத்தில் குறைக்கவும்.</li>
          <li><strong>கூரை சூரிய சக்தியுடன் இணைக்கவும்:</strong> பகல்நேர சுய-நுகர்வு ஏற்கனவே கிரிட் மின்சாரம்
          மலிவான இடைவெளியை ஈடுசெய்கிறது, எனவே உங்கள் மாலை தேவைகளுக்கு அமைப்பை அளவிடுங்கள் — எங்கள்
          <a href="/solar-calculator/">சூரிய சேமிப்பு மதிப்பீட்டாளரைப்</a> பார்க்கவும்.</li>
          <li><strong>தொகுதி சுமைகளைக் கவனியுங்கள்:</strong> கடைகள் மற்றும் சிறு தொழில்களுக்கு, கம்ப்ரசர்,
          பம்பிங் அல்லது குளிர்பதன-டிஃப்ரோஸ்ட் சுழற்சிகளை மாலை உச்சத்திலிருந்து மாற்றுவது பொதுவாக மிகப்பெரிய
          சேமிப்பாகும்.</li>
        </ul>
      </section>`,
    faqsTa: [
      { q: 'ToD பட்டியலிடல் வீட்டு (குடியிருப்பு) இணைப்புகளுக்குப் பொருந்துமா?', a: 'பெருகிய முறையில், ஆம். ToD பெரும்பாலான வணிக மற்றும் தொழில்துறை நுகர்வோருக்கு நீண்ட காலமாகக் கட்டாயமானது; இந்தியாவின் ஸ்மார்ட்-மீட்டரிங் கட்டமைப்பின் கீழ் ஸ்மார்ட் மீட்டர் பொருத்தப்பட்டவுடன் இது வீட்டு நுகர்வோருக்கும் விரிவடைகிறது, உச்ச கூடுதல் கட்டணங்களும் சூரிய-நேர தள்ளுபடிகளும் ஒவ்வொரு மாநிலத்தின் கட்டண ஆணையிலும் வரையறுக்கப்படுகின்றன.' },
      { q: 'இந்தியாவில் மின்சாரத்திற்கான வழக்கமான உச்ச நேரங்கள் என்ன?', a: 'மாலை உச்சம் பொதுவாக மாலை 6 முதல் இரவு 10 மணி வரை இருக்கும், மேலும் பல மாநிலங்கள் காலை உச்சத்தையும் வரையறுக்கின்றன. சூரிய நேரங்கள் (தோராயமாக காலை 9 முதல் மாலை 4 வரை) பெருகிய முறையில் மலிவான இடைவெளியாகக் கருதப்படுகின்றன. சரியான இடைவெளிகள் ஒவ்வொரு மாநில நియாமகராலும் நிர்ணயிக்கப்பட்டு கட்டண ஆணையில் அச்சிடப்படுகின்றன.' },
      { q: 'kWh மற்றும் kVAh பட்டியலிடலுக்கு இடையே உள்ள வேறுபாடு என்ன?', a: 'kWh உண்மையான நுகரப்பட்ட ஆற்றலை அளக்கிறது; kVAh தோற்ற ஆற்றலை அளக்கிறது, இது மோட்டார்கள் மற்றும் மோசமான-பவர்-ஃபேக்டர் உபகரணங்களால் இழுக்கப்படும் ரியாக்டிவ் திறனையும் பிரதிபலிக்கிறது. kVAh பட்டியலிடலின் கீழ், 1-ஐ விடக் குறைந்த பவர் ஃபேக்டர் பில் செய்யக்கூடிய யூனிட்களை அதிகரிக்கிறது — பவர் ஃபேக்டரை மேம்படுத்துவது (எ.கா. மின்தேக்கிகளுடன்) நேரடியாக பில்லைக் குறைக்கிறது.' },
      { q: 'ToD பட்டியலிடல் எனது பில்லைக் குறைக்குமா?', a: 'ஆம் — நெகிழ்வான சுமைகளை (EV சார்ஜிங், பம்பிங், துணி துவைத்தல், தண்ணீர் சூடாக்குதல்) உச்சமல்லாத அல்லது சூரிய-தள்ளுபடி இடைவெளிகளுக்கு மாற்றினால், அதே மொத்த நுகர்வு குறைவாக செலவாகும். மாலை நேரங்களிலிருந்து எந்த சுமையையும் மாற்ற முடியாத நுகர்வோர் சிறிது அதிகரிப்பைக் காணக்கூடும்.' },
    ],
  },
...

  {
    ...
    titleTa: 'உங்கள் பில்லில் மின் வரி: அது என்ன, மாநிலங்கள் எப்படி வேறுபடுகின்றன',
    metaTitleTa: 'மின் வரி விளக்கம் — உங்கள் பில்லில் உள்ள வரி ஏன் மாநிலத்திற்கு மாநிலம் மாறுபடுகிறது',
    descriptionTa: 'மின் வரி என்பது உங்கள் மின் பில் மூலம் வசூலிக்கப்படும் ஒரு மாநில வரி. அது எப்படிக் கணக்கிடப்படுகிறது (சதவீதம் vs ஒரு யூனிட்டுக்கு பைசா), ஏன் மாநிலங்களில் பூஜ்ஜியம் முதல் 15%-க்கு மேல் வரை இருக்கிறது, எந்த வகைகள் விலக்கு பெற்றவை, உங்களுடையதை எப்படிச் சரிபார்ப்பது.',
    introTa: `உங்கள் பில்லில் உள்ள "ED" அல்லது "மின் வரி" வரி ஒரு DISCOM கட்டணமே அல்ல — இது பில் மூலம்
      வசூலிக்கப்பட்டு மாநில கருவூலத்திற்குச் செலுத்தப்படும் ஒரு <strong>மாநில அரசு வரி</strong>. ஒவ்வொரு மாநிலமும்
      தனது சொந்த வரியைச் சட்டமாக்குவதால், நீங்கள் எங்கு வசிக்கிறீர்கள் என்பதைப் பொறுத்து அதே நுகர்வு மிகவும்
      வேறுபட்ட வரிச் சுமையைச் சுமக்கலாம்.`,
    sectionsTa: `
      <section class="seo-section">
        <h2>வரி எப்படி விதிக்கப்படுகிறது</h2>
        <p>மாநிலங்கள் இரண்டு அடிப்படைகளில் ஒன்றைப் பயன்படுத்துகின்றன:</p>
        <ul>
          <li><strong>கட்டணங்களின் சதவீதம்</strong> — ஆற்றல் கட்டணத்தின் (மற்றும் பல மாநிலங்களில் நிலையான கட்டணம்
          மற்றும் எரிபொருள் கூடுதல் கட்டணமும்) % ஆக வரி. FPPA முதலில் சேர்க்கப்படுவதால், எரிபொருள் கூடுதல் கட்டண
          உயர்வும் வரி ரூபாயை உயர்த்துகிறது.</li>
          <li><strong>ஒரு யூனிட்டுக்கு பைசா</strong> — நீங்கள் செலுத்தும் விகிதத்தைச் சாராத ஒரு நிலையான ₹/kWh வரி.</li>
        </ul>
        <p>சதவீதம் மாநிலத்திற்கும் நுகர்வோர் வகைக்கும் மிகப்பெரிய அளவில் மாறுபடுகிறது. எங்கள் கட்டணப் பக்கங்களில் உள்ள
        அட்டவணைகளில், <a href="/tariffs/maharashtra/msedcl/">மகாராஷ்டிரா வீட்டு</a> மிக உயர்ந்த சதவீத வரிகளில் ஒன்றைச்
        சுமக்கிறது, <a href="/tariffs/delhi/brpl/">டெல்லி</a> மற்றும் <a href="/tariffs/tamil-nadu/tangedco/">தமிழ்நாடு</a>
        குறைந்த ஒற்றை இலக்கத்தில் உள்ளன, மேலும் <a href="/tariffs/karnataka/bescom/">கர்நாடகா</a> வரி-உள்ளடக்கிய
        கட்டணங்களை வெளியிடுகிறது — ஒரு BESCOM பில்லில் தனி ED வரியே தோன்றாது.</p>
      </section>
      <section class="seo-section">
        <h2>யார் விலக்கு பெற்றவர்கள்</h2>
        <p>விலக்குகளும் மாநிலக் கொள்கையே. பொதுவானவை: விவசாய பம்ப்செட்டுகள், லைஃப்லைன்/BPL வீட்டு அடுக்குகள், அரசு நீர்
        வழங்கல் பணிகள், மற்றும் ஊக்குவிக்கப்பட்ட காலங்களில் சில தொழில்கள். உங்கள் வகை விலக்கு பெற்றால், ED வரி பூஜ்ஜியமாக
        அச்சாக வேண்டும் — உங்கள் பில்லில் ஏதேனும் வகை மாற்றத்திற்குப் பிறகு சரிபார்க்கத் தகுந்தது.</p>
      </section>
      <section class="seo-section">
        <h2>உங்களுடையதை எப்படிச் சரிபார்ப்பது</h2>
        <ol>
          <li><a href="/tariffs/states/">கட்டண அடைவிலிருந்து</a> உங்கள் மாநிலப் பக்கத்தைத் திறக்கவும் — ஒவ்வொரு
          வகை அட்டையின் "கூடுதல் கட்டணங்கள்" வரிசை பயன்படுத்தப்பட்ட வரியைக் காட்டுகிறது.</li>
          <li>அடிப்படையைச் சரிபார்க்கவும்: வரி% × (ஆற்றல் + நிலையான + FPPA) மறுகணக்கிடவும் — அச்சிடப்பட்ட எண் அதிகமாக
          இருந்தால், பில் நிலுவைத் தொகையின் மீது கூட்டுத்தொகையாக இருக்கலாம், அது புகாருக்குத் தகுந்தது.</li>
          <li>ஒவ்வொரு மாநிலத்தின் வரியையும் சரியான அடிப்படையில் தானாகப் பயன்படுத்தும்
          <a href="/#calculator">கணிப்பானைப்</a> பயன்படுத்தவும்.</li>
        </ol>
      </section>`,
    faqsTa: [
      { q: 'என் பில்லில் மின் வரி என்றால் என்ன?', a: 'மின் வரி என்பது உங்கள் மாநில அரசு மின் நுகர்வின் மீது விதிக்கும் வரி, DISCOM உங்கள் பில் மூலம் வசூலித்து மாநில கருவூலத்திற்குச் செலுத்துகிறது. இது மாநிலச் சட்டத்தால் நிர்ணயிக்கப்படுகிறது, எனவே விகிதமும் அடிப்படையும் மாநிலத்திற்கு மாநிலம் வேறுபடுகின்றன.' },
      { q: 'மாநிலங்களுக்கு இடையே மின் வரி ஏன் இவ்வளவு வேறுபடுகிறது?', a: 'வரி என்பது மாநிலச் சட்டம், மத்திய வசூல் அல்ல. ஒவ்வொரு மாநிலமும் அடிப்படையை (கட்டணங்களின் சதவீதம் vs ஒரு யூனிட்டுக்கு பைசா), விகிதம், விலக்குகளைத் தேர்ந்தெடுக்கிறது — அதனால்தான் மகாராஷ்டிராவின் வீட்டு வரி இரட்டை இலக்கத்தில் இருக்க, டெல்லியுடையது 5% ஆகவும் கர்நாடகா அதை அச்சிடப்பட்ட கட்டணத்துள் முழுவதுமாக மடக்கியும் உள்ளது.' },
      { q: 'எரிபொருள் கூடுதல் கட்டணத்தின் (FPPA) மீது மின் வரி விதிக்கப்படுகிறதா?', a: 'பெரும்பாலான மாநிலங்களில், ஆம் — FPPA சேர்க்கப்பட்ட பிறகு வரி பயன்படுத்தப்படுகிறது, அதாவது ஆற்றல் கட்டணம் + நிலையான கட்டணம் + FPPA மீது. அந்த வரிசை என்பது ஒரு எரிபொருள்-கூடுதல் திருத்தம் உங்கள் வரியையும் சற்று உயர்த்துகிறது.' },
      { q: 'எந்த நுகர்வோரும் மின் வரியிலிருந்து விலக்கு பெற்றவரா?', a: 'பல மாநிலங்கள் விவசாய இணைப்புகள், லைஃப்லைன்/BPL வீட்டு அடுக்குகள், மற்றும் சில அரசு அல்லது ஊக்குவிக்கப்பட்ட-தொழில் வகைகளுக்கு விலக்கு அளிக்கின்றன. விலக்குகள் ஒவ்வொரு மாநிலத்தின் வரி அறிவிப்பில் பட்டியலிடப்பட்டுள்ளன; நீங்கள் தகுதி பெற்றால், உங்கள் பில்லில் ED வரி பூஜ்ஜியமாக இருக்க வேண்டும்.' },
    ],
...

  {
    ...
    intro: `Tamil Nadu bills are the most misread in India for one simple reason:
      ...
      and every comparison with other states must be done on a 2-month cycle. Add the free units
      (200 per cycle for most households since FY 2026-27) and the concession cliff at 500 units,
      and two similar households can see very different totals.`,
    sections: `
      <section class="seo-section">
      ...
      <section class="seo-section">
        <h2>2. The free units — 200 or 100, depending on your total</h2>
        <p>Every domestic consumer gets free units each 2-month cycle. Since FY 2026-27
        (G.O. (Ms) No. 50, given effect by TNERC Order No. 5 of 2026), it is
        <strong>200 units free if the cycle total stays within 500 units</strong>, and 100 free
        units above that — earlier it was a flat 100 for everyone. So crossing 500 units does two
        things at once: your free allowance halves <em>and</em> the concessional treatment falls
        away. That's the "cliff" that makes a 510-unit cycle cost far more than a 490-unit
        one.</p>
      </section>
      <section class="seo-section">
      ...
      <section class="seo-section">
        ...
        <ol>
          ...
          <li>Recompute: free units (200 within a ≤500-unit cycle, else 100) → slab ladder on the rest → duty. Or enter <em>half</em> your
    ...
    faqs: [
      ...
      { q: 'How many free electricity units does Tamil Nadu give per cycle?',
        a: 'Since FY 2026-27, 200 units free per 2-month cycle for domestic consumers whose cycle total stays within 500 units, and 100 free units above that (earlier it was a flat 100 for all). The allowance halving at 500 units is part of why the bill jumps at that threshold.' },
    ...
    introHi: `तमिलनाडु के बिल भारत में सबसे ज़्यादा ग़लत पढ़े जाते हैं, एक सीधी वजह से:
      ...
      अन्य राज्यों से हर तुलना 2-महीने के चक्र पर करनी होती है। साथ में मुफ़्त यूनिटें (FY 2026-27 से
      अधिकांश घरों को प्रति चक्र 200) और 500 यूनिट पर रियायत क्लिफ़ जोड़ें, तो दो एक-जैसे घर बहुत अलग
      कुल देख सकते हैं।`,
    sectionsHi: `
      <section class="seo-section">
      ...
      <section class="seo-section">
        <h2>2. मुफ़्त यूनिटें — कुल खपत के हिसाब से 200 या 100</h2>
        <p>हर घरेलू उपभोक्ता को हर 2-महीने चक्र में मुफ़्त यूनिटें मिलती हैं। FY 2026-27 से (शासनादेश
        (Ms) सं. 50, TNERC आदेश सं. 5/2026 से लागू) चक्र कुल <strong>500 यूनिट के भीतर रहे तो 200
        यूनिटें मुफ़्त</strong>, उससे ऊपर 100 — पहले सबके लिए सीधी 100 थीं। यानी 500 पार करते ही दो
        चीज़ें एक साथ होती हैं: मुफ़्त भत्ता आधा हो जाता है <em>और</em> रियायती ढाँचा हट जाता है। यही
        "क्लिफ़" है जो 510-यूनिट चक्र को 490-यूनिट वाले से कहीं महँगा बनाता है।</p>
      </section>
      <section class="seo-section">
        <h2>3. स्लैब सीढ़ी</h2>
      ...
      <section class="seo-section">
        ...
        <ol>
          ...
          <li>दोबारा निकालें: मुफ़्त यूनिटें (≤500 चक्र में 200, वरना 100) → बाक़ी पर स्लैब सीढ़ी → शुल्क। या
    ...
    faqsHi: [
      ...
      { q: 'तमिलनाडु में प्रति चक्र कितनी यूनिटें मुफ़्त हैं?',
        a: 'FY 2026-27 से, जिन घरेलू उपभोक्ताओं का 2-महीने चक्र कुल 500 यूनिट के भीतर रहता है उन्हें 200 यूनिटें मुफ़्त, उससे ऊपर वालों को 100 (पहले सबके लिए सीधी 100 थीं)। 500 पर भत्ते का आधा होना ही उस सीमा पर बिल उछलने की एक बड़ी वजह है।' },
    ...
    introMr: `तमिळनाडूची बिले भारतात सर्वात जास्त चुकीची वाचली जातात, एका साध्या कारणाने:
      ...
      मर्यादा आणि इतर राज्यांशी प्रत्येक तुलना 2-महिन्यांच्या चक्रावर करावी लागते. सोबत मोफत युनिटे
      (FY 2026-27 पासून बहुतेक घरांना प्रति चक्र 200) आणि 500 युनिटवरील सवलत क्लिफ जोडा, तर दोन सारखी
      घरे खूप वेगळे एकूण पाहू शकतात.`,
    sectionsMr: `
      <section class="seo-section">
      ...
      <section class="seo-section">
        <h2>2. मोफत युनिटे — एकूण वापरानुसार 200 किंवा 100</h2>
        <p>प्रत्येक घरगुती ग्राहकाला प्रत्येक 2-महिना चक्रात मोफत युनिटे मिळतात. FY 2026-27 पासून
        (शासनादेश (Ms) क्र. 50, TNERC आदेश क्र. 5/2026 ने लागू) चक्र एकूण <strong>500 युनिटांच्या आत
        राहिले तर 200 युनिटे मोफत</strong>, त्यावर 100 — आधी सर्वांसाठी सरसकट 100 होत्या. म्हणजे 500
        ओलांडताच दोन गोष्टी एकाच वेळी होतात: मोफत भत्ता निम्मा होतो <em>आणि</em> सवलतीची रचना नाहीशी
        होते. हाच तो "क्लिफ" जो 510-युनिट चक्राला 490-युनिट वाल्यापेक्षा खूप महाग बनवतो.</p>
      </section>
      <section class="seo-section">
        <h2>3. स्लॅब शिडी</h2>
      ...
      <section class="seo-section">
        ...
        <ol>
          ...
          <li>पुन्हा काढा: मोफत युनिटे (≤500 चक्रात 200, अन्यथा 100) → उरलेल्यावर स्लॅब शिडी → शुल्क. किंवा <a href="/?state=Tamil%20Nadu#calculator">कॅल्क्युलेटर</a>
    ...
    faqsMr: [
      ...
      { q: 'तमिळनाडूत प्रति चक्र किती युनिटे मोफत आहेत?',
        a: 'FY 2026-27 पासून, ज्या घरगुती ग्राहकांचे 2-महिना चक्र एकूण 500 युनिटांच्या आत राहते त्यांना 200 युनिटे मोफत, त्यावर 100 (आधी सर्वांसाठी सरसकट 100 होत्या). 500 वर भत्ता निम्मा होणे हेच त्या मर्यादेवर बिल उसळण्याचे एक मोठे कारण आहे.' },
    ...
    titleTa: 'உங்கள் TNEB / TANGEDCO மின் பில்லை எப்படிப் படிப்பது',
    metaTitleTa: 'TNEB (TANGEDCO) பில் எப்படிப் படிப்பது — இருமாத அடுக்குகள் & இலவச யூனிட்',
    descriptionTa: 'தமிழ்நாடு (TNEB/TANGEDCO) மின் பில்களின் வரி-வரியான விளக்கம்: பில் ஏன் இருமாதம், இலவச யூனிட்கள் (FY 2026-27 முதல் பெரும்பாலானோருக்கு சுழற்சிக்கு 200) எப்படி வேலை செய்கின்றன, சலுகைகளை நீக்கும் 500-யூனிட் எல்லை, 1000+ யூனிட் வரை அடுக்குக் கணக்கு, மற்றும் மொத்தத்தை எப்படிச் சரிபார்ப்பது.',
    introTa: `தமிழ்நாட்டு பில்கள் இந்தியாவிலேயே அதிகம் தவறாகப் படிக்கப்படுபவை, ஒரு எளிய காரணத்தால்:
      <strong>TANGEDCO இரண்டு மாதங்களுக்கு ஒருமுறை பில் அனுப்புகிறது</strong>, எனவே ஒவ்வொரு
      அடுக்கும், ஒவ்வொரு இலவச-யூனிட் வரம்பும், மற்ற மாநிலங்களுடன் ஒவ்வொரு ஒப்பீடும் 2-மாத
      சுழற்சியில் செய்யப்பட வேண்டும். இதனுடன் இலவச யூனிட்கள் (FY 2026-27 முதல் பெரும்பாலான
      குடும்பங்களுக்கு சுழற்சிக்கு 200) மற்றும் 500 யூனிட்டில் சலுகை எல்லை சேர்த்தால், ஒரே மாதிரியான
      இரு வீடுகள் மிக வேறுபட்ட மொத்தங்களைக் காணலாம்.`,
    sectionsTa: `
      <section class="seo-section">
        <h2>1. இருமாத பில் — குழப்பத்தின் #1 காரணம்</h2>
        <p>உங்கள் "மாதாந்திர" நுகர்வு உண்மையில் இரண்டு மாத யூனிட்கள். மற்ற மாநில நண்பர்களுடன்
        ஒப்பிடும்போது — அல்லது மாத அடுக்குகளில் கட்டமைக்கப்பட்ட எந்தக் கணிப்பானையும் பயன்படுத்தும்போது
        — முதலில் உங்கள் TNEB யூனிட்களைப் பாதியாக்குங்கள். எங்கள்
        <a href="/?state=Tamil%20Nadu#calculator">தமிழ்நாடு கணிப்பான்</a> மாதாந்திர மதிப்பீட்டைக்
        காட்டுகிறது; இருமாத பில்லைச் சரிபார்க்க இரண்டால் பெருக்குங்கள்.</p>
      </section>
      <section class="seo-section">
        <h2>2. இலவச யூனிட்கள் — மொத்த நுகர்வைப் பொறுத்து 200 அல்லது 100</h2>
        <p>ஒவ்வொரு வீட்டு நுகர்வோருக்கும் ஒவ்வொரு 2-மாத சுழற்சியிலும் இலவச யூனிட்கள் கிடைக்கின்றன.
        FY 2026-27 முதல் (அரசாணை (Ms) எண் 50, TNERC ஆணை எண் 5/2026 மூலம் அமல்), சுழற்சி மொத்தம்
        <strong>500 யூனிட்டுக்குள் இருந்தால் 200 யூனிட் இலவசம்</strong>, அதற்கு மேல் 100 — முன்பு
        அனைவருக்கும் சமமாக 100 ஆக இருந்தது. எனவே 500 யூனிட்டைத் தாண்டுவது இரண்டைச் செய்கிறது: உங்கள்
        இலவச ஒதுக்கீடு பாதியாகிறது <em>மேலும்</em> சலுகை அமைப்பு நீங்குகிறது. இதுவே 510-யூனிட்
        சுழற்சியை 490-யூனிட் சுழற்சியை விட மிக விலை உயர்வாக்கும் "எல்லை".</p>
      </section>
      <section class="seo-section">
        <h2>3. அடுக்கு ஏணி</h2>
        <p>இலவசத் தொகுதிக்கு மேல், அடுக்குகள் சுழற்சிக்கு 200, 500, 1000 யூனிட்களில் படிகளாக ஏறுகின்றன
        (அடுக்கு வாரியாக), உச்ச அடுக்கு 1000-க்கு மேல் பொருந்தும். தற்போதைய யூனிட் விகிதங்கள்
        <a href="/ta/tariffs/tamil-nadu/tangedco/">TANGEDCO கட்டணப் பக்கத்தில்</a> உள்ளன. வீட்டு
        இணைப்புகளுக்கு நிலையான கட்டணம் சுழற்சிக்கு ஒரு சிறிய தொகை, மேலும் மின் கட்டணத்தின் மீது 5%
        மின்சார வரி சேர்கிறது.</p>
      </section>
      <section class="seo-section">
        <h2>4. மொத்தத்தைச் சரிபார்க்கவும்</h2>
        <ol>
          <li>வாசிப்புத் தேதிகள் ~60 நாட்கள் பரவியிருப்பதை உறுதிசெய்யுங்கள் — நீண்ட சுழற்சி யூனிட்களை
          அமைதியாக உயர் அடுக்குகளுக்குத் தள்ளுகிறது.</li>
          <li>சரிபார்க்கவும்: யூனிட் = (தற்போதைய − முந்தைய) × MF.</li>
          <li>மீண்டும் கணக்கிடுங்கள்: இலவச யூனிட்கள் (≤500 சுழற்சியில் 200, இல்லையேல் 100) → மீதியில்
          அடுக்கு ஏணி → வரி. அல்லது <a href="/?state=Tamil%20Nadu#calculator">கணிப்பானில்</a> உங்கள்
          சுழற்சியின் <em>பாதி</em> யூனிட்களை உள்ளிட்டு முடிவை இரட்டிப்பாக்குங்கள்.</li>
          <li>பழக்கம் மாறாமல் பில் உயர்ந்தால், பொதுவாக சுழற்சி 500 யூனிட்டைத் தாண்டியதே காரணம் — எங்கள்
          <a href="/ta/guides/tamil-nadu-electricity-tariff-july-2026/">தமிழ்நாடு கட்டண விளக்கத்தைப்</a>
          பாருங்கள்.</li>
        </ol>
      </section>`,
    faqsTa: [
      { q: 'என் TNEB பில் ஏன் இரண்டு மாதங்களுக்கு?',
        a: 'TANGEDCO வீட்டு நுகர்வோருக்கு இருமாதமாக பில் அனுப்புகிறது — மீட்டர்கள் ~60 நாட்களுக்கு ஒருமுறை வாசிக்கப்படுகின்றன, அனைத்து அடுக்குகளும் இலவச-யூனிட் வரம்புகளும் 2-மாத சுழற்சிக்கு வரையறுக்கப்பட்டவை. மாதாந்திர பில் மாநிலங்களுடன் ஒப்பிடுமுன் யூனிட்களைப் பாதியாக்குங்கள்.' },
      { q: 'தமிழ்நாட்டில் சுழற்சிக்கு எத்தனை யூனிட்கள் இலவசம்?',
        a: 'FY 2026-27 முதல், 2-மாத சுழற்சி மொத்தம் 500 யூனிட்டுக்குள் இருக்கும் வீட்டு நுகர்வோருக்கு 200 யூனிட் இலவசம், அதற்கு மேல் 100 (முன்பு அனைவருக்கும் சமமாக 100). 500-இல் ஒதுக்கீடு பாதியாவதே அந்த எல்லையில் பில் உயர்வதற்கான ஒரு முக்கியக் காரணம்.' },
      { q: 'என் பயன்பாடு பெரிதாக மாறாவிட்டாலும் TNEB பில் ஏன் உயர்ந்தது?',
        a: 'மிகவும் பொதுவான காரணம் 2-மாத சுழற்சிக்கான 500-யூனிட் எல்லையைத் தாண்டுவது, இது முழு பில்லுக்கும் சலுகை விகிதங்களை நீக்குகிறது — 20-யூனிட் அதிகரிப்பு விகிதாசாரமின்றி தொகையைச் சேர்க்கலாம். நீண்ட வாசிப்புச் சுழற்சிகளும் மதிப்பீட்டு வாசிப்புகளும் அடுத்த சந்தேகங்கள்.' },
      { q: 'TANGEDCO மின்சார வரி வசூலிக்கிறதா?',
        a: 'ஆம் — தமிழ்நாடு மின் கட்டணத்தின் மீது 5% மின்சார வரி சேர்க்கிறது, பெரிய மாநிலங்களில் குறைந்த விகிதங்களில் ஒன்று. இது அடுக்குக் கட்டணங்களுக்குப் பிறகு தனி வரியாகக் காட்டப்படும்.' },
    ],
  },

  {
    ...
    titleTa: 'சூரிய நெட் மீட்டரிங்: சேமிப்பு உண்மையில் எப்படி வேலை செய்கிறது',
    metaTitleTa: 'சூரிய நெட் மீட்டரிங் சேமிப்பு விளக்கம் — வரவுகள், அளவீடு & திருப்பிச் செலுத்தல்',
    descriptionTa: 'ஒரு இந்திய மின் பில்லில் கூரை சூரிய நெட் மீட்டரிங் வரவுகள் எப்படி வேலை செய்கின்றன, ஏன் அதே அமைப்பு வெவ்வேறு மாநிலங்களில் வெவ்வேறு தொகைகளைச் சேமிக்கிறது, அடுக்கு விகிதங்கள் கணக்கை எப்படி மாற்றுகின்றன, அளவீட்டு விதிமுறைகள் மற்றும் திருப்பிச் செலுத்தலை எது இயக்குகிறது.',
    introTa: `நெட் மீட்டரிங் உங்கள் கூரை சூரிய அமைப்பை உங்கள் மீட்டரை இரு திசைகளிலும் இயக்க அனுமதிக்கிறது:
      நீங்கள் ஏற்றுமதி செய்யும் யூனிட்கள் நீங்கள் இறக்குமதி செய்யும் யூனிட்களை ஈடுசெய்கின்றன, நீங்கள் (தோராயமாக)
      <strong>நிகரத்திற்கு</strong> மட்டுமே செலுத்துகிறீர்கள். ஆனால் "தோராயமாக" என்பதுதான் பணம் மறைந்திருக்கும்
      இடம் — அதே 3 kW அமைப்பு ஒரு மாநிலத்தில் 4 ஆண்டுகளிலும் இன்னொன்றில் 8 ஆண்டுகளிலும் திருப்பிச் செலுத்தலாம்,
      ஏனெனில் ஈடுசெய்யப்பட்ட ஒரு யூனிட்டின் மதிப்பு <em>உங்கள்</em> கட்டணத்தைப் பொறுத்தது.`,
    sectionsTa: `
      <section class="seo-section">
        <h2>பட்டியலிடல் எப்படி வேலை செய்கிறது</h2>
        <p>நெட் மீட்டரிங்குடன், ஒரு இருதிசை மீட்டர் இறக்குமதி மற்றும் ஏற்றுமதியை தனித்தனியாகப் பதிவு
        செய்கிறது. பட்டியலிடும்போது, ஏற்றுமதி யூனிட்கள் இறக்குமதி யூனிட்களுக்கு எதிராக நிகரப்படுத்தப்படுகின்றன;
        நீங்கள் நிகர இறக்குமதியின் மீது கட்டணம் செலுத்துகிறீர்கள், உபரி ஏற்றுமதி பொதுவாக வரவாக முன்னெடுக்கப்படுகிறது
        (ஆண்டு இறுதியில் குறைந்த விகிதத்தில் தீர்க்கப்படுகிறது). மக்கள் தவறவிடும் இரண்டு விளைவுகள்:</p>
        <ul>
          <li><strong>நிலையான கட்டணங்கள், வரி மற்றும் கூடுதல் கட்டணங்கள் மறைந்துவிடாது</strong> — அவை
          உங்கள் அனுமதிக்கப்பட்ட சுமை மற்றும் நிகர நுகர்வின் மீது வழக்கம் போல் பொருந்தும்.</li>
          <li><strong>ஈடுசெய்யப்பட்ட யூனிட்கள் உங்கள் உச்ச-அடுக்கு விகிதத்திற்கு மதிப்புடையவை.</strong>
          நிகரப்படுத்துதல் முதலில் மிக விலையுயர்ந்த யூனிட்களைக் குறைக்கிறது — எனவே உயர் அடுக்குகளில் ஆழமாக
          இருக்கும் வீடுகள் உற்பத்தி செய்யப்படும் ஒரு யூனிட்டுக்கு அதிகமாக சேமிக்கின்றன.</li>
        </ul>
      </section>
      <section class="seo-section">
        <h2>சேமிப்பு மாநிலத்திற்கு மாநிலம் ஏன் வேறுபடுகிறது</h2>
        <p>மூன்று காரணிகள் பொருளாதாரத்தை மாற்றுகின்றன:</p>
        <ol>
          <li><strong>உங்கள் அடுக்கு ஏணி.</strong> செங்குத்தான ஏணிகள் (<a href="/tariffs/maharashtra/msedcl/">மகாராஷ்டிரா</a>
          பார்க்கவும்) ஒவ்வொரு ஈடுசெய்யப்பட்ட யூனிட்டையும் அதிக மதிப்புடையதாக்குகின்றன; தட்டையான அல்லது
          மானியமளிக்கப்பட்ட ஏணிகள் (<a href="/tariffs/karnataka/bescom/">கர்நாடகா</a> அல்லது
          <a href="/tariffs/tamil-nadu/tangedco/">தமிழ்நாடு</a>-வின் இலவச-யூனிட் திட்டங்கள்) சிறிய அமைப்புகளை
          பயனற்றதாக்கக்கூடும் — ஏற்கனவே இலவசமாக இருந்த யூனிட்களில் உங்களால் சேமிக்க முடியாது.</li>
          <li><strong>மாநிலத்தின் நெட்-மீட்டரிங் விதிகள்.</strong> மாநிலங்கள் தகுதியான அமைப்பு அளவுகள், நெட்
          மீட்டரிங் vs நெட் பில்லிங் (குறைந்த ஃபீட்-இன் விகிதத்தில் ஏற்றுமதி வரவு) மற்றும் தீர்வு காலங்களில்
          வேறுபடுகின்றன — அளவிடுவதற்கு முன் உங்கள் DISCOM-இன் தற்போதைய விதிமுறைகளைச் சரிபார்க்கவும்.</li>
          <li><strong>மானியம்.</strong> மத்திய கூரை திட்டம் (PM சூர்ய கர்) குடியிருப்பு அமைப்புகளுக்கு ஒரு
          உச்சவரம்பு தொகை வரை மானியம் அளிக்கிறது; மாநில கூடுதல் தொகைகள் மாறுபடும்.</li>
        </ol>
      </section>
      <section class="seo-section">
        <h2>அளவீடு: உங்கள் பகல்நேர + உச்ச-அடுக்கு பயன்பாட்டைப் பொருத்துங்கள்</h2>
        <p>ஒரு நடைமுறை விதி: உங்கள் <em>முழு</em> பில்லை அல்ல, உங்கள் <em>உச்ச-அடுக்கு</em> நுகர்வை
        அழிக்க அமைப்பை அளவிடுங்கள். இந்தியாவின் பெரும்பாலான பகுதிகளில் ஒவ்வொரு kW கூரை சூரிய சக்தியும்
        தோராயமாக 4 யூனிட்/நாள் (110–130 யூனிட்/மாதம்) உற்பத்தி செய்கிறது. எங்கள் <a href="/solar-calculator/">சூரிய
        சேமிப்பு மதிப்பீட்டாளர்</a> இதை உங்கள் உண்மையான DISCOM கட்டணத்திற்கு எதிராகச் செய்கிறது — உங்கள் மாதாந்திர
        யூனிட்களை உள்ளிடவும், அது <a href="/#calculator">பில் கணிப்பானின்</a> அதே இயந்திரத்திலிருந்து அமைப்பு
        அளவு, சூரியத்திற்குப் பிந்தைய பில் மற்றும் திருப்பிச் செலுத்தலைக் கணக்கிடுகிறது.</p>
      </section>
      <section class="seo-section">
        <h2>திருப்பிச் செலுத்தலை எது இயக்குகிறது</h2>
        <ul>
          <li><strong>குறுகிய திருப்பிச் செலுத்தல்:</strong> உயர் உச்ச-அடுக்கு விகிதங்கள், அதிக பகல்நேர
          சுய-நுகர்வு, மானியம் பெறப்பட்டது, நெட் (மொத்தமல்ல) மீட்டரிங்.</li>
          <li><strong>நீண்ட திருப்பிச் செலுத்தல்:</strong> பெரிதும் மானியமளிக்கப்பட்ட நுகர்வு (இலவச-யூனிட்
          திட்டங்கள்), அமைப்பு அளவில் குறைந்த அனுமதிக்கப்பட்ட சுமை வரம்புகள், ஏற்றுமதிகளின் ஃபீட்-இன்-விகித
          தீர்வு.</li>
        </ul>
        <p>ஒரு விற்பனையாளருடன் ஒப்பந்தம் செய்வதற்கு முன், <a href="/solar-calculator/">மதிப்பீட்டாளரிலும்</a>
        உங்கள் DISCOM-இன் <a href="/tariffs/states/">கட்டணப் பக்கத்திற்கு</a> எதிராகவும் எண்களை நீங்களே
        இயக்கிப் பாருங்கள் — விற்பனையாளரின் "70% சேமிப்பு" சொல்முறை மிகவும் செங்குத்தான கட்டணத்தை
        அனுமானிக்கிறது, அது உங்களுடையதாக இருக்காமல் போகலாம்.</p>
      </section>`,
    faqsTa: [
      { q: 'நெட் மீட்டரிங் எனது மின் பில்லை எப்படிக் குறைக்கிறது?', a: 'ஏற்றுமதி செய்யப்பட்ட சூரிய யூனிட்கள் இறக்குமதி யூனிட்களுக்கு எதிராக நிகரப்படுத்தப்படுகின்றன, எனவே நீங்கள் நிகர நுகர்வின் மீது மட்டுமே கட்டணம் செலுத்துகிறீர்கள் — நிகரப்படுத்துதல் முதலில் உங்கள் மிக விலையுயர்ந்த (உச்ச-அடுக்கு) யூனிட்களை நீக்குவதால், ஒவ்வொரு சூரிய யூனிட்டும் சராசரி அல்ல, உங்கள் உயர்ந்த பொருந்தும் விகிதத்திற்கு மதிப்புடையது.' },
      { q: '1 kW கூரை சூரிய சக்தி எத்தனை யூனிட்கள் உற்பத்தி செய்கிறது?', a: 'தோராயமாக ஒரு நாளைக்கு 4 யூனிட்கள் — இந்தியாவின் பெரும்பாலான பகுதிகளில் மாதத்திற்கு சுமார் 110–130 யூனிட்கள், இடம், திசை மற்றும் பருவத்திற்கு ஏற்ப மாறுபடும். எனவே 3 kW அமைப்பு மாதத்திற்கு சுமார் 330–390 யூனிட்களை ஈடுசெய்கிறது.' },
      { q: 'எனக்கு இலவச மின் யூனிட்கள் கிடைத்தால் நெட் மீட்டரிங் மதிப்புள்ளதா?', a: 'சிறிய அமைப்புகளுக்கு பெரும்பாலும் இல்லை. ஒரு மாநில திட்டம் (கர்நாடகாவின் கிருஹ ஜோதி அல்லது தமிழ்நாட்டின் இலவச-யூனிட் தொகுதி போன்றவை) ஏற்கனவே உங்கள் பில்லை பூஜ்ஜியமாக்கினால், சூரிய சக்தி இலவச உரிமையைத் தாண்டிய நுகர்வில் மட்டுமே சேமிக்க முடியும் — அந்த உபரிக்கு ஏற்ப அளவிடுங்கள், அல்லது உங்கள் பயன்பாடு அதிகரிக்கும் வரை காத்திருங்கள்.' },
      { q: 'நெட் மீட்டரிங் மற்றும் நெட் பில்லிங் இடையே உள்ள வேறுபாடு என்ன?', a: 'நெட் மீட்டரிங்கில், ஏற்றுமதி யூனிட்கள் உங்கள் சில்லறை கட்டணத்தில் ஒன்றுக்கு-ஒன்று இறக்குமதி யூனிட்களை ஈடுசெய்கின்றன. நெட் பில்லிங்கில் (மொத்த தீர்வு), ஏற்றுமதிகளுக்கு குறைந்த ஃபீட்-இன் விகிதத்தில் பணம் வழங்கப்படும்போது இறக்குமதிகளுக்கு முழு கட்டணமும் செலவாகும் — அதே வன்பொருள், கணிசமாக மோசமான பொருளாதாரம். எது பொருந்தும் என்பது உங்கள் மாநிலத்தின் தற்போதைய விதிமுறைகளைப் பொறுத்தது.' },
    ],
  },
      ...
      <section class="seo-section">
        ...
        <div class="comparison-table-wrapper"><table class="comparison-table">
          ...
          <tbody>
            ...
            <tr><td><strong>अतिरिक्त अनामत रक्कम</strong></td><td>अनामत रक्कम भार व वापराशी जोडलेली आहे, म्हणून भार वाढल्यानंतर डिस्कॉम एकवेळ अतिरिक्त अनामतीची मागणी करू शकतो.</td></tr>
          </tbody>
        </table></div>
...

  {
    ...
    titleTa: 'உங்கள் ஸ்மார்ட் மீட்டர் வேகமாக ஓடுகிறதா? அதை நீங்களே எப்படி சோதிப்பது',
    metaTitleTa: 'ஸ்மார்ட் மீட்டர் வேகமாக ஓடுகிறதா? பொருத்திய பின் அதிக பில் — எப்படி சோதிப்பது',
    descriptionTa: 'ஸ்மார்ட் மீட்டர் பொருத்திய உடனேயே மின் பில்கள் ஏன் அதிகரிக்கின்றன, ஸ்மார்ட் மீட்டர்கள் உண்மையில் பழைய மீட்டர்களை விட அதிகமாகப் பதிவு செய்கின்றனவா, வீட்டிலேயே 30 நிமிடங்களில் நீங்களே செய்யக்கூடிய சோதனை, மற்றும் உங்கள் DISCOM-இடம் நீங்கள் கோரக்கூடிய அதிகாரப்பூர்வ மீட்டர்-துல்லிய சோதனை.',
    introTa: `ஸ்மார்ட் மீட்டர்கள் <strong>அதிகமாக பில் செய்ய வடிவமைக்கப்படவில்லை</strong> — ஆனால் ஒன்று
      பொருத்திய உடனேயே பல நுகர்வோருக்கு பில்கள் உண்மையிலேயே அதிகரிக்கின்றன, காரணங்கள் பொதுவாக சாதாரணமானவை:
      பழைய மீட்டர் மெதுவாக இருந்தது, நின்றுவிட்டது அல்லது மதிப்பிடப்பட்டு வந்தது, புதிய மீட்டர் அனைத்தையும்
      அளக்கிறது. இந்த வழிகாட்டி ஏன் இந்த அதிகரிப்பு நிகழ்கிறது, ஏற்கனவே உங்களிடம் உள்ள ஒரு சாதனத்துடன் மட்டும்
      சுமார் 30 நிமிடங்களில் உங்கள் சொந்த மீட்டரை எப்படி சோதிப்பது, மற்றும் எண்கள் இன்னும் பொருந்தாவிட்டால்
      அதிகாரப்பூர்வ துல்லிய சோதனையை எப்படிக் கோருவது என்பதை விளக்குகிறது.`,
    sectionsTa: `
      <section class="seo-section">
        <h2>ஸ்மார்ட் மீட்டர் பொருத்திய உடனேயே பில்கள் ஏன் அதிகரிக்கின்றன</h2>
        <p>புதிய மீட்டர் வேகமாக இருக்கிறது என்று கருதுவதற்கு முன், நான்கு பொதுவான காரணங்களை நீக்குங்கள் —
        எதுவும் ஒரு குறைபாடுள்ள மீட்டரை உள்ளடக்கவில்லை:</p>
        <div class="comparison-table-wrapper"><table class="comparison-table">
          <thead><tr><th>காரணம்</th><th>உண்மையில் என்ன நடந்தது</th></tr></thead>
          <tbody>
            <tr><td><strong>பழைய மீட்டர் மெதுவாக இருந்தது அல்லது நின்றுவிட்டது</strong></td><td>எலக்ட்ரோமெக்கானிக்கல் (டிஸ்க்) மீட்டர்கள் வயதாகும்போது துல்லியத்தை இழந்து பெரும்பாலும் ஆண்டுக்கணக்கில் குறைவாகப் பதிவு செய்கின்றன. ஸ்மார்ட் மீட்டரின் அளவீடே சரியானது — "அதிகரிப்பு" என்பது உங்களிடம் ஒருபோதும் பில் செய்யப்படாத நுகர்வு.</td></tr>
            <tr><td><strong>நீங்கள் மதிப்பிடப்பட்ட அளவீடுகளில் இருந்தீர்கள்</strong></td><td>பழைய மீட்டர் அணுக முடியாதது அல்லது குறைபாடுடையதாக இருந்தால் (பில்லில் IDF/RDF போன்ற குறியீடுகள்), DISCOM உங்கள் பயன்பாட்டை யூகித்தது — பெரும்பாலும் குறைவாக. முதல் உண்மையான அளவீடுகள் ஒரு பாய்ச்சலாகத் தெரியும்.</td></tr>
            <tr><td><strong>ஒரு கேட்ச்-அப் அல்லது சரிசெய்தல் பில்</strong></td><td>பழைய மீட்டரின் இறுதி அளவீடு மற்றும் புதியதன் முதல் காலகட்டம் சில நேரங்களில் ஒரே பில்லில் விழுகிறது, அந்த மாதத்திற்கு மட்டும் யூனிட்களை உயர்ந்த <a href="/glossary/#telescopic-slabs">அடுக்குகளுக்கு</a> தள்ளுகிறது.</td></tr>
            <tr><td><strong>தேவை இப்போது பதிவு செய்யப்படுகிறது</strong></td><td>ஸ்மார்ட் மீட்டர்கள் <a href="/glossary/#maximum-demand">அதிகபட்ச தேவையை</a> பதிவு செய்கின்றன, பழைய வீட்டு மீட்டர்கள் இதை ஒருபோதும் அளக்கவில்லை. இது ஒரு அனுமதிக்கப்பட்ட-சுமை திருத்தத்தையும் அதிக நிலையான கட்டணங்களையும் தூண்டக்கூடும் — <a href="/guides/uppcl-sanctioned-load-increased/">ஸ்மார்ட் மீட்டருக்குப் பிறகு அனுமதிக்கப்பட்ட சுமை ஏன் அதிகரிக்கிறது</a> என்பதைப் பார்க்கவும்.</td></tr>
          </tbody>
        </table></div>
        <p>உங்கள் பில் உயர்ந்தது ஆனால் <em>யூனிட்கள்</em> கடந்த ஆண்டு அதே பருவத்தை ஒத்திருந்தால், காரணம்
        ஒரு கட்டணம் அல்லது கட்டண மாற்றம் — <a href="/guides/why-did-my-electricity-bill-increase/">பில்-அதிகரிப்பு
        சரிபார்ப்புப் பட்டியலைப்</a> பயன்படுத்துங்கள்.</p>
      </section>
      <section class="seo-section">
        <h2>ஒரு ஸ்மார்ட் மீட்டர் உண்மையில் வேகமாக ஓட முடியுமா?</h2>
        <p>எந்த மீட்டரும் குறைபாடுடையதாக இருக்கலாம், ஆனால் ஸ்மார்ட் மீட்டர் அது மாற்றியதை விட அதிகமாகப்
        படிக்க <em>குறைவாகவே</em> வாய்ப்புள்ளது. ஸ்மார்ட் மீட்டர்கள் <strong>துல்லிய வகுப்பு 1.0</strong>
        (±1% அனுமதிக்கப்பட்ட பிழை) கொண்ட ஸ்டேடிக் (எலக்ட்ரானிக்) மீட்டர்கள் — பழைய டிஸ்க் மீட்டர்கள் பொதுவாக
        வகுப்பு 2.0 (±2%) கொண்டவை, தேய்மானத்துடன் மேலும் விலகின. DISCOM ஒரு மீட்டரை தொலைவிலிருந்து
        "வேகப்படுத்த" எந்த வழிமுறையும் இல்லை: மீட்டர் ஃபர்ம்வேர் சீல் செய்யப்பட்டது, அளவீடுகள் மீட்டரின்
        சொந்த நினைவகத்தில் பதிவு செய்யப்படுகின்றன — இதுவே கீழே உள்ள சுய-சோதனையை உறுதியானதாக்குகிறது.</p>
        <p>ஒரு ஸ்மார்ட் மீட்டர் <em>உண்மையில்</em> செய்வது பழைய அமைப்பு தவறவிட்ட நுகர்வைப் பிடிப்பதுதான்:
        சிறிய ஸ்டாண்ட்பை சுமைகள் இருபத்தி நான்கு மணி நேரமும், துல்லியமான குறைந்த-மின்னோட்ட அளவீடு, ஒவ்வொரு
        நாளும் மதிப்பிடப்படாமல் மீட்டரிடப்படுகிறது. இது அளவீட்டு முழுமை, அதிக-பதிவு அல்ல.</p>
      </section>
      <section class="seo-section">
        <h2>30-நிமிட சுய-சோதனை</h2>
        <p>நீங்கள் நம்பும் ஒரு சாதனம் தேவை — ஒரு 2,000 W (2 kW) கீஸர் அல்லது அறை ஹீட்டர் சிறந்தது ஏனெனில்
        அதன் இழுப்பு நிலையானது:</p>
        <ol>
          <li><strong>அனைத்தையும் அணைக்கவும்</strong> முதன்மை போர்டில், நீங்கள் பார்க்க ஒரு விளக்கைத்
          தவிர. மீட்டர் அளவீட்டை (அல்லது உங்கள் DISCOM-இன் ஸ்மார்ட்-மீட்டர் ஆப்பில் உள்ள அளவீட்டை) இரண்டு
          தசம இடங்கள் வரை குறிக்கவும்.</li>
          <li><strong>அறியப்பட்ட சுமையை சரியாக 30 நிமிடங்கள் இயக்கவும்.</strong> ஒரு 2 kW சாதனம் அரை
          மணி நேரத்திற்கு கிட்டத்தட்ட சரியாக <strong>1.0 யூனிட்</strong> (2 kW × 0.5 மணி) நுகர வேண்டும்.</li>
          <li><strong>மீட்டரை மீண்டும் படிக்கவும்.</strong> வகுப்பு-1 சகிப்புத்தன்மைக்குள் நீங்கள் 0.98–1.02
          யூனிட்களைக் காண வேண்டும். மீட்டர் அந்த அரை மணி நேரத்திற்கு, சொல்லுங்கள், 1.3 யூனிட்களைக் காட்டினால்,
          உங்களிடம் அதிக-பதிவுக்கான உண்மையான ஆதாரம் உள்ளது — அதிகாரப்பூர்வ சோதனைக்குச் செல்லுங்கள்.</li>
        </ol>
        <p>இரண்டு செம்மைப்படுத்தல்கள்: எங்காவது ஒரு ஃபிரிட்ஜ் அல்லது பம்ப் சுழற்சி இயங்குவதை நீக்க சோதனையை
        இரண்டு முறை இயக்கவும், ஹீட்டர் கூறுகள் வழங்கல் மின்னழுத்தத்துடன் சிறிது மாறுபடும் என்பதை நினைவில்
        கொள்ளுங்கள் — இந்த முறைசாரா முறைக்கு எதிர்பார்த்ததில் ±5% உள்ள முடிவு சாதாரணமானது. வீட்டு ஒற்றை-கட்ட
        மீட்டருக்கு பில்லின் <a href="/glossary/#multiplying-factor">பெருக்கல் காரணி</a> 1 ஆக அச்சிடப்பட்டுள்ளதையும்
        சரிபார்க்கவும்; தவறான MF ஒவ்வொரு யூனிட்டையும் பெருக்குகிறது.</p>
      </section>
      <section class="seo-section">
        <h2>அதிகாரப்பூர்வ வழி: ஒரு மீட்டர் துல்லிய சோதனையைக் கோருங்கள்</h2>
        <p>ஒவ்வொரு மாநிலத்தின் மின்சார வழங்கல் நெறிமுறையும் உங்கள் மீட்டரைச் சோதிக்கும் உரிமையை வழங்குகிறது:</p>
        <ol>
          <li><strong>உங்கள் துணைப் பிரிவு அலுவலகத்தில் விண்ணப்பிக்கவும்</strong> (அல்லது DISCOM-இன் ஆன்லைன்
          நுகர்வோர் போர்ட்டல்) ஒரு மீட்டர் துல்லிய சோதனைக்கு, உங்கள் சுய-சோதனை முடிவைக் குறிப்பிட்டு. ஒரு சிறிய
          சோதனைக் கட்டணம் பொருந்தும் — மீட்டர் குறைபாடுடையதாக இருந்தால் அது <strong>திரும்பப் பெறப்படும் அல்லது
          உங்கள் பில்லில் சரிசெய்யப்படும்</strong>.</li>
          <li><strong>ஒரு சரிபார்ப்பு மீட்டரைக் கேளுங்கள்.</strong> DISCOM ஒரு சுழற்சி அல்லது இரண்டிற்கு உங்கள்
          மீட்டருடன் தொடராக ஒரு இரண்டாவது, சோதிக்கப்பட்ட மீட்டரைப் பொருத்துகிறது; அளவீடுகள் ஒப்பிடப்படுகின்றன.
          இது இரு வழிகளிலும் தெளிவான ஆதாரம்.</li>
          <li><strong>ஆய்வக சோதனை.</strong> மாற்றாக மீட்டர் உங்கள் முன்னிலையில் அகற்றப்பட்டு, சீல் செய்யப்பட்டு,
          DISCOM-இன் மீட்டர் ஆய்வகத்தில் பெஞ்ச்-சோதிக்கப்படுகிறது (சோதனையைக் கண்காணிக்க நீங்கள் கேட்கலாம்).</li>
        </ol>
        <p>மீட்டர் வேகமானது என்று உறுதிப்படுத்தப்பட்டால், வழங்கல் நெறிமுறை DISCOM-ஐ <strong>பாதிக்கப்பட்ட
        காலத்திற்கான உங்கள் பில்களைத் திருத்தவும்</strong> (பொதுவாக ஒரு குறிப்பிட்ட எண்ணிக்கையிலான மாதங்களுக்கு
        வரையறுக்கப்பட்டது) மீட்டரை இலவசமாக மாற்றவும் கட்டாயப்படுத்துகிறது.</p>
      </section>
      <section class="seo-section">
        <h2>DISCOM நடவடிக்கை எடுக்கவில்லை என்றால்</h2>
        <p>வரிசையாக அதிகரிக்கவும்: உங்கள் சோதனை ஆதாரத்துடன் நிர்வாக பொறியாளருக்கு எழுத்துப்பூர்வ புகார் →
        DISCOM-இன் <strong>நுகர்வோர் குறை தீர்வு மன்றம் (CGRF)</strong> → மாநில
        <strong>மின்சார ஒம்புட்ஸ்மேன்</strong>. சுய-சோதனை எண்கள், மீட்டர் காட்சியின் புகைப்படங்கள் மற்றும்
        ஒவ்வொரு பில்லையும் வைத்திருங்கள் — கணக்கு உள்ள வழக்குகள் வெல்கின்றன. சரியான பில் <em>எப்படி இருக்க
        வேண்டும்</em> என்பதை <a href="/#calculator">கணிப்பானுடன்</a> சரிபார்த்து, அந்த விவரத்தை புகாருடன்
        இணைக்கவும்.</p>
      </section>`,
    faqsTa: [
      { q: 'பழைய மீட்டர்களை விட ஸ்மார்ட் மீட்டர்கள் அதிக யூனிட்களைப் பதிவு செய்கின்றனவா?', a: 'அவை அதிக முழுமையாகப் பதிவு செய்கின்றன, தவறாக அல்ல. ஸ்மார்ட் மீட்டர்கள் வகுப்பு-1.0 ஸ்டேடிக் மீட்டர்கள் (±1% அனுமதிக்கப்பட்ட பிழை), வகுப்பு 2.0 ஆக இருந்து வயதாகும்போது பெரும்பாலும் குறைவாகப் படித்த பழைய டிஸ்க் மீட்டர்களை மாற்றுகின்றன. பொருத்திய பிறகான வழக்கமான "அதிகரிப்பு" என்பது பழைய மீட்டர் தவறவிட்ட அல்லது மதிப்பிடப்பட்ட பில்லிங் ஒருபோதும் பிடிக்காத நுகர்வு.' },
      { q: 'எனது ஸ்மார்ட் மீட்டர் வேகமாக ஓடுகிறதா எனச் சரிபார்ப்பது எப்படி?', a: 'அனைத்தையும் அணைக்கவும், ஒரு அறியப்பட்ட சுமையை — எ.கா. ஒரு 2 kW கீஸரை — சரியாக 30 நிமிடங்கள் இயக்கவும், முன் மற்றும் பின் மீட்டர் அளவீடுகளை ஒப்பிடவும். இது 1.0 யூனிட்டிற்கு மிக நெருக்கமாக பதிவாக வேண்டும். கணிசமாக அதிக எண் உங்கள் DISCOM-இடம் அதிகாரப்பூர்வ துல்லிய சோதனையைக் கோருவதற்கான ஆதாரம்.' },
      { q: 'எனது மின் மீட்டரை அதிகாரப்பூர்வமாக எப்படி சோதிப்பது?', a: 'உங்கள் மாநிலத்தின் மின்சார வழங்கல் நெறிமுறையின் கீழ் மீட்டர் துல்லிய சோதனைக்கு உங்கள் துணைப் பிரிவு அலுவலகத்தில் அல்லது DISCOM போர்ட்டலில் விண்ணப்பிக்கவும். ஒரு சிறிய கட்டணம் பொருந்தும், மீட்டர் குறைபாடுடையதாக நிரூபிக்கப்பட்டால் திரும்பத் தரப்படும். ஒரு பில்லிங் சுழற்சிக்கு இணையாகப் பொருத்தப்பட்ட ஒரு சரிபார்ப்பு மீட்டரையும் நீங்கள் கோரலாம், அல்லது ஒரு ஆய்வக பெஞ்ச் சோதனையைக் கண்காணிக்கலாம்.' },
      { q: 'மீட்டர் வேகமானது எனக் கண்டறியப்பட்டால் எனது பில்கள் திருத்தப்படுமா?', a: 'ஆம். மீட்டர் அனுமதிக்கப்பட்ட வரம்புகளுக்கு அப்பால் அதிகமாகப் பதிவு செய்கிறது என்று சோதனை உறுதிப்படுத்தினால், வழங்கல் நெறிமுறை DISCOM-ஐ பாதிக்கப்பட்ட காலத்திற்கான பில்களைத் திருத்த (பொதுவாக ஒரு குறிப்பிட்ட எண்ணிக்கையிலான மாதங்களுக்கு வரையறுக்கப்பட்டது) மற்றும் மீட்டரை இலவசமாக மாற்ற கட்டாயப்படுத்துகிறது.' },
      { q: 'DISCOM தொலைவிலிருந்து ஸ்மார்ட் மீட்டரை அதிகமாகப் படிக்க வைக்க முடியுமா?', a: 'இல்லை. தொலை கட்டளைகள் அளவீடு சேகரிப்பு, இணைப்பு/துண்டிப்பு மற்றும் கட்டண-அட்டவணை புதுப்பிப்புகளை மட்டுமே உள்ளடக்கும் — அளவீட்டு அமைப்பை அல்ல. மெட்ராலஜி ஃபர்ம்வேர் சீல் செய்யப்பட்டு வகை-சோதிக்கப்பட்டது, அளவீடுகள் மீட்டரின் சொந்த நினைவகத்தில் பதிவு செய்யப்படுகின்றன — இதனால்தான் ஒரு உடல் சுய-சோதனை அல்லது சரிபார்ப்பு மீட்டர் இந்தக் கேள்வியை உறுதியாகத் தீர்க்கிறது.' },
    ],
  },

  {
    ...
    titleTa: 'ஸ்மார்ட் ப்ரீபெய்ட் மீட்டர்: ரீசார்ஜ், குறைந்த இருப்பு மற்றும் தொலை துண்டிப்பு',
    metaTitleTa: 'ஸ்மார்ட் ப்ரீபெய்ட் மீட்டர் துண்டிக்கப்பட்டதா? ரீசார்ஜ், மறு இணைப்பு நேரம் & உங்கள் உரிமைகள்',
    descriptionTa: 'ஸ்மார்ட் ப்ரீபெய்ட் மின் மீட்டர்கள் இருப்பை எப்படிக் கழிக்கின்றன, ஒரு தொலை துண்டிப்பை மின்தடை அல்லது கோளாறிலிருந்து எப்படி வேறுபடுத்துவது, DISCOM-கள் உங்களைத் துண்டிக்க அனுமதிக்கப்படாத நேரங்கள், ரீசார்ஜுக்குப் பிறகு வழங்கல் எவ்வளவு வேகமாகத் திரும்பும், மற்றும் பழைய நிலுவைத் தொகைகள் எப்படி மீட்கப்படுகின்றன.',
    introTa: `ஒரு ஸ்மார்ட் ப்ரீபெய்ட் மீட்டர் உங்கள் மின் இணைப்பை ஒரு ரீசார்ஜ்-மற்றும்-நுகர் கணக்காக மாற்றுகிறது:
      மீட்டர் தினமும் உங்கள் இருப்பைக் கழிக்கிறது, அது குறைவாக இருக்கும்போது எச்சரிக்கிறது, மேலும் அது
      பூஜ்ஜியத்தை அடையும்போது வழங்கலை <strong>தொலைவிலிருந்து துண்டிக்கலாம்</strong>. உங்கள் மின்சாரம் இப்போதுதான்
      போய்விட்டால், இந்த வழிகாட்டி ஒரு இருப்பு துண்டிப்பை சாதாரண மின்தடை அல்லது கோளாறிலிருந்து எப்படி
      வேறுபடுத்துவது, ரீசார்ஜுக்குப் பிறகு வழங்கல் எவ்வளவு விரைவாகத் திரும்பும், மற்றும் நியாயமற்ற துண்டிப்புக்கு
      எதிராக மாநில விதிகள் உங்களுக்கு அளிக்கும் பாதுகாப்புகளைக் காட்டுகிறது.`,
    sectionsTa: `
      <section class="seo-section">
        <h2>தினசரி கழிப்பு எப்படி வேலை செய்கிறது</h2>
        <p>உங்கள் ரீசார்ஜ் யூனிட்களுக்கு மட்டும் பணம் செலுத்துவதல்ல. ஒவ்வொரு நாளும் மீட்டர் (அல்லது அதன்
        பின்னணியில் உள்ள DISCOM-இன் பில்லிங் அமைப்பு) கழிக்கிறது:</p>
        <ul>
          <li><strong>ஆற்றல் கட்டணம்</strong> — உங்கள் அடுக்கு/கட்டண விகிதத்தில் விலையிடப்பட்ட அன்றைய
          நுகர்வு, பொருந்தும் இடத்தில் <a href="/glossary/#fppa">FPPA</a> உட்பட;</li>
          <li><strong>நிலையான கட்டணம், தினசரி விகிதாசாரமாக்கப்பட்டது</strong> — உங்கள் மாதாந்திர
          <a href="/glossary/#fixed-charge">நிலையான கட்டணம்</a> ÷ மாதத்தில் உள்ள நாட்கள், நீங்கள் ஒன்றும்
          நுகராத நாட்களிலும் கழிக்கப்படுகிறது;</li>
          <li><strong>மின் வரி</strong> மற்றும் பிற பில் வசூல்கள், போஸ்ட்பெய்ட் பில்லில் இருப்பது போலவே
          பயன்படுத்தப்படுகிறது.</li>
        </ul>
        <p>எனவே "இரவோடு வடியும்" இருப்பு பொதுவாக திருட்டு அல்ல — இது தினசரி நிலையான-கட்டண கழிப்பு மற்றும்
        எப்போதும்-இயங்கும் சுமைகள் (ஃபிரிட்ஜ், இன்வெர்ட்டர் சார்ஜிங், ரூட்டர்கள்). DISCOM ஆப்பின் தினசரி கழிப்பு
        லெட்ஜர் இதை விவரமாகக் காட்டுகிறது; மீட்டரை சந்தேகிப்பதற்கு முன் அதைச் சரிபார்க்கவும், விகிதங்களை
        <a href="/tariffs/states/">கட்டண அடைவில்</a> உங்கள் மாநிலப் பக்கத்திற்கு எதிராகச் சரிபார்க்கவும்.</p>
      </section>
      <section class="seo-section">
        <h2>நான் தொலைவிலிருந்து துண்டிக்கப்பட்டேனா — அல்லது இது ஒரு கோளாறா?</h2>
        <p>ஒரு எலக்ட்ரீஷியனை அழைப்பதற்கு முன் இந்தப் பட்டியலைச் சரிபார்க்கவும்:</p>
        <ol>
          <li><strong>அண்டை வீட்டாரை / உங்கள் தெருவைச் சரிபார்க்கவும்.</strong> அவர்களும் இருட்டாக இருந்தால்,
          இது ஒரு பகுதி மின்தடை, உங்கள் மீட்டர் அல்ல.</li>
          <li><strong>மீட்டர் காட்சியைப் பாருங்கள்.</strong> தொலைவிலிருந்து துண்டிக்கப்பட்ட ஒரு ஸ்மார்ட்
          மீட்டரில் இன்னும் ஒரு நேரடி காட்சி உள்ளது — பெரும்பாலானவை ஒரு ரிலே/துண்டிப்பு சின்னம், "OFF", அல்லது
          ஒரு குறிப்பிட்ட எச்சரிக்கை குறியீட்டைக் காட்டும். முற்றிலும் இறந்த காட்சி ஒரு வழங்கல்-பக்க கோளாறைக்
          குறிக்கிறது.</li>
          <li><strong>ஆப் மற்றும் SMS-ஐச் சரிபார்க்கவும்.</strong> ப்ரீபெய்ட் துண்டிப்புகளுக்கு முன் குறைந்த-இருப்பு
          எச்சரிக்கைகள் வரும், DISCOM ஆப்பில் ஒரு நேர முத்திரையுடன் பதிவு செய்யப்படும். அங்கு ஒரு துண்டிப்பு
          பதிவு அதைத் தீர்த்துவிடும்.</li>
          <li><strong>உங்கள் சொந்த MCB/ELCB-ஐச் சரிபார்க்கவும்.</strong> மீட்டர் காட்சி இயங்கினால், போதுமான
          இருப்பையும் துண்டிப்பு சின்னமும் இல்லாமல் காட்டினால், ஆனால் வீடு இருட்டாக இருந்தால், உங்கள் முதன்மை
          சுவிட்ச் அல்லது உள் வயரிங் தடுக்கப்பட்டது — அது எலக்ட்ரீஷியனுக்கானது.</li>
        </ol>
      </section>
      <section class="seo-section">
        <h2>DISCOM உங்களைத் துண்டிக்க அனுமதிக்கப்படாத நேரம்</h2>
        <p>மாநில வழங்கல் நெறிமுறைகளும் ஸ்மார்ட்-மீட்டரிங் விதிகளும் நுகர்வோர் பாதுகாப்புகளை உள்ளடக்கியுள்ளன.
        விவரங்கள் மாநிலத்திற்கு மாநிலம் மாறுபடும், ஆனால் பொதுவான வடிவம்:</p>
        <ul>
          <li><strong>முன்கூட்டிய எச்சரிக்கை கட்டாயம்</strong> — எந்த துண்டிப்புக்கும் முன் SMS/ஆப் மூலம்
          குறைந்த-இருப்பு எச்சரிக்கைகள், இருப்பு பூஜ்ஜியத்தை அடைந்த பிறகு ஒரு வரையறுக்கப்பட்ட அறிவிப்பு
          சாளரம்.</li>
          <li><strong>நியாயமற்ற நேரங்களில் துண்டிப்பு இல்லை</strong> — பெரும்பாலான நெறிமுறைகள் இரவில், ஞாயிற்றுக்
          கிழமைகள், பொது விடுமுறை நாட்களில் மற்றும் நியாயமான முறையில் ரீசார்ஜ் செய்ய முடியாத நாட்களில் தொலை
          துண்டிப்பைத் தடை செய்கின்றன.</li>
          <li><strong>ஒரு அவகாசக் காலம் அல்லது அவசர கடன்</strong> — பல DISCOM-கள் ஒரு சிறிய எதிர்மறை இருப்பு
          அல்லது "நட்பு நேரங்களை" வழங்குகின்றன, இதனால் நீங்கள் டாப் அப் செய்யும் வரை வழங்கல் தொடர்கிறது; தொகை
          அடுத்த ரீசார்ஜிலிருந்து மீட்கப்படுகிறது.</li>
        </ul>
        <p>எச்சரிக்கை இல்லாமல், இரவில் அல்லது விடுமுறை நாளில் நீங்கள் துண்டிக்கப்பட்டால், ஆப்பிலிருந்து நேர
        முத்திரைகளைக் குறித்துக் கொள்ளுங்கள் — இது ஒரு எழுத்துப்பூர்வ புகாருக்கு தகுதியான வழங்கல்-நெறிமுறை
        மீறல்.</p>
      </section>
      <section class="seo-section">
        <h2>ரீசார்ஜுக்குப் பிறகு மீண்டும் இணைக்கப்படுதல்</h2>
        <ol>
          <li><strong>ரீசார்ஜ் செய்யவும்</strong> DISCOM ஆப்/போர்ட்டல் அல்லது ஒரு அங்கீகரிக்கப்பட்ட கட்டண
          சேனல் மூலம். தொகை எந்த எதிர்மறை இருப்பையும் <em>மேலும்</em> ஒரு நேர்மறை மார்ஜினையும் ஈடுசெய்கிறதா
          எனச் சரிபார்க்கவும் — பற்றாக்குறையை மட்டும் அழிக்கும் ஒரு ரீசார்ஜ் மறு இணைப்பைத் தூண்டாமல் இருக்கலாம்.</li>
          <li><strong>தானியங்கு-மறு இணைப்பு கட்டளைக்காகக் காத்திருங்கள்.</strong> கட்டணம் பதிவான பிறகு
          மறுசீரமைப்பு பொதுவாக சில நிமிடங்களிலிருந்து சில மணி நேரங்களுக்குள் தானாகவே நடக்கும்; மீட்டரின் ரிலே
          மீண்டும் இணைகிறது.</li>
          <li><strong>சில மீட்டர்களுக்கு ஒரு பட்டன் அழுத்தம் தேவை.</strong> பாதுகாப்புக்காக, சில மாடல்கள்
          மறு இணைப்பு கட்டளை வந்த பிறகு நீங்கள் மீட்டரின் புஷ் பட்டனை அழுத்தி பிடிக்க வேண்டும், இதனால் வழங்கல்
          கவனிக்கப்படாத வீட்டிற்குத் திரும்பாது. மீட்டரின் ஸ்டிக்கர் அல்லது DISCOM ஆப் ப்ராம்ப்ட்டைச்
          சரிபார்க்கவும்.</li>
          <li><strong>சில மணி நேரங்களுக்குப் பிறகும் அணைந்திருக்கிறதா?</strong> ரீசார்ஜ் ரசீது எண்ணுடன் ஒரு
          வழங்கல் புகாரைப் பதிவு செய்யவும் — மீட்டர் நெட்வொர்க் இணைப்பை இழந்திருந்தால் மறு இணைப்பு கட்டளை
          தோல்வியடையக்கூடும், பின்னர் ஒரு லைன்மேன் வருகை தேவைப்படும்.</li>
        </ol>
      </section>
      <section class="seo-section">
        <h2>புதிய ப்ரீபெய்ட் மீட்டரில் பழைய நிலுவைத் தொகைகள்</h2>
        <p>ப்ரீபெய்ட் மீட்டர் பொருத்தப்பட்டபோது உங்களிடம் செலுத்தப்படாத போஸ்ட்பெய்ட் பில்கள் இருந்தால், நிலுவைத்
        தொகைகள் மறைந்துவிடாது — அவை பொதுவாக தீரும் வரை <strong>ஒவ்வொரு ரீசார்ஜிலிருந்தும் ஒரு சதவீதக்
        கழிப்பாக</strong> மீட்கப்படுகின்றன (பிரிவு ரீசார்ஜ் ரசீதில் காட்டப்படுகிறது). எனவே உங்கள் பயனுள்ள
        இருப்பு ரீசார்ஜ் தொகையை விட மெதுவாக வளரும். கழிக்கப்பட்ட நிலுவைத் தொகை எண் தவறாகத் தோன்றினால், எழுத்துப்
        பூர்வமாக மறுக்கவும்; ஆப்பில் உள்ள ரீசார்ஜ் லெட்ஜர் உங்கள் ஆதாரம். ஒரு மாதத்தின் நுகர்வு <em>எவ்வளவு</em>
        செலவாக வேண்டும் என்பதை மீட்டர் என்ன கழித்தது என்பதற்கு எதிராக சுய-சரிபார்க்க, <a href="/#calculator">கணிப்பானைப்</a>
        பயன்படுத்தவும்.</p>
      </section>`,
    faqsTa: [
      { q: 'எனது ஸ்மார்ட் மீட்டர் குறைந்த இருப்புக்காக துண்டிக்கப்பட்டதா என எப்படித் தெரிந்துகொள்வது?', a: 'மீட்டர் காட்சி நேரடியாகவே இருந்து ஒரு துண்டிப்பு/ரிலே சின்னம் அல்லது "OFF" காட்டும், DISCOM ஆப் ஒரு நேர முத்திரையுடன் ஒரு துண்டிப்பு நிகழ்வைப் பதிவு செய்யும், மேலும் நீங்கள் அதற்கு முன் குறைந்த-இருப்பு SMS எச்சரிக்கைகளைப் பெற்றிருப்பீர்கள். முற்றிலும் இறந்த மீட்டர் காட்சி அல்லது ஒரு முழு இருட்டான தெரு அதற்குப் பதிலாக ஒரு மின்தடை அல்லது கோளாறைக் குறிக்கிறது.' },
      { q: 'ரீசார்ஜ் செய்த பிறகு எவ்வளவு நேரத்தில் மின்சாரம் திரும்பும்?', a: 'கட்டணம் பதிவான பிறகு சில நிமிடங்களிலிருந்து சில மணி நேரங்களுக்குள் மறு இணைப்பு பொதுவாக தானாகவே நடக்கும். சில மீட்டர் மாடல்களுக்கு பாதுகாப்பிற்காக மீட்டரின் புஷ் பட்டனை அழுத்துவதும் கூடுதலாகத் தேவை. சில மணி நேரங்களுக்குள் வழங்கல் திரும்பவில்லை என்றால், உங்கள் ரீசார்ஜ் ரசீதுடன் புகார் செய்யவும் — மோசமான நெட்வொர்க் இணைப்புள்ள ஒரு மீட்டரை மறு இணைப்பு கட்டளை சென்றடையாமல் இருக்கலாம்.' },
      { q: 'ஒரு ப்ரீபெய்ட் ஸ்மார்ட் மீட்டர் இரவில் அல்லது விடுமுறை நாளில் எனது மின்சாரத்தை துண்டிக்க முடியுமா?', a: 'மாநில வழங்கல் நெறிமுறைகள் பொதுவாக இரவிலும் ஞாயிறு/பொது விடுமுறை நாட்களிலும் தொலை துண்டிப்பைத் தடை செய்கின்றன, மேலும் முன்கூட்டிய குறைந்த-இருப்பு எச்சரிக்கைகளைக் கோருகின்றன. பல DISCOM-கள் அவசர கடன் அல்லது நட்பு நேரங்களையும் வழங்குகின்றன, இதனால் நீங்கள் ரீசார்ஜ் செய்யும் வரை வழங்கல் தொடரும். இந்த சாளரங்களை மீறிய ஒரு துண்டிப்பு புகாருக்கான காரணம்.' },
      { q: 'நான் மின்சாரத்தைப் பயன்படுத்தாதபோதும் எனது ப்ரீபெய்ட் இருப்பு ஏன் குறைகிறது?', a: 'நுகர்வைப் பொருட்படுத்தாமல் நிலையான கட்டணங்கள் தினமும் கழிக்கப்படுகின்றன (மாதாந்திர நிலையான கட்டணத்தை மாதத்தின் நாட்களால் வகுத்தல்), பொருந்தும் கூறுகளின் மீதான வரியுடன் — கூடுதலாக ஃபிரிட்ஜ் மற்றும் ரூட்டர்கள் போன்ற எப்போதும்-இயங்கும் சுமைகள் தொடர்ந்து நுகர்கின்றன. ஆப்பின் தினசரி கழிப்பு லெட்ஜர் என்ன எடுக்கப்பட்டது என்பதை விவரமாகக் காட்டுகிறது.' },
      { q: 'ப்ரீபெய்ட் மீட்டரில் எனது பழைய செலுத்தப்படாத பில்களுக்கு என்ன ஆகும்?', a: 'போஸ்ட்பெய்ட் காலத்திலிருந்தான நிலுவைத் தொகைகள் பொதுவாக தீரும் வரை ஒவ்வொரு ரீசார்ஜின் ஒரு நிலையான சதவீதமாக மீட்கப்படும், ரீசார்ஜ் ரசீதில் ஒரு பிரிவாகக் காட்டப்படும். நிலுவைத் தொகை தீரும் வரை உங்கள் பயன்படுத்தக்கூடிய இருப்பு மெதுவாக வளரும்; எண் தவறாகத் தோன்றினால், ரீசார்ஜ் லெட்ஜரை ஆதாரமாகக் கொண்டு மறுக்கவும்.' },
    ],
  },

  {
    ...
    titleTa: 'ஸ்மார்ட் மீட்டர் ரீசார்ஜ் தோல்வியடைந்ததா அல்லது இருப்பு புதுப்பிக்கப்படவில்லையா? என்ன செய்வது',
    metaTitleTa: 'ஸ்மார்ட் மீட்டர் ரீசார்ஜ் தோல்வி 2026 — பணம் கழிக்கப்பட்டது, இருப்பு புதுப்பிக்கப்படவில்லை: சரிசெய்தல்',
    descriptionTa: 'பணம் போய்விட்டது ஆனால் இருப்பு மாறவில்லையா? தீர்வு தாமதம் சில மணி நேரங்களில் தானாகவே தீரும்; தோல்வியடைந்த பரிவர்த்தனை 3–7 வேலை நாட்களில் தானாகவே திரும்பப் பெறப்படும்; தவறான நுகர்வோர் எண்ணுக்கு எழுத்துப்பூர்வ DISCOM புகார் தேவை. UTR எண்ணை வைத்திருங்கள் — ஒவ்வொரு வழக்கிற்கும் சரியான அதிகரிப்பு பாதை, 1912 மற்றும் ஆப் படிகளுடன்.',
    introTa: `ஒரு ப்ரீபெய்ட் ரீசார்ஜ் பொதுவாக சில நிமிடங்களில் மீட்டரில் பிரதிபலிக்கும் — எனவே உங்கள்
      கணக்கிலிருந்து பணம் போய், இருப்பு நகராதபோது, அது கவலையாக இருக்கும். கிட்டத்தட்ட ஒவ்வொரு வழக்கிலும் பணம்
      இழக்கப்படவில்லை: அது <strong>இன்னும் தீர்வாகிக் கொண்டிருக்கிறது</strong>, <strong>மீட்டர் மீண்டும்
      ஆன்லைனுக்கு வர காத்திருக்கிறது</strong>, அல்லது <strong>தவறான நுகர்வோர் எண்ணில் அமர்ந்திருக்கிறது</strong>.
      இந்த வழிகாட்டி ஒவ்வொரு வழக்கிற்கான சரிசெய்தல், திரும்பப் பெறும் காலவரிசைகள், மற்றும் ஒரு புகார் விரைவாகத்
      தீர எந்த ஆதாரங்களை வைத்திருக்க வேண்டும் என்பதை விளக்குகிறது.`,
    sectionsTa: `
      <section class="seo-section">
        <h2>முதலில்: 30 நிமிடங்கள் கொடுங்கள், பின் சரியான இடத்தில் சரிபார்க்கவும்</h2>
        <p>ரீசார்ஜ் பணம் பல அமைப்புகள் வழியாகச் செல்கிறது — உங்கள் வங்கி/UPI ஆப், கட்டண திரட்டி அல்லது BBPS,
        DISCOM-இன் பில்லிங் அமைப்பு, இறுதியாக மீட்டரே. ஒவ்வொரு தாவலும் தாமதத்தைச் சேர்க்கலாம், குறிப்பாக
        மாலை நேரப் பரபரப்பில் அனைவரும் ஒரே நேரத்தில் ரீசார்ஜ் செய்யும்போது. தோல்வியடைந்ததாகக் கருதுவதற்கு முன்:</p>
        <ol>
          <li><strong>நீங்கள் செலுத்திய ஆப்பில் கட்டணத்தின் நிலையைச் சரிபார்க்கவும்.</strong> "நிலுவையில்"
          என்பது பணம் இன்னும் DISCOM-ஐ சென்றடையவில்லை என்பதைக் குறிக்கிறது — பெரும்பாலான நிலுவை UPI
          பரிவர்த்தனைகள் சில மணி நேரங்களில் தானாகவே தீர்கின்றன (வெற்றி அல்லது தானியங்கு-திரும்பப் பெறுதல்).</li>
          <li><strong>DISCOM-இன் சொந்த ஆப் அல்லது போர்ட்டலில் இருப்பைச் சரிபார்க்கவும்</strong>, மீட்டர்
          காட்சியை மட்டும் அல்ல. பில்லிங் அமைப்பு பெரும்பாலும் முதலில் வரவு வைத்து பின்னர் மீட்டருக்குத்
          தள்ளுகிறது.</li>
          <li><strong>மீட்டர் காட்சியை கடைசியாகச் சரிபார்க்கவும்.</strong> ஆப் புதிய இருப்பைக் காட்டினாலும்
          மீட்டர் காட்டவில்லை என்றால், மீட்டர் ஆஃப்லைனில் இருக்கலாம் (பலவீனமான நெட்வொர்க்) — அது மீண்டும்
          இணைக்கும்போது இருப்பு ஒத்திசைக்கும், அதற்கிடையில் வழங்கல் இயங்கியிருந்தால் பாதிக்கப்படாது.</li>
        </ol>
      </section>
      <section class="seo-section">
        <h2>பணம் கழிக்கப்பட்டது, இருப்பு புதுப்பிக்கப்படவில்லை — மூன்று காரணங்கள்</h2>
        <div class="comparison-table-wrapper"><table class="comparison-table">
          <thead><tr><th>என்ன நடந்தது</th><th>எப்படி தீரும்</th></tr></thead>
          <tbody>
            <tr><td><strong>தீர்வு தாமதம்</strong> — கட்டணம் வெற்றியடைந்தது ஆனால் திரட்டிக்கும் DISCOM-க்கும் இடையே இன்னும் பயணித்துக் கொண்டிருக்கிறது</td><td>தானாகவே தீரும், பொதுவாக சில மணி நேரங்களில் (எப்போதாவது வங்கி விடுமுறையில் 24–48 மணி நேரம் வரை). பரிவர்த்தனை ஐடியை வைத்திருங்கள்; உடனடியாக மீண்டும் ரீசார்ஜ் செய்யாதீர்கள், இரட்டிப்பாகச் செலுத்தக்கூடும்.</td></tr>
            <tr><td><strong>பரிவர்த்தனை உண்மையில் தோல்வியடைந்தது</strong> — பணம் பிடிக்கப்பட்டது, கட்டணம் தோல்வியடைந்ததாகக் குறிக்கப்பட்டது</td><td>UPI/கார்டு சார்ஜ்பேக் விதிகளின் கீழ் பொதுவாக 3–7 வேலை நாட்களுக்குள் செலுத்திய கணக்கிற்கு தானாகவே திரும்பப் பெறப்படும். வரவில்லை என்றால், UTR/பரிவர்த்தனை ஐடியை மேற்கோள் காட்டி கட்டண ஆப் மற்றும் உங்கள் வங்கி இரண்டிடமும் புகார் செய்யுங்கள்.</td></tr>
            <tr><td><strong>தவறான நுகர்வோர்/மீட்டர் எண்</strong> — கட்டணம் வெற்றியடைந்தது, ஆனால் வேறொருவரின் கணக்கில்</td><td>தானாகத் தீராது. ரசீதுடன் DISCOM-க்கு எழுத்துப்பூர்வமாக புகார் செய்யுங்கள்; வரவு எங்கு விழுந்தது என்பதை அவர்களால் கண்டுபிடித்து மாற்ற முடியும். இது மிக மெதுவான வழக்கு — ஒவ்வொரு முறையும் எண்ணை இருமுறை சரிபார்க்கவும்.</td></tr>
          </tbody>
        </table></div>
        <p>இருப்பு புதுப்பிக்கப்பட்டது ஆனால் <em>வழங்கல்</em> திரும்பவில்லை என்றால் இன்னொரு சாத்தியம்: மறு
        இணைப்பு கட்டளை மீட்டரை சென்றடையவில்லை — <a href="/guides/smart-meter-prepaid-disconnection/">ரீசார்ஜ்
        செய்த பிறகு மின்சாரத்தைத் திரும்பப் பெறுவது</a> பார்க்கவும்.</p>
      </section>
      <section class="seo-section">
        <h2>அதிகரிப்பு பாதை (மற்றும் வெல்லும் ஆதாரம்)</h2>
        <ol>
          <li><strong>இப்போது எல்லாவற்றையும் சேமிக்கவும்:</strong> கட்டண ஸ்கிரீன்ஷாட், பரிவர்த்தனை/UTR
          எண், தேதி-நேரம், நீங்கள் உள்ளிட்ட நுகர்வோர் எண், மற்றும் மீட்டரின் இருப்பு திரை.</li>
          <li><strong>ஆப் தோல்வி/நிலுவை காட்டினால் முதலில் கட்டண ஆப்</strong> — அவர்களின் ஆதரவு பரிவர்த்தனையின்
          அவர்களுடைய பகுதிக்கான திரும்பப் பெறுதலைக் கையாளும்.</li>
          <li><strong>கட்டணம் வெற்றியாகக் காட்டினால் அடுத்து DISCOM</strong>: <strong>1912</strong>-ஐ அழைக்கவும்
          அல்லது DISCOM ஆப்/போர்ட்டல் புகார் பிரிவைப் பயன்படுத்தவும், UTR-ஐ மேற்கோள் காட்டி. எழுத்துப்பூர்வ
          புகார் எண்ணைக் கேளுங்கள்.</li>
          <li><strong>ஒரு வாரத்தில் தீராவிட்டால் துணைப் பிரிவு அலுவலகத்திற்கு எழுத்துப்பூர்வமாக அதிகரிக்கவும்</strong>,
          பின்னர் DISCOM-இன் நுகர்வோர் குறை தீர்வு மன்றம் (CGRF). UTR உள்ள பண-தடய வழக்குகள் கிட்டத்தட்ட
          எப்போதும் படி 3-இல் தீரும்.</li>
        </ol>
      </section>
      <section class="seo-section">
        <h2>அடுத்த முறை நிலுவையில் இருக்கும் ரீசார்ஜைத் தவிர்த்தல்</h2>
        <ul>
          <li><strong>இருப்பு முக்கியமானதாக மாறுவதற்கு முன் ரீசார்ஜ் செய்யவும்</strong> — இரவு 11 மணிக்கு
          ₹2 மட்டும் மீதமிருக்கும்போது ஒரு நிலுவை கட்டணம் மோசமான வழக்கு. எங்கள் <a href="/recharge-calculator/">ரீசார்ஜ்
          கணிப்பான்</a> உங்கள் தற்போதைய இருப்பு உண்மையில் எத்தனை நாட்களைக் கொண்டுள்ளது எனக் காட்டுகிறது.</li>
          <li><strong>உங்கள் நுகர்வோர் எண்ணை</strong> ஒவ்வொரு முறையும் தட்டச்சு செய்வதற்குப் பதிலாக கட்டண
          ஆப்பில் சேமிக்கவும்.</li>
          <li><strong>பெரிய ரீசார்ஜுகளுக்கு DISCOM-இன் சொந்த ஆப்/போர்ட்டலை விரும்பவும்</strong> — மூன்றாம்
          தரப்பு சேனல்களை விட ஒரு தாவல் குறைவு.</li>
          <li><strong>ஒரு மாதத்தின் பில்லை ரீசார்ஜ் அளவாக வைத்திருங்கள்</strong> இதனால் ஒரு தோல்வி ஒருபோதும்
          அவசரநிலையாக மாறாது.</li>
        </ul>
      </section>`,
    faqsTa: [
      { q: 'எனது பணம் கழிக்கப்பட்டது ஆனால் ஸ்மார்ட் மீட்டர் இருப்பு புதுப்பிக்கப்படவில்லை. அது இழக்கப்பட்டதா?', a: 'கிட்டத்தட்ட ஒருபோதும் இல்லை. கட்டணம் இன்னும் தீர்வாகிக் கொண்டிருக்கிறது (சில மணி நேரங்களில் தீரும்), அது தோல்வியடைந்து 3–7 வேலை நாட்களில் தானாகவே திரும்பப் பெறப்படும், அல்லது அது தவறான நுகர்வோர் எண்ணுக்கு வரவு வைக்கப்பட்டது (உங்கள் பரிவர்த்தனை ஐடியுடன் ஒரு எழுத்துப்பூர்வ DISCOM புகார் மூலம் மீட்கக்கூடியது). UTR எண்ணை வைத்திருங்கள் — இது ஒவ்வொரு தீர்வுப் பாதைக்கும் சாவி.' },
      { q: 'ஒரு ஸ்மார்ட் மீட்டர் ரீசார்ஜ் பிரதிபலிக்க எவ்வளவு நேரம் ஆகும்?', a: 'பொதுவாக சில நிமிடங்களில். தீர்வு தாமதம் அதை சில மணி நேரங்களுக்கு நீட்டிக்கலாம், மீட்டரே ஆஃப்லைனில் இருந்தால் DISCOM ஆப் முதலில் வரவைக் காட்டும், நெட்வொர்க் இணைப்பு திரும்பியதும் மீட்டர் ஒத்திசைக்கும். 24 மணி நேரத்திற்குப் பிறகும் DISCOM ஆப்பில் எதுவும் காட்டவில்லை என்றால், பரிவர்த்தனை ஐடியுடன் புகார் செய்யுங்கள்.' },
      { q: 'நான் தவறான நுகர்வோர் எண்ணை ரீசார்ஜ் செய்துவிட்டேன். பணத்தைத் திரும்பப் பெற முடியுமா?', a: 'ஆம், ஆனால் DISCOM மூலம் மட்டுமே — கட்டணமே வெற்றியடைந்துவிட்டது, எனவே கட்டண ஆப்பால் அதை மாற்ற முடியாது. ரசீது மற்றும் இரண்டு எண்களுடன் (உங்களுடையது மற்றும் செலுத்தப்பட்டது) எழுத்துப்பூர்வ புகாரைச் சமர்ப்பிக்கவும்; DISCOM வரவைக் கண்டுபிடித்து மாற்ற முடியும்.' },
      { q: 'முதல் கட்டணம் நிலுவையில் இருக்கும்போது நான் மீண்டும் ரீசார்ஜ் செய்ய வேண்டுமா?', a: 'வழங்கல் இன்னும் இயங்கினால், சில மணி நேரங்கள் காத்திருங்கள் — நிலுவை கட்டணங்கள் பொதுவாக தீரும், நீங்கள் இரட்டை வரவைத் தவிர்க்கலாம். நீங்கள் துண்டிக்கப்பட்டு இப்போதே மின்சாரம் தேவைப்பட்டால், இரண்டாவது ரீசார்ஜைச் செய்யுங்கள், இரண்டு ரசீதுகளையும் வைத்திருங்கள், முதலாவதின் நிலை தீர்ந்தவுடன் அதைத் திரும்பக் கோருங்கள்.' },
    ],
  },

  {
    ...
    titleTa: 'உங்கள் ஸ்மார்ட் மீட்டர் இருப்பை எப்படிச் சரிபார்ப்பது (காட்சி, ஆப், SMS)',
    metaTitleTa: 'ஸ்மார்ட் மீட்டர் இருப்பு சரிபார்ப்பு — மீட்டர் காட்சி, DISCOM ஆப் & தினசரி கழிப்புகள்',
    descriptionTa: 'ஒரு ப்ரீபெய்ட் ஸ்மார்ட் மீட்டர் இருப்பைச் சரிபார்க்க மூன்று வழிகள் — மீட்டரின் புஷ்-பட்டன் காட்சி, DISCOM ஆப்/போர்ட்டல், மற்றும் SMS எச்சரிக்கைகள் — மேலும் தினசரி கழிப்பு லெட்ஜரை எப்படிப் படிப்பது, இதனால் இருப்பு எங்கு செல்கிறது என்பது உங்களுக்குச் சரியாகத் தெரியும்.',
    introTa: `ஒரு ப்ரீபெய்ட் ஸ்மார்ட் மீட்டர் அதன் இருப்பை மூன்று இடங்களில் காட்டுகிறது: <strong>மீட்டரிலேயே</strong>,
      <strong>DISCOM-இன் ஆப் அல்லது போர்ட்டலில்</strong>, மற்றும் <strong>SMS எச்சரிக்கைகள்</strong> மூலம். ஒவ்வொன்றும்
      வெவ்வேறு பயன்பாட்டைக் கொண்டுள்ளது — காட்சி உடனடியானது, ஆப்பில் முழு கழிப்பு வரலாறு உள்ளது, SMS ஸ்மார்ட்ஃபோன்
      இல்லாமல் வேலை செய்கிறது. இந்த வழிகாட்டி மூன்றையும் உள்ளடக்கியது, மற்றும் தினசரி கழிப்பு லெட்ஜரை எப்படிப்
      படிப்பது எனக் காட்டுகிறது, இதனால் குறையும் இருப்பு ஒருபோதும் உங்களை ஆச்சரியப்படுத்தாது.`,
    sectionsTa: `
      <section class="seo-section">
        <h2>1. மீட்டர் காட்சியில் (இணையம் இல்லாமல் வேலை செய்கிறது)</h2>
        <p>ஒவ்வொரு ஸ்மார்ட் மீட்டரிலும் அதன் திரைகள் வழியாகக் காட்சியைச் சுழற்றும் ஒரு <strong>புஷ்
        பட்டன்</strong> உள்ளது — அதை மீண்டும் மீண்டும் அழுத்தி லேபிள்களைக் கவனியுங்கள். சரியான வரிசை தயாரிப்பாளரைப்
        பொறுத்து மாறுபடும், ஆனால் பொதுவாக நீங்கள் காண்பீர்கள்: தற்போதைய இருப்பு (₹), ஒட்டுமொத்த யூனிட்கள் (kWh),
        உடனடி சுமை (kW), மற்றும் மின்னழுத்தம். இருப்பு திரை பொதுவாக ஒரு ₹ சின்னம் அல்லது "BAL"/"CR" லேபிளைக்
        காட்டும்; எதிர்மறை எண் நீங்கள் கடனில் நுகர்கிறீர்கள் என்பதைக் குறிக்கிறது, ஒரு துண்டிப்பு வரிசையில்
        இருக்கலாம்.</p>
        <p>மீட்டரின் இருப்பு DISCOM-இன் அமைப்பை விட ஒரு ஒத்திசைவு சுழற்சியால் பின்தங்கியிருக்கலாம் என்பதை
        நினைவில் கொள்ளுங்கள் — நீங்கள் இப்போதுதான் ரீசார்ஜ் செய்திருந்தால், ஆப் முதலில் புதுப்பிக்கிறது,
        மீட்டர் அடுத்த முறை இணைக்கும்போது பின்தொடர்கிறது.</p>
      </section>
      <section class="seo-section">
        <h2>2. DISCOM ஆப் அல்லது போர்ட்டலில் (முழு படம்)</h2>
        <p>DISCOM-இன் சொந்த ஆப் அல்லது நுகர்வோர் போர்ட்டல் அதிகாரப்பூர்வ இடம்: நேரடி இருப்பு, ரீசார்ஜ்
        வரலாறு மற்றும் — மிகவும் பயனுள்ளதாக — <strong>தினசரி கழிப்பு லெட்ஜரைப்</strong> பார்க்க உங்கள்
        நுகர்வோர்/கணக்கு எண்ணுடன் உள்நுழையவும். உத்தரப் பிரதேசத்தில் இது
        <a href="https://uppclonline.com" target="_blank" rel="noopener">uppclonline.com</a> அல்லது UPPCL
        நுகர்வோர் ஆப்; பீகாரில் <strong>Bihar Bijli Smart Meter</strong> ஆப். மற்ற மாநிலங்களுக்கு, உங்கள்
        ரீசார்ஜ் ரசீதில் பெயரிடப்பட்ட ஆப் அல்லது போர்ட்டலைப் பயன்படுத்தவும் — எங்கள்
        <a href="/smart-meter-recharge/">DISCOM-வாரியான ரீசார்ஜ் பக்கங்கள்</a> ஒவ்வொரு அதிகாரப்பூர்வ போர்ட்டலையும்
        இணைக்கின்றன.</p>
      </section>
      <section class="seo-section">
        <h2>3. SMS எச்சரிக்கைகள் (ஸ்மார்ட்ஃபோன் தேவையில்லை)</h2>
        <p>DISCOM-கள் உங்கள் இணைப்புக்கு எதிராகப் பதிவு செய்யப்பட்ட மொபைல் எண்ணுக்கு குறைந்த-இருப்பு
        எச்சரிக்கைகளை அனுப்புகின்றன — பொதுவாக துண்டிப்புக்கு முன் ஒன்று அல்லது இரண்டு வரம்புகளில், ஒவ்வொரு
        ரீசார்ஜுக்குப் பிறகும் ஒரு உறுதிப்படுத்தல். நீங்கள் அவற்றைப் பெறவில்லை என்றால், உங்கள் பதிவு செய்யப்பட்ட
        எண் காலாவதியானதாக இருக்கலாம்: DISCOM ஆப், போர்ட்டல் அல்லது துணைப் பிரிவு அலுவலகம் மூலம் அதைப்
        புதுப்பிக்கவும். ஆப்பைப் பயன்படுத்த முடியாதவர்களுக்கு, இந்த எச்சரிக்கைகளே முதன்மை பாதுகாப்பு வலை,
        எனவே எண்ணைச் சரிசெய்வது பயணத்திற்கு உரியது.</p>
      </section>
      <section class="seo-section">
        <h2>தினசரி கழிப்பு லெட்ஜரைப் படித்தல்</h2>
        <p>ஒவ்வொரு நாளின் கழிப்பும் "யூனிட்கள் × விகிதம்" மட்டும் அல்ல. இது தொகுக்கிறது:</p>
        <ul>
          <li><strong>ஆற்றல் கட்டணம்</strong> — உங்கள் <a href="/glossary/#telescopic-slabs">அடுக்கு
          விகிதங்களில்</a> விலையிடப்பட்ட அன்றைய யூனிட்கள்;</li>
          <li><strong>நிலையான கட்டணம்</strong> — மாத நாட்களில் பிரிக்கப்பட்ட மாதாந்திர
          <a href="/glossary/#fixed-charge">நிலையான கட்டணம்</a>, பூஜ்ஜிய நுகர்வில் கூட கழிக்கப்படுகிறது;</li>
          <li><strong>FPPA மற்றும் வரி</strong> — பொருந்தும் தலைப்புகளில் <a href="/glossary/#fppa">எரிபொருள்
          கூடுதல் கட்டணம்</a> மற்றும் <a href="/glossary/#electricity-duty">மின் வரி</a>;</li>
          <li><strong>நிலுவைத் தவணை</strong> — பழைய போஸ்ட்பெய்ட் நிலுவைத் தொகைகள் மீட்கப்பட்டுக் கொண்டிருந்தால்,
          ஒரு ரீசார்ஜுக்கு அல்லது ஒரு நாளுக்கு ஒரு பகுதி.</li>
        </ul>
        <p>வீடு பூட்டப்பட்டிருந்த நாளிலும் இருப்பு சிறிது குறைவது இதனால்தான். உங்கள் சாதாரண தினசரி செலவு
        <em>எவ்வளவு</em> இருக்க வேண்டும் — தற்போதைய இருப்பு எவ்வளவு காலம் நீடிக்கும் என்பதைப் பார்க்க,
        <a href="/recharge-calculator/">ஸ்மார்ட் மீட்டர் ரீசார்ஜ் கணிப்பானைப்</a> பயன்படுத்தவும், இது உங்கள்
        DISCOM-இன் உண்மையான கட்டணத்தில் உங்கள் பயன்பாட்டை விலையிடுகிறது.</p>
      </section>`,
    faqsTa: [
      { q: 'மீட்டரிலேயே இருப்பை எப்படிச் சரிபார்ப்பது?', a: 'மீட்டரின் புஷ் பட்டனை அழுத்தி அதன் காட்சி திரைகளைச் சுழற்றவும் — ஒரு திரை ₹-இல் ப்ரீபெய்ட் இருப்பைக் காட்டும் (பெரும்பாலும் BAL அல்லது CR என லேபிளிடப்பட்டது), ஒட்டுமொத்த kWh, சுமை மற்றும் மின்னழுத்தத்திற்கான திரைகளுடன். இது இணையம் இல்லாமல் வேலை செய்கிறது, ஆனாலும் ரீசார்ஜுக்குப் பிறகு உடனடியாக DISCOM ஆப்பை விட ஒரு ஒத்திசைவு சுழற்சி பின்தங்கியிருக்கலாம்.' },
      { q: 'நான் மின்சாரத்தைப் பயன்படுத்தாதபோதும் எனது இருப்பு ஏன் குறைந்தது?', a: 'தினசரி கழிப்பில் மாதாந்திர நிலையான கட்டணத்தின் ஒரு பங்கு (பூஜ்ஜிய யூனிட்களிலும் கழிக்கப்படும்), FPPA மற்றும் வரி, மற்றும் ஏதேனும் நிலுவைத் தவணை அடங்கும் — கூடுதலாக வழங்கல் இயங்கியிருந்தால் ஃபிரிட்ஜ் அல்லது ரூட்டர் போன்ற எப்போதும்-இயங்கும் சுமைகள். ஆப்பின் தினசரி கழிப்பு லெட்ஜர் என்ன எடுக்கப்பட்டது என்பதை விவரமாகக் காட்டுகிறது.' },
      { q: 'ஆப் இருப்பும் மீட்டர் இருப்பும் வேறுபடுகின்றன — எது சரியானது?', a: 'DISCOM-இன் பில்லிங் அமைப்பு (ஆப்/போர்ட்டல் எண்) அதிகாரப்பூர்வமானது; மீட்டர் அடுத்த முறை இணைக்கும்போது அதனுடன் ஒத்திசைக்கும். ரீசார்ஜுக்குப் பிறகு உடனடியாக ஒரு இடைவெளி சாதாரணமானது. அவை ஒரு நாளுக்கும் மேலாக வேறுபட்டால், மீட்டர் நெட்வொர்க்கை இழந்திருக்கலாம் — DISCOM-இடம் தெரிவிக்கவும்.' },
      { q: 'குறைந்த-இருப்பு SMS எச்சரிக்கைகளை நான் எப்படிப் பெறுவது?', a: 'எச்சரிக்கைகள் உங்கள் இணைப்புக்கு எதிராகப் பதிவு செய்யப்பட்ட மொபைல் எண்ணுக்குச் செல்கின்றன. நீங்கள் அவற்றைப் பெறவில்லை என்றால், DISCOM ஆப், போர்ட்டல் அல்லது துணைப் பிரிவு அலுவலகம் மூலம் உங்கள் எண்ணைப் புதுப்பிக்கவும் — எந்த இருப்பு துண்டிப்புக்கும் முன் உங்களை எச்சரிக்க DISCOM-கள் கட்டாயப்படுத்தப்படுகின்றன.' },
    ],
  },

  {
    ...
    sectionsMr: `
      ...
      <section class="seo-section">
        ...
        <ul class="seo-list">
          ...
          प्रीपेडमध्ये जाण्यास सांगितले जाऊ शकते, असे मंत्र्यांनी स्पष्ट केले. ही निवड नियमित भरणा करणाऱ्या ग्राहकांचे संरक्षण करते, थकबाकीचे नाही.</li>
        </ul>
    ...
    descriptionTa: 'ப்ரீபெய்ட் மற்றும் போஸ்ட்பெய்ட் ஸ்மார்ட் மீட்டர்கள் ஒரே கட்டண விகிதங்களை வசூலிக்கின்றன — வேறுபாடுகள் தள்ளுபடிகள், பாதுகாப்பு டெபாசிட், தாமத கட்டணங்கள் மற்றும் பணப்புழக்கம். இரண்டு பயன்முறைகளின் நேர்மையான ஒப்பீடு, ஒவ்வொன்றும் யாருக்குப் பொருந்தும், மற்றும் நீங்கள் மாற முடியுமா என்பது.',
    introTa: `அதே ஸ்மார்ட் மீட்டர் <strong>ப்ரீபெய்ட்</strong> (முதலில் ரீசார்ஜ், பின் நுகர்வு) அல்லது
      <strong>போஸ்ட்பெய்ட்</strong> (முதலில் நுகர்வு, பின்னர் பில்) பயன்முறையில் இயங்கலாம் — ஆற்றல் விகிதங்கள்
      ஒரே கட்டண ஆணையால் நிர்ணயிக்கப்பட்டு ஒரே மாதிரியானவை. உண்மையில் வேறுபடுவது பணப்புழக்கம், பாதுகாப்பு
      டெபாசிட், தாமத-கட்டண அபாயம் மற்றும் சிறிய தள்ளுபடிகள். இந்த வழிகாட்டி இரண்டையும் நேர்மையாக ஒப்பிடுகிறது,
      இதனால் — உங்கள் DISCOM ஒரு தேர்வை வழங்கும் இடத்தில் — எந்த பயன்முறை உங்கள் வீட்டிற்குப் பொருந்தும்
      என்பதை நீங்கள் முடிவு செய்யலாம்.`,
    sectionsTa: `
      <section class="seo-section">
        <h2>ஒரே கட்டணம், வெவ்வேறு கட்டணத் திசை</h2>
        <p>ப்ரீபெய்ட் மீட்டர்கள் ஒரு யூனிட்டுக்கு அதிகமாக வசூலிக்கும் என்பது ஒரு பொதுவான அச்சம். அவை
        வசூலிக்காது: அடுக்கு விகிதங்கள், நிலையான கட்டணங்கள், <a href="/glossary/#fppa">FPPA</a> மற்றும் வரி
        இரண்டு வழிகளிலும் ஒரே கட்டண ஆணையிலிருந்து வருகின்றன — உங்கள் <a href="/tariffs/states/">மாநிலத்தின்
        கட்டணப் பக்கத்தில்</a> சரிபார்க்கவும். ப்ரீபெய்ட் பயன்முறையில் அதே மாதாந்திர பில் மாத இறுதியில் ஒரு
        கோரிக்கையாக வருவதற்குப் பதிலாக நாள்தோறும் உங்கள் இருப்பிலிருந்து கழிக்கப்படுகிறது. ஓர் ஆண்டில், கீழே
        உள்ள சரிசெய்தல்களுக்கு முன், ஆற்றல் செலவு ரூபாய்க்கு ரூபாய் அதே.</p>
      </section>
      <section class="seo-section">
        <h2>உண்மையான வேறுபாடுகள் எங்கே உள்ளன</h2>
        <div class="comparison-table-wrapper"><table class="comparison-table">
          <thead><tr><th></th><th>ப்ரீபெய்ட்</th><th>போஸ்ட்பெய்ட்</th></tr></thead>
          <tbody>
            <tr><td><strong>தள்ளுபடி</strong></td><td>பல மாநிலங்களின் கட்டண ஆணைகள் ப்ரீபெய்ட் நுகர்வுக்கு ஒரு சிறிய தள்ளுபடி (பொதுவாக 1–2% வரம்பில்) வழங்குகின்றன — உங்கள் மாநிலத்தின் ஆணையைச் சரிபார்க்கவும்.</td><td>பொதுவாக இல்லை (சில DISCOM-கள் சரியான நேரம் அல்லது டிஜிட்டல் கட்டணத்திற்கு சிறிய தள்ளுபடிகளை வழங்குகின்றன).</td></tr>
            <tr><td><strong>பாதுகாப்பு டெபாசிட்</strong></td><td>தேவையில்லை — உங்கள் இருப்பே பாதுகாப்பு. இருக்கும் டெபாசிட்கள் பொதுவாக மாற்றத்தில் சரிசெய்யப்படும் அல்லது திரும்பத் தரப்படும்.</td><td>தேவை, தோராயமாக 1–2 மாத நுகர்வு, அவ்வப்போது திருத்தப்படும்.</td></tr>
            <tr><td><strong>தாமத கட்டண கூடுதல் தொகை</strong></td><td>எழ முடியாது — கடைசி தேதி இல்லை.</td><td>தாமதமான எந்த பில்லிலும் LPSC (பெரும்பாலும் மாதத்திற்கு 1.25–1.5%).</td></tr>
            <tr><td><strong>கடன் காலம்</strong></td><td>இல்லை — நீங்கள் முன்கூட்டியே நுகர்வுக்கு பணம் அளிக்கிறீர்கள்.</td><td>நீங்கள் செலுத்துவதற்கு முன் ~30–45 நாட்கள் மின்சாரத்தைப் பயன்படுத்துகிறீர்கள் — ஒரு உண்மையான வட்டி-இல்லா மிதவை.</td></tr>
            <tr><td><strong>துண்டிப்பு அபாயம்</strong></td><td>எதிர்மறை இருப்பில் தானாகவே (எச்சரிக்கைகள் மற்றும் பாதுகாக்கப்பட்ட நேரங்களுடன்) — <a href="/guides/smart-meter-prepaid-disconnection/">துண்டிப்பு விதிகளைப்</a> பார்க்கவும்.</td><td>செலுத்தப்படாத பில்களுக்கு முறையான அறிவிப்புக்குப் பிறகு மட்டும்.</td></tr>
            <tr><td><strong>செலவு தெரிவுநிலை</strong></td><td>தினசரி — கழிப்பு லெட்ஜர் ஒவ்வொரு நாளின் செலவையும் காட்டுகிறது.</td><td>மாதாந்திரம், நடந்த பிறகு.</td></tr>
          </tbody>
        </table></div>
      </section>
      <section class="seo-section">
        <h2>ஒவ்வொரு பயன்முறையும் யாருக்குப் பொருந்தும்</h2>
        <p><strong>ப்ரீபெய்ட் நன்றாக வேலை செய்கிறது</strong> செலவு கட்டுப்பாட்டை விரும்பும் வீடுகளுக்கு
        (தினசரி லெட்ஜர் வீணையைத் தெரியப்படுத்துகிறது), குத்தகைதாரர்கள் மற்றும் வீட்டு உரிமையாளர்களுக்கு
        (சர்ச்சைக்குரிய இறுதி பில்கள் இல்லை — இருப்பு வெறுமனே மாறுகிறது அல்லது காலியாகிறது), காலியாக இருக்கும்
        இரண்டாவது வீடுகளுக்கு, மற்றும் மறந்த கடைசி தேதிகளில் LPSC-யால் பாதிக்கப்பட்ட எவருக்கும். மாற்றத்தில்
        டெபாசிட் திரும்பப் பெறுவது ஒரு உண்மையான ஒரு-முறை ஆதாயம்.</p>
        <p><strong>போஸ்ட்பெய்ட் பொருந்துவது</strong> ~ஒரு மாத மிதவையை மதிக்கும் வீடுகளுக்கு, ரீசார்ஜ்-கண்காணிப்பை
        விட ஒரு கட்டணத்தை விரும்புபவர்களுக்கு, அல்லது இணைப்பு ரீசார்ஜ்களை நம்பகமற்றதாக்கும் இடங்களில்
        வாழ்பவர்களுக்கு. வீட்டில் யாராவது மின்சார மருத்துவ உபகரணங்களைச் சார்ந்திருந்தால், போஸ்ட்பெய்டின் முறையான-அறிவிப்பு
        துண்டிப்பு செயல்முறையும் பாதுகாப்பான இயல்புநிலை — எந்த மாற்றத்திற்கும் முன் இதை உங்கள் DISCOM-இடம்
        எழுப்புங்கள்.</p>
        <p>உங்கள் ரீசார்ஜ்களை சரியாக அளவிடுவது பெரும்பாலான ப்ரீபெய்ட் உராய்வை நீக்குகிறது: <a href="/recharge-calculator/">ரீசார்ஜ்
        கணிப்பான்</a> உங்கள் DISCOM மற்றும் பயன்பாட்டிற்கான சிறந்த மாதாந்திர தொகையைக் காட்டுகிறது.</p>
      </section>
      <section class="seo-section">
        ...
        <ul class="seo-list">
          ...
          செலுத்தாதவர்களை ப்ரீபெய்ட்-க்கு மாறச் சொல்லலாம் என்பதை அமைச்சர் தெளிவாகக் குறிப்பிட்டார். இந்தத் தேர்வு கட்டணம் செலுத்தும் நுகர்வோரைப் பாதுகாக்கிறது, பாக்கியை அல்ல.</li>
        </ul>
...

  {
    ...
    titleHi: 'MSEDCL FPPCA (ईंधन समायोजन) शुल्क कैसे निकालें',
    metaTitleHi: 'MSEDCL FPPCA / FAC शुल्क — ईंधन समायोजन का पूरा हिसाब',
    descriptionHi: 'MSEDCL बिल पर FPPCA लाइन का मतलब क्या है, हर महीने ₹/यूनिट दर कैसे तय होती है, अपनी यूनिट से यह शुल्क ख़ुद कैसे जाँचें, और अचानक बढ़ जाए तो क्या देखें।',
    introHi: `MSEDCL बिल पर <strong>FPPCA</strong> लाइन का मतलब है ईंधन एवं विद्युत क्रय लागत समायोजन
      (Fuel and Power Purchase Cost Adjustment) — प्रति यूनिट लगने वाला एक मासिक अधिभार (धनात्मक या
      ऋणात्मक), जो MSEDCL की असल बिजली-ख़रीद लागत में हुए बदलाव को उपभोक्ता तक पहुँचाता है। इसे जाँचने
      के लिए बिल पर छपी FPPCA दर को महीने की बिल की गई यूनिट से गुणा करें:
      <strong>FPPCA शुल्क = FPPCA दर (₹/यूनिट) × खपत यूनिट</strong>। यह गाइड बताती है कि वह दर आती
      कहाँ से है, हर महीने क्यों बदलती है, और आप इस लाइन को ख़ुद कैसे जाँच सकते हैं।`,
    sectionsHi: `
      <section class="seo-section">
        <h2>FPPCA है क्या — और क्यों है</h2>
        <p>MSEDCL की मूल ऊर्जा दरें साल भर के लिए MERC (महाराष्ट्र विद्युत नियामक आयोग) टैरिफ़ आदेश में
        तय कर देता है। लेकिन MSEDCL बिजली के लिए असल में जो कीमत चुकाती है — कोयले की लागत, गैस के दाम,
        कमी के दौरान बाज़ार से ख़रीद — वह हर महीने बदलती रहती है। हर बार टैरिफ़ दोबारा खोलने के बजाय
        नियामक एक स्वतः पास-थ्रू की अनुमति देता है:</p>
        <ul>
          <li>जब असल बिजली-ख़रीद लागत टैरिफ़ की मानी गई लागत से <strong>ऊपर</strong> जाती है, तो FPPCA
          <strong>धनात्मक</strong> होता है और बिल में जुड़ता है।</li>
          <li>जब यह उस अनुमान से <strong>नीचे</strong> रहती है (सस्ता कोयला, अच्छे पनबिजली महीने), तो
          FPPCA <strong>ऋणात्मक</strong> हो जाता है और क्रेडिट के रूप में दिखता है।</li>
        </ul>
        <p>पुराने MSEDCL बिलों में इसी लाइन को <strong>FAC</strong> (Fuel Adjustment Charge) कहा जाता था।
        मौजूदा MERC ढाँचे में FPPCA वही व्यवस्था है — खपत यूनिट पर गणना किया जाने वाला मासिक,
        फ़ॉर्मूला-आधारित समायोजन।</p>
      </section>

      <section class="seo-section">
        <h2>हर महीने की ₹/यूनिट दर कैसे तय होती है</h2>
        <p>हर महीने MSEDCL टैरिफ़ में <em>स्वीकृत</em> बिजली-ख़रीद लागत और <em>असल में हुई</em> लागत के
        बीच का अंतर निकालती है (आमतौर पर दो महीने की देरी के साथ, इसलिए गर्मियों में लागत का उछाल
        बिलों पर दो-एक महीने बाद दिखता है)। यह अंतर बेची गई यूनिटों में बाँटने पर प्रति-यूनिट समायोजन
        मिलता है। आपके बिल के लिए दो बातें मायने रखती हैं:</p>
        <div class="comparison-table-wrapper"><table class="comparison-table">
          <thead><tr><th>विशेषता</th><th>आपके लिए इसका मतलब</th></tr></thead>
          <tbody>
            <tr><td><strong>यह श्रेणी और स्लैब के हिसाब से बदलती है</strong></td><td>MSEDCL महीने का
            FPPCA ₹/यूनिट दरों की एक सूची के रूप में प्रकाशित करती है — घरेलू स्लैब, व्यावसायिक,
            औद्योगिक और कृषि कनेक्शनों की अपनी-अपनी दर होती है। आपके बिल पर <em>आपकी</em> श्रेणी और
            खपत स्लैब वाली दर लगती है।</td></tr>
            <tr><td><strong>यह हर महीने बदलती है</strong></td><td>इस महीने के FPPCA की पिछले महीने से
            तुलना कर लेने पर "बिल क्यों बढ़ गया?" के कई मामले वैसे ही सुलझ जाते हैं, जबकि खपत बिल्कुल
            उतनी ही रही हो। दर ख़ुद बिल पर FPPCA लाइन के बगल में छपी होती है।</td></tr>
          </tbody>
        </table></div>
        <p>चूँकि दर हर महीने संशोधित होती है, पिछले महीने का आँकड़ा कभी मत मान लीजिए — दर हमेशा मौजूदा
        बिल से पढ़िए, या उस बिलिंग महीने के लिए MSEDCL की प्रकाशित FPPCA सूची से।</p>
      </section>

      <section class="seo-section">
        <h2>FPPCA लाइन ख़ुद दोबारा जोड़कर देखिए</h2>
        <p>यह जाँच एक मिनट से भी कम लेती है:</p>
        <ol>
          <li>महीने की अपनी <strong>बिल की गई यूनिट</strong> देखिए (मीटर वाले हिस्से में वर्तमान −
          पिछली रीडिंग × MF दिखता है)।</li>
          <li>बिल पर छपी <strong>FPPCA दर</strong> देखिए (₹/यूनिट, कभी-कभी पैसे में लिखी होती है —
          65 पैसे = ₹0.65)।</li>
          <li>गुणा कीजिए: <strong>यूनिट × दर</strong>। नतीजा FPPCA राशि से एक पैसे की गोलाई तक मेल
          खाना चाहिए।</li>
        </ol>
        <p>स्लैब वाली श्रेणियों में MSEDCL हर स्लैब में आने वाली यूनिटों पर उसी स्लैब का FPPCA लगाती है —
        ठीक उसी तरह जैसे ऊर्जा प्रभार स्लैब-वार लगते हैं। हमारा
        <a href="/?state=Maharashtra#calculator">महाराष्ट्र बिल कैलकुलेटर</a> यह अधिभार इसी प्रति-यूनिट
        तर्क से लगाता है: अपनी यूनिट और बिल वाली FPPCA दर डालिए और पूरा कुल मिलान कर लीजिए। MSEDCL की
        मौजूदा मूल दरें <a href="/hi/tariffs/maharashtra/">महाराष्ट्र टैरिफ़ पन्नों</a> पर हैं।</p>
        <p>क्रम का एक नियम जान लेना ज़रूरी है: <strong>बिजली शुल्क (ड्यूटी) की गणना FPPCA जुड़ने के बाद
        होती है</strong>। इसलिए ज़्यादा FPPCA वाले महीने में ड्यूटी की लाइन भी थोड़ी ऊपर जाती है — दोनों
        लाइनें साथ चलती हैं, यह सामान्य है, दोहरा शुल्क नहीं।</p>
      </section>

      <section class="seo-section">
        <h2>जब FPPCA लाइन ग़लत लगे</h2>
        <ul>
          <li><strong>गुणा मेल नहीं खा रहा।</strong> देखिए कि दर पैसे में छपी थी और आपने रुपये मानकर
          गुणा तो नहीं किया, और कहीं बिल अवधि दो महीनों में तो नहीं फैली (तब यूनिट दो अलग मासिक दरों
          में बँट सकती हैं)।</li>
          <li><strong>दर असामान्य रूप से ऊँची लग रही है।</strong> उस महीने और अपनी श्रेणी के लिए MSEDCL
          की प्रकाशित FPPCA सूची से मिलाइए। घरेलू कनेक्शन पर व्यावसायिक दर लग जाना श्रेणी की ग़लती है,
          जिस पर आपत्ति बनती है।</li>
          <li><strong>अनुमानित बिल पर FPPCA आ गया।</strong> अगर महीने का बिल अनुमानित रीडिंग पर बना है,
          तो FPPCA भी अनुमानित यूनिट पर ही चलता है — असल रीडिंग लेने पर यह ऊर्जा प्रभार के साथ अपने आप
          ठीक हो जाता है।</li>
        </ul>
        <p>अगर फिर भी आँकड़े नहीं मिल रहे, तो बिल हमारी मुफ़्त
        <a href="/bill-review/">विशेषज्ञ बिल समीक्षा</a> पर अपलोड कर दीजिए — FPPCA लगाने की ग़लतियाँ
        समीक्षकों को सबसे ज़्यादा मिलने वाली चीज़ों में से हैं।</p>
      </section>`,
    faqsHi: [
      { q: 'MSEDCL बिजली बिल पर FPPCA क्या होता है?',
        a: 'FPPCA (ईंधन एवं विद्युत क्रय लागत समायोजन) प्रति यूनिट लगने वाला एक मासिक अधिभार है, जो MSEDCL की असल बिजली-ख़रीद लागत में हुए बदलाव को उपभोक्ता तक पहुँचाता है। यह पुरानी FAC लाइन की जगह आया है, हर महीने श्रेणी और स्लैब के हिसाब से तय होता है, और धनात्मक (शुल्क) या ऋणात्मक (क्रेडिट) दोनों हो सकता है।' },
      { q: 'अपने MSEDCL बिल पर FPPCA शुल्क कैसे निकालूँ?',
        a: 'महीने की बिल की गई यूनिट को बिल पर छपी FPPCA दर से गुणा कीजिए (पैसे और रुपये का ध्यान रखिए)। स्लैब वाली श्रेणियों में दर स्लैब-वार लगती है, ठीक जैसे ऊर्जा प्रभार लगते हैं। गुणनफल FPPCA लाइन से गोलाई तक मेल खाना चाहिए।' },
      { q: 'MSEDCL का FPPCA हर महीने क्यों बदलता है?',
        a: 'यह समायोजन MERC टैरिफ़ में स्वीकृत बिजली-ख़रीद लागत और MSEDCL द्वारा असल में चुकाई गई लागत के मासिक अंतर का पीछा करता है, आमतौर पर लगभग दो महीने की देरी से। इसीलिए कोयले और बाज़ार-बिजली के दामों की हलचल बिलों पर दो-एक महीने बाद दिखती है।' },
      { q: 'क्या MSEDCL बिल पर FPPCA ऋणात्मक हो सकता है?',
        a: 'हाँ। जिन महीनों में असल बिजली-ख़रीद लागत टैरिफ़ में मानी गई लागत से कम रहती है, समायोजन ऋणात्मक होता है और प्रति-यूनिट क्रेडिट के रूप में दिखकर बिल घटाता है।' },
      { q: 'क्या महाराष्ट्र में FPPCA पर बिजली शुल्क लगता है?',
        a: 'हाँ — बिजली शुल्क की गणना FPPCA जुड़ने के बाद होती है, इसलिए ड्यूटी का आधार ईंधन समायोजन को भी समेटे रहता है। ज़्यादा FPPCA वाले महीने में ड्यूटी की लाइन उसी अनुपात में बढ़ती है; यही निर्धारित क्रम है, दोहरा शुल्क नहीं।' },
    ],
...

  {
    ...
    titleHi: 'बिजली की एक यूनिट क्या होती है? kWh और उपकरणों का गणित',
    metaTitleHi: 'बिजली की 1 यूनिट क्या है? kWh का पूरा हिसाब — 2026',
    descriptionHi: 'एक यूनिट बिजली = एक किलोवाट-घंटा (kWh): 1,000 वॉट का उपकरण एक घंटे चलने पर। मीटर यूनिट कैसे गिनता है, किसी भी उपकरण की महीने की खपत कैसे निकालें, और बिल की हर लाइन यूनिट से क्यों तय होती है।',
    introHi: `बिजली की एक <strong>यूनिट</strong> यानी एक <strong>किलोवाट-घंटा (kWh)</strong> —
      1,000 वॉट का उपकरण एक घंटे में जितनी ऊर्जा खर्च करता है, उतनी। 500 वॉट के उपकरण को एक यूनिट
      खर्च करने में दो घंटे लगते हैं; 2,000 वॉट का गीज़र 30 मिनट में एक यूनिट पी जाता है। आपके बिल
      की हर राशि अंततः इसी बात से तय होती है कि मीटर ने कितनी यूनिट गिनीं — इसीलिए उपकरण-दर-उपकरण
      यूनिट का हिसाब लगाना बिल समझने और पहले से अंदाज़ा लगाने का सबसे तेज़ तरीका है।`,
    sectionsHi: `
      <section class="seo-section">
        <h2>फ़ॉर्मूला और हल किए हुए उदाहरण</h2>
        <p><strong>यूनिट (kWh) = वॉट में क्षमता × चले हुए घंटे ÷ 1,000.</strong></p>
        <div class="comparison-table-wrapper"><table class="comparison-table">
          <thead><tr><th>उपकरण</th><th>सामान्य क्षमता</th><th>रोज़ का उपयोग</th><th>यूनिट/माह (लगभग)</th></tr></thead>
          <tbody>
            <tr><td>सीलिंग फ़ैन</td><td>75 वॉट</td><td>12 घंटे</td><td>27</td></tr>
            <tr><td>LED टीवी (43")</td><td>80 वॉट</td><td>5 घंटे</td><td>12</td></tr>
            <tr><td>फ़्रिज (250 लीटर)</td><td>~150 वॉट कंप्रेसर, चक्र में</td><td>24 घंटे प्लग में</td><td>30–45</td></tr>
            <tr><td>1.5 टन इन्वर्टर AC</td><td>1,200–1,800 वॉट, घटता-बढ़ता</td><td>8 घंटे</td><td>250–350</td></tr>
            <tr><td>गीज़र (स्टोरेज)</td><td>2,000 वॉट</td><td>45 मिनट</td><td>45</td></tr>
            <tr><td>वॉशिंग मशीन</td><td>500 वॉट (बिना हीटर)</td><td>1 घंटा × 15 दिन</td><td>7–8</td></tr>
          </tbody>
        </table></div>
        <p>दो आदतें इन अनुमानों को सटीक बनाती हैं: <em>असली</em> नेमप्लेट वॉटेज देखें (प्लग के पास
        लगे स्टिकर या मैनुअल में), और यह याद रखें कि थर्मोस्टैट वाले उपकरण (फ़्रिज, AC, गीज़र) चालू-बंद
        होते रहते हैं — इसलिए उनकी असल खपत क्षमता × घंटे से काफ़ी कम रहती है। ऊपर AC और फ़्रिज की
        पंक्तियाँ इसी वजह से रेंज में दी गई हैं। पूरे घर का हिसाब लगाने के लिए हमारा
        <a href="/electricity-cost-calculator/">खपत अनुमानक</a> यही काम उपकरण-दर-उपकरण करता है।</p>
      </section>

      <section class="seo-section">
        <h2>आपका मीटर यूनिट कैसे गिनता है</h2>
        <ul>
          <li>मीटर kWh को लगातार एक आजीवन काउंटर में जोड़ता रहता है — यह कभी रीसेट नहीं होता। बिल में
          आई खपत बस <strong>वर्तमान रीडिंग − पिछली रीडिंग</strong> होती है।</li>
          <li>जहाँ करंट ट्रांसफ़ॉर्मर लोड को मीटर के लिए घटाकर दिखाता है (बड़े कनेक्शन), वहाँ इस अंतर को
          <strong>MF</strong> (गुणक कारक) से गुणा किया जाता है। घरेलू मीटरों में MF लगभग हमेशा 1 होता है।</li>
          <li>कुछ व्यावसायिक और औद्योगिक कनेक्शनों का बिल kWh की जगह <strong>kVAh</strong> (आभासी ऊर्जा)
          पर बनता है — kVAh = kWh ÷ पावर फ़ैक्टर, इसलिए ख़राब पावर फ़ैक्टर सीधे बिल की यूनिट बढ़ा देता है।
          देखें हमारी <a href="/hi/guides/tod-billing-explained/">TOD और kVAh बिलिंग गाइड</a>।</li>
        </ul>
      </section>

      <section class="seo-section">
        <h2>बिल में यूनिट सबसे ज़्यादा मायने क्यों रखती है</h2>
        <p>भारतीय बिजली बिल की लगभग हर लाइन यूनिट के साथ बढ़ती है:</p>
        <ol>
          <li><strong>ऊर्जा प्रभार</strong> — यूनिट पर आपके राज्य की स्लैब दरें लगती हैं। स्लैब ऊपर
          चढ़ते हैं, इसलिए 350वीं यूनिट की कीमत 50वीं यूनिट से लगभग दोगुनी हो सकती है। हर डिस्कॉम की
          स्लैब दरें हमारे <a href="/hi/tariffs/states/">टैरिफ़ पन्नों</a> पर हैं।</li>
          <li><strong>ईंधन अधिभार (FPPA/FPPCA)</strong> — या तो प्रति यूनिट लगता है या ऊर्जा प्रभार के
          प्रतिशत के रूप में; दोनों ही तरह यह यूनिट के पीछे चलता है।</li>
          <li><strong>बिजली शुल्क (इलेक्ट्रिसिटी ड्यूटी)</strong> — ऊपर की राशियों पर प्रतिशत में लगता है,
          इसलिए यूनिट से तय हुआ कुल इसमें अपने आप आ जाता है।</li>
        </ol>
        <p>सिर्फ़ फ़िक्स्ड चार्ज (₹ प्रति kW स्वीकृत भार) यूनिट से नहीं जुड़ा होता। यही वजह है कि 50 यूनिट
        की एक ही बचत ऊँचे स्लैब वाले महीने में ज़्यादा पैसे बचाती है — और यही वजह है कि उपकरण-दर-उपकरण
        यूनिट का अनुमान लगाकर उसे <a href="/#calculator">बिल कैलकुलेटर</a> में जाँच लेने से बिल
        कुछ प्रतिशत के भीतर पहले ही पता चल जाता है।</p>
      </section>`,
    faqsHi: [
      { q: 'बिजली की 1 यूनिट कितने की होती है?',
        a: 'एक यूनिट यानी एक किलोवाट-घंटा (kWh): 1,000 वॉट का उपकरण एक घंटे चलने पर। इसकी कीमत आपके राज्य, श्रेणी और खपत स्लैब पर निर्भर करती है — वही एक यूनिट निचले स्लैब में कुछ रुपये और ऊँचे स्लैब में लगभग दोगुनी पड़ सकती है।' },
      { q: 'किसी उपकरण की खपत यूनिट में कैसे निकालें?',
        a: 'यूनिट = वॉट × घंटे ÷ 1,000। 75 वॉट का पंखा रोज़ 12 घंटे चले तो रोज़ 0.9 यूनिट, यानी महीने में लगभग 27 यूनिट। AC, फ़्रिज और गीज़र जैसे थर्मोस्टैट वाले उपकरणों में असल खपत क्षमता × घंटे से कम रहती है, क्योंकि कंप्रेसर या एलिमेंट चालू-बंद होता रहता है।' },
      { q: '1.5 टन AC दिन में कितनी यूनिट खर्च करता है?',
        a: '1.5 टन इन्वर्टर AC आमतौर पर प्रति घंटे लगभग 1 से 1.5 यूनिट लेता है — यह सेट तापमान, इन्सुलेशन और बाहर की गर्मी पर निर्भर करता है। यानी 8 घंटे की रात के लिए करीब 8 से 12 यूनिट। पुराने नॉन-इन्वर्टर AC इससे ज़्यादा खर्च करते हैं।' },
      { q: 'बिल में kWh और kVAh में क्या अंतर है?',
        a: 'kWh वह सक्रिय ऊर्जा नापता है जो असल में काम में बदली; kVAh आभासी ऊर्जा नापता है, जो kWh को पावर फ़ैक्टर से भाग देने पर मिलती है। कुछ व्यावसायिक और औद्योगिक टैरिफ़ kVAh पर बिल बनाते हैं, इसलिए ख़राब पावर फ़ैक्टर सीधे बिल की यूनिट बढ़ा देता है।' },
    ],
    ...
    introTa: `ஒரு <strong>யூனிட்</strong> மின்சாரம் என்பது ஒரு <strong>கிலோவாட்-மணி (kWh)</strong> —
      1,000-வாட் சாதனம் ஒரு மணி நேரத்தில் நுகரும் ஆற்றல். ஒரு 500 W சாதனம் ஒரு யூனிட்டைப் பயன்படுத்த இரண்டு மணிநேரம்
      எடுக்கும்; ஒரு 2,000 W கீசர் 30 நிமிடத்தில் ஒரு யூனிட்டைப் பயன்படுத்துகிறது. உங்கள் மின் பில்லின் ஒவ்வொரு
      கட்டணமும் இறுதியில் உங்கள் மீட்டர் எத்தனை யூனிட்களை எண்ணியது என்பதால் இயக்கப்படுகிறது, எனவே சாதன-அளவிலான யூனிட்
      கணக்கே உங்கள் பில்லைப் புரிந்துகொள்ளவும் — முன்கூட்டியே அறியவும் — வேகமான வழி.`,
    sectionsTa: `
      <section class="seo-section">
        <h2>சூத்திரமும், தீர்க்கப்பட்ட எடுத்துக்காட்டுகளும்</h2>
        <p><strong>யூனிட்கள் (kWh) = திறன் மதிப்பீடு (வாட்) × பயன்படுத்திய மணிநேரம் ÷ 1,000.</strong></p>
        <div class="comparison-table-wrapper"><table class="comparison-table">
          <thead><tr><th>சாதனம்</th><th>வழக்கமான மதிப்பீடு</th><th>தினசரி பயன்பாடு</th><th>யூனிட்கள்/மாதம் (≈)</th></tr></thead>
          <tbody>
            <tr><td>கூரை விசிறி</td><td>75 W</td><td>12 மணி</td><td>27</td></tr>
            <tr><td>LED TV (43")</td><td>80 W</td><td>5 மணி</td><td>12</td></tr>
            <tr><td>குளிர்சாதனப் பெட்டி (250 L)</td><td>~150 W கம்ப்ரசர், சுழற்சி</td><td>24 மணி இணைப்பு</td><td>30–45</td></tr>
            <tr><td>1.5-டன் இன்வெர்ட்டர் AC</td><td>1,200–1,800 W மாறும்</td><td>8 மணி</td><td>250–350</td></tr>
            <tr><td>கீசர் (சேமிப்பு)</td><td>2,000 W</td><td>45 நிமி</td><td>45</td></tr>
            <tr><td>சலவை இயந்திரம்</td><td>500 W (ஹீட்டர் இல்லாமல்)</td><td>1 மணி × 15 நாட்கள்</td><td>7–8</td></tr>
          </tbody>
        </table></div>
        <p>இந்த மதிப்பீடுகளைத் துல்லியமாக்க இரண்டு பழக்கங்கள்: <em>உண்மையான</em> நேம்பிளேட் வாட்டேஜைப் பயன்படுத்துங்கள்
        (பிளக்கிற்கு அருகில் உள்ள ஸ்டிக்கரில் அல்லது கையேட்டில்), மேலும் தெர்மோஸ்டாட்-இயக்கப்படும் சாதனங்கள் (குளிர்சாதனப்
        பெட்டி, AC, கீசர்) இயக்கம்-நிறுத்தம் சுழல்கின்றன என்பதை நினைவில் கொள்ளுங்கள் — அவற்றின் திறம்பட நுகர்வு மதிப்பீடு
        × மணிநேரத்தை விடக் கணிசமாகக் குறைவு, அதனால்தான் மேலே உள்ள AC மற்றும் குளிர்சாதனப் பெட்டி வரிசைகள் வரம்புகள்.
        முழு வீட்டையும் மாதிரியாக்க, எங்கள் <a href="/electricity-cost-calculator/">பயன்பாட்டு மதிப்பீட்டாளர்</a> இதை
        சாதனம்-வாரியாகச் செய்கிறது.</p>
      </section>

      <section class="seo-section">
        <h2>உங்கள் மீட்டர் யூனிட்களை எப்படி எண்ணுகிறது</h2>
        <ul>
          <li>மீட்டர் kWh-ஐ ஒரு வாழ்நாள் கவுண்ட்டரில் தொடர்ச்சியாகக் குவிக்கிறது — அது ஒருபோதும் மீட்டமைக்கப்படாது. உங்கள்
          பட்டியலிடப்பட்ட நுகர்வு வெறுமனே <strong>தற்போதைய அளவீடு − முந்தைய அளவீடு</strong>.</li>
          <li>ஒரு மின்னோட்ட மின்மாற்றி மீட்டருக்காக சுமையைக் குறைக்கும் இடத்தில் (பெரிய இணைப்புகள்), வித்தியாசம் ஒரு
          <strong>MF</strong> (பெருக்கல் காரணி) ஆல் பெருக்கப்படுகிறது. வீட்டு மீட்டர்களுக்கு கிட்டத்தட்ட எப்போதும் MF = 1.</li>
          <li>சில வணிக மற்றும் தொழில்துறை வழங்கல்கள் kWh-க்குப் பதிலாக <strong>kVAh</strong>-இல் (தோற்ற ஆற்றல்)
          பட்டியலிடப்படுகின்றன — kVAh = kWh ÷ பவர் ஃபேக்டர், எனவே மோசமான பவர் ஃபேக்டர் பட்டியலிடப்பட்ட யூனிட்களை நேரடியாக
          உயர்த்துகிறது. எங்கள் <a href="/guides/tod-billing-explained/">ToD மற்றும் kVAh பட்டியல் வழிகாட்டியைப்</a>
          பார்க்கவும்.</li>
        </ul>
      </section>

      <section class="seo-section">
        <h2>பில்லில் வேறு எதையும் விட யூனிட்கள் ஏன் முக்கியம்</h2>
        <p>ஒரு இந்திய மின் பில்லின் கிட்டத்தட்ட ஒவ்வொரு வரியும் யூனிட்களுடன் அளவிடப்படுகிறது:</p>
        <ol>
          <li><strong>ஆற்றல் கட்டணம்</strong> — உங்கள் மாநிலத்தின் அடுக்கு அட்டவணை மூலம் விலை நிர்ணயிக்கப்படும் யூனிட்கள்.
          அடுக்குகள் படிப்படியாக உயர்வதால், யூனிட் #350 யூனிட் #50 செலவாகுவதை விட கிட்டத்தட்ட இரட்டிப்பாகச் செலவாகும்.
          ஒவ்வொரு DISCOM-இன் அடுக்கு விகிதங்களும் எங்கள் <a href="/tariffs/">கட்டணப் பக்கங்களில்</a> உள்ளன.</li>
          <li><strong>எரிபொருள் கூடுதல் கட்டணம் (FPPA/FPPCA)</strong> — ஒரு யூனிட்டுக்கு அல்லது ஆற்றல் கட்டணத்தின்
          சதவீதமாக விதிக்கப்படுகிறது, இரண்டு வழியிலும் யூனிட்களைப் பின்தொடர்கிறது.</li>
          <li><strong>மின் வரி</strong> — மேற்கண்டவற்றின் மீது ஒரு சதவீதம், எனவே இது யூனிட்-இயக்கப்படும் மொத்தத்தைப்
          பெறுகிறது.</li>
        </ol>
        <p>நிலையான கட்டணம் (அனுமதிக்கப்பட்ட சுமையின் ஒரு kW-க்கு ₹) மட்டுமே யூனிட்களைப் புறக்கணிக்கிறது. அதனால்தான் அதே
        50-யூனிட் குறைப்பு குறைந்த-அடுக்கு மாதத்தை விட உயர்-அடுக்கு மாதத்தில் அதிகம் சேமிக்கிறது — மேலும் ஏன் யூனிட்களை
        சாதனம்-வாரியாக மதிப்பிட்டு, பின்னர் <a href="/#calculator">பில் கணிப்பானில்</a> சரிபார்ப்பது உங்கள் பில்லை சில
        சதவீதத்திற்குள் முன்கூட்டியே அறிவிக்கிறது.</p>
      </section>`,
    faqsTa: [
      { q: '1 யூனிட் மின்சாரம் எவ்வளவு?', a: 'ஒரு யூனிட் ஒரு கிலோவாட்-மணிக்கு (kWh) சமம்: 1,000-வாட் சாதனம் ஒரு மணி நேரம் இயங்குவது. அதன் விலை உங்கள் மாநிலம், வகை மற்றும் நுகர்வு அடுக்கைப் பொறுத்தது — அதே யூனிட் குறைந்த அடுக்கில் சில ரூபாயும் உயர் அடுக்கில் தோராயமாக அதன் இரட்டிப்பும் செலவாகலாம்.' },
      { q: 'ஒரு சாதனம் நுகரும் யூனிட்களை எப்படிக் கணக்கிடுவது?', a: 'யூனிட்கள் = வாட் × மணிநேரம் ÷ 1,000. ஒரு நாளைக்கு 12 மணிநேரம் இயங்கும் 75 W விசிறி தினமும் 0.9 யூனிட், மாதம் சுமார் 27 பயன்படுத்துகிறது. AC, குளிர்சாதனப் பெட்டி, கீசர் போன்ற தெர்மோஸ்டாட்-இயக்கப்படும் சாதனங்களுக்கு, கம்ப்ரசர் அல்லது எலிமென்ட் இயக்கம்-நிறுத்தம் சுழல்வதால் திறம்பட நுகர்வு மதிப்பீடு × மணிநேரத்தை விடக் குறைவு.' },
      { q: '1.5-டன் AC ஒரு நாளைக்கு எத்தனை யூனிட் பயன்படுத்துகிறது?', a: 'ஒரு 1.5-டன் இன்வெர்ட்டர் AC அமைக்கப்பட்ட வெப்பநிலை, காப்பு மற்றும் வெளிப்புற வெப்பத்தைப் பொறுத்து பொதுவாக ஒரு மணிக்கு தோராயமாக 1 முதல் 1.5 யூனிட் நுகர்கிறது — 8-மணிநேர இரவுக்கு சுமார் 8 முதல் 12 யூனிட். பழைய இன்வெர்ட்டர் அல்லாத யூனிட்கள் அதிகமாக இயங்கும்.' },
      { q: 'பில்லில் kWh-க்கும் kVAh-க்கும் உள்ள வித்தியாசம் என்ன?', a: 'kWh என்பது உண்மையில் வேலையாக மாற்றப்பட்ட செயலூக்க ஆற்றலை அளவிடுகிறது; kVAh என்பது தோற்ற ஆற்றலை அளவிடுகிறது, இது kWh-ஐ பவர் ஃபேக்டரால் வகுத்ததற்குச் சமம். சில வணிக மற்றும் தொழில்துறை கட்டணங்கள் kVAh-இல் பட்டியலிடுகின்றன, எனவே மோசமான பவர் ஃபேக்டர் பட்டியலிடப்பட்ட யூனிட்களை நேரடியாக அதிகரிக்கிறது.' },
    ],
  ...
  },
  {
    ...
    titleHi: 'UPPCL नया कनेक्शन एस्टीमेट 2026: SAC और मीटर शुल्क',
    metaTitleHi: 'UPPCL नया कनेक्शन एस्टीमेट 2026: SAC शुल्क',
    descriptionHi: 'UPPCL नया कनेक्शन एस्टीमेट 2026: भार और दूरी के हिसाब से तय SAC स्लैब, मीटरिंग शुल्क, स्मार्ट मीटर वसूली, और कब वास्तविक एस्टीमेट लागू होता है।',
    introHi: `UPPCL के नए कनेक्शन का एस्टीमेट 2026 में बदल गया है, क्योंकि कॉस्ट डेटा बुक अब
      विद्युतीकृत क्षेत्रों में 150 kW तक के अधिकांश गैर-PTW कनेक्शनों के लिए तय
      <strong>सप्लाई अफोर्डिंग चार्ज (SAC)</strong> स्लैब का इस्तेमाल करती है। अब हर आवेदक के लिए
      अलग लाइन एस्टीमेट बनाने के बजाय, राशि आपके स्वीकृत भार और नज़दीकी वितरण लाइन से तार की
      वास्तविक दूरी के आधार पर एक तालिका से ली जाती है। इस लेख में वही तालिका, आपका एस्टीमेट अब
      अलग क्यों दिखता है, और किन मामलों में आज भी वास्तविक एस्टीमेट बनता है — सब समझाया गया है।`,
    sectionsHi: `
      <section class="seo-section">
        <h2>1. 2026 का एस्टीमेट अलग क्यों दिखता है</h2>
        <p>पुराने तरीके में एस्टीमेट अक्सर साइट विज़िट, नापी गई लाइन की लंबाई, खंभे, केबल, मज़दूरी
        और जूनियर इंजीनियर के हाथ से बनाए गए हिसाब पर निर्भर करता था। एक ही मोहल्ले के दो उपभोक्ताओं
        को अलग-अलग रकम दिख सकती थी, और दोनों में से कोई भी उसकी जाँच आसानी से नहीं कर सकता था।</p>
        <p>2026 की कॉस्ट डेटा बुक अधिकांश छोटे और मझोले नए कनेक्शनों को एक सीधे नियम पर ले आती है:
        <strong>मीटरिंग शुल्क + तय SAC स्लैब</strong>। SAC मासिक बिल का हिस्सा नहीं है। यह आपके
        परिसर तक बिजली उपलब्ध कराने के लिए ली जाने वाली एकमुश्त राशि है।</p>
        <ul>
          <li><strong>दूरी स्लैब:</strong> 100 मीटर तक, 100 मीटर से ऊपर 300 मीटर तक, और 300 मीटर से अधिक।</li>
          <li><strong>भार स्लैब:</strong> सिंगल-फेज LT, थ्री-फेज LT और 150 kW तक के HT भार के लिए अलग-अलग पंक्तियाँ।</li>
          <li><strong>300 मीटर से आगे:</strong> UPPCL वास्तविक एस्टीमेट बनाता है और तालिका की राशि व
          वास्तविक एस्टीमेट में से जो अधिक हो, वही वसूलता है।</li>
        </ul>
      </section>

      <section class="seo-section">
        <h2>2. अध्याय 5A की मीटरिंग शुल्क व SAC तालिका</h2>
        <p>यह तालिका <strong>विद्युतीकृत क्षेत्रों में 150 kW तक के गैर-PTW भार</strong> के लिए है,
        जैसा 2026 कॉस्ट डेटा बुक के अध्याय 5A "मीटरिंग चार्ज एंड सप्लाई अफोर्डिंग चार्ज" में छपा है।
        आख़िरी कॉलम में दी गई राशि <em>न्यूनतम</em> है: UPPCL वास्तविक एस्टीमेट बनाकर दोनों में से
        जो अधिक हो, वही लेता है।</p>
        <div class="comparison-table-wrapper"><table class="comparison-table">
          <thead>
            <tr>
              <th>भार</th>
              ...
              <th>मीटर वसूली</th>
              <th>SAC ≤100 मी</th>
              <th>SAC 100–300 मी</th>
              <th>SAC &gt;300 मी</th>
            </tr>
          </thead>
          <tbody>
            <tr><td><strong>सिंगल-फेज 1 kW</strong><br>केवल लाइफलाइन उपभोक्ता</td><td>₹1,425</td><td>₹84 × 24 माह</td><td>₹1,000</td><td>₹3,500</td><td>₹3,500</td></tr>
            <tr><td><strong>सिंगल-फेज 1 kW से 2 kW</strong><br>लाइफलाइन के अलावा</td><td>₹1,855</td><td>₹84 × 24 माह</td><td>₹1,500</td><td>₹3,500</td><td>₹3,500</td></tr>
            <tr><td><strong>सिंगल-फेज 3 kW से 4 kW</strong></td><td>₹1,908</td><td>₹84 × 24 माह</td><td>₹3,500</td><td>₹6,500</td><td>₹6,500</td></tr>
            <tr><td><strong>थ्री-फेज 3 kW से 4 kW</strong></td><td>₹5,278</td><td>शून्य</td><td>₹6,500</td><td>₹13,000</td><td>₹13,000</td></tr>
            <tr><td><strong>थ्री-फेज 5 kW से 10 kW</strong></td><td>₹6,358</td><td>शून्य</td><td>₹10,000</td><td>₹20,000</td><td>₹20,000</td></tr>
            <tr><td><strong>थ्री-फेज 11 kW से 15 kW</strong></td><td>₹6,358</td><td>शून्य</td><td>₹20,000</td><td>₹40,000</td><td>₹40,000</td></tr>
            <tr><td><strong>थ्री-फेज 16 kW से 20 kW</strong></td><td>₹6,358</td><td>शून्य</td><td>₹25,000</td><td>₹50,000</td><td>₹50,000</td></tr>
            <tr><td><strong>थ्री-फेज 21 kW से 24 kW</strong></td><td>₹6,358</td><td>शून्य</td><td>₹35,000</td><td>₹70,000</td><td>₹70,000</td></tr>
            <tr><td><strong>थ्री-फेज 25 kW</strong></td><td>₹12,418 ओवरहेड<br>₹14,706 अंडरग्राउंड</td><td>शून्य</td><td>₹35,000</td><td>₹70,000</td><td>₹70,000</td></tr>
            <tr><td><strong>थ्री-फेज 26 kW से 35 kW</strong></td><td>₹12,418 ओवरहेड<br>₹14,706 अंडरग्राउंड</td><td>शून्य</td><td>₹50,000</td><td>₹1,00,000</td><td>₹1,00,000</td></tr>
            <tr><td><strong>थ्री-फेज 36 kW से 50 kW</strong></td><td>₹12,418 ओवरहेड<br>₹14,706 अंडरग्राउंड</td><td>शून्य</td><td>₹80,000</td><td>₹1,60,000</td><td>₹1,60,000</td></tr>
            <tr><td><strong>HT 51 kW से 150 kW</strong><br>166 kVA</td><td>₹2,48,280 ओवरहेड<br>₹2,65,110 अंडरग्राउंड</td><td>शून्य</td><td>₹1,22,000</td><td>₹2,22,000</td><td>₹2,22,000</td></tr>
          </tbody>
        </table></div>
        <p><strong>इसे पढ़ें कैसे:</strong> 100 मीटर के भीतर 2 kW घरेलू आवेदक के लिए अलग से कोई लाइन
        एस्टीमेट बनता ही नहीं। अध्याय 5A वाला हिस्सा है ₹1,855 मीटरिंग शुल्क + ₹1,500 SAC — यानी
        ₹3,355 — और स्मार्ट मीटर की वसूली इससे अलग लगती है, जैसा नीचे बताया गया है। रजिस्ट्रेशन
        फीस, सिक्योरिटी डिपॉज़िट और श्रेणी-विशेष राशियाँ इसके अतिरिक्त हैं और पोर्टल के एस्टीमेट में
        अपनी अलग लाइनों में दिखती हैं।</p>
      </section>

      <section class="seo-section">
        <h2>3. स्मार्ट मीटर वसूली वाली लाइन</h2>
        <p>सिंगल-फेज कनेक्शनों के लिए तालिका मासिक मीटर शुल्क <strong>₹84 प्रति माह, 24 माह तक</strong>
        दिखाती है। इसीलिए एक छोटे घरेलू आवेदक को शुरू में मीटरिंग शुल्क और बाद में मासिक वसूली —
        दोनों दिख सकते हैं। इसी अध्याय 5A तालिका में थ्री-फेज LT और HT पंक्तियों में मासिक शुल्क
        <strong>शून्य</strong> है।</p>
        <p>इसे कनेक्शन चालू होने के बाद लगने वाले मासिक फिक्स्ड चार्ज से न मिलाएँ। फिक्स्ड चार्ज
        बिजली बिल के टैरिफ का हिस्सा है; मीटरिंग शुल्क नए कनेक्शन की लागत सूची का हिस्सा है।</p>
      </section>

      <section class="seo-section">
        <h2>4. जब SAC से पूरा एस्टीमेट तय नहीं होता</h2>
        <p>तय SAC तालिका का दायरा बड़ा है, पर हर मामले में लागू नहीं होती। इन स्थितियों में व्यवहार अलग होगा:</p>
        <ul>
          <li><strong>वितरण लाइन से 300 मीटर से अधिक दूरी:</strong> वास्तविक एस्टीमेट लागू होता है,
          और तालिका की राशि न्यूनतम सीमा का काम करती है।</li>
          <li><strong>निजी नलकूप / PTW कनेक्शन:</strong> PTW के अपने पैकेज और ट्रांसफॉर्मर नियम हैं;
          किसान पंप पर यह गैर-PTW तालिका न लगाएँ।</li>
          <li><strong>अविद्युतीकृत कॉलोनियाँ और बहुमंज़िला मल्टी-पॉइंट मामले:</strong> ढाँचे की वसूली
          डेवलपमेंट या भवन-स्तरीय शुल्कों से हो सकती है, इसलिए आवेदक को इस मद में सिर्फ़ मीटरिंग
          शुल्क देना पड़ सकता है।</li>
          <li><strong>150 kW से ऊपर के HT भार:</strong> ये इस तालिका से बाहर हैं और इनके लिए संबंधित
          HT एस्टीमेट प्रावधान लागू होते हैं।</li>
        </ul>
      </section>

      <section class="seo-section">
        <h2>5. 3 kW और 4 kW वालों के पास अब फेज़ का विकल्प है</h2>
        <p>यह तालिका छोटी वर्कशॉप और थ्री-फेज उपकरण वाले घरों के लिए ख़ास काम की है:
        <strong>3 kW से 4 kW</strong> सिंगल-फेज और थ्री-फेज, दोनों पंक्तियों में मौजूद है। लागत का
        अंतर वास्तविक है। सिंगल-फेज 3–4 kW पर ₹1,908 मीटरिंग शुल्क और ₹3,500 वाला SAC स्लैब लगता है;
        थ्री-फेज पर ₹5,278 मीटरिंग शुल्क और ₹6,500 SAC — बाक़ी कुछ जोड़ने से पहले ही लगभग ₹6,400 ज़्यादा।
        थ्री-फेज इसलिए चुनें क्योंकि आपके उपकरणों को उसकी ज़रूरत है, इसलिए नहीं कि वह ज़्यादा
        ताक़तवर लगता है।</p>
      </section>

      <section class="seo-section">
        <h2>6. एस्टीमेट भरने से पहले क्या जाँचें</h2>
        <ol>
          <li><strong>भार:</strong> पक्का करें कि झटपट पोर्टल पर डाला गया kW वही है जितनी आपको सच में
          ज़रूरत है। ज़रूरत से ज़्यादा भार नए कनेक्शन का एस्टीमेट और बाद का फिक्स्ड चार्ज, दोनों बढ़ाता है।
          संदेह हो तो हमारी <a href="/hi/guides/reduce-fixed-charges-sanctioned-load/">स्वीकृत भार
          गाइड</a> देखें।</li>
          <li><strong>दूरी बैंड:</strong> देखें कि UPPCL ने आपको 100 मीटर के भीतर रखा है, 100–300 मीटर
          में, या 300 मीटर से आगे। दूरी तार के व्यावहारिक रास्ते की होनी चाहिए, नक़्शे का मोटा अंदाज़ा नहीं।</li>
          <li><strong>फेज़:</strong> 3–4 kW के लिए पुष्टि करें कि एस्टीमेट सिंगल-फेज का है या थ्री-फेज का।</li>
          <li><strong>अलग-अलग मदें:</strong> रजिस्ट्रेशन फीस, मीटरिंग शुल्क, SAC और सिक्योरिटी डिपॉज़िट
          को एक अनजान रकम में न मिलने दें। पोर्टल के एस्टीमेट में हर मद अलग पहचानी जानी चाहिए।</li>
        </ol>
        <p>आवेदन की प्रक्रिया, दस्तावेज़ और शिकायत बढ़ाने के चरणों के लिए साथ वाली
        <a href="/hi/guides/uppcl-new-connection-jhatpat/">UPPCL झटपट नया कनेक्शन गाइड</a> पढ़ें।</p>
      </section>

      <section class="seo-section">
        <h2>स्रोत और इसकी जाँच कैसे करें</h2>
        <p>ऊपर दी गई राशियाँ UPPCL कॉस्ट डेटा बुक 2026 के अध्याय 5A, "मीटरिंग चार्ज एंड सप्लाई
        अफोर्डिंग चार्ज" से ली गई हैं। उस संस्करण के बाद का कोई संशोधन हमें नहीं मिला है, पर कॉस्ट
        डेटा बुक टैरिफ आदेशों की तुलना में ज़्यादा बार संशोधित होती है — इसलिए इस पेज को एस्टीमेट के
        <em>ढाँचे</em> की गाइड मानें, देय राशि का अंतिम प्रमाण नहीं।</p>
        <p><strong>झटपट पोर्टल पर UPPCL जो राशि दिखाता है, वही आपको देनी है।</strong> अगर वह तालिका
        से अलग है, तो पोर्टल सही है और यह पेज पुराना — कृपया
        <a href="/contact/">हमें बताएँ</a> ताकि हम इसे सुधार सकें। हम आँकड़े कहाँ से लेते और कैसे
        जाँचते हैं, यह हमारे <a href="/methodology/">मेथडोलॉजी नोट</a> में है।</p>
      </section>`,
    faqsHi: [
      { q: 'UPPCL नए कनेक्शन एस्टीमेट में SAC क्या है?',
        a: 'SAC यानी सप्लाई अफोर्डिंग चार्ज। यह आवेदक तक बिजली उपलब्ध कराने के लिए ली जाने वाली एकमुश्त राशि है, जो 2026 कॉस्ट डेटा बुक के तहत विद्युतीकृत क्षेत्रों में 150 kW तक के अधिकांश गैर-PTW कनेक्शनों के लिए भार और दूरी स्लैब से तय होती है।' },
      { q: '2 kW UPPCL घरेलू कनेक्शन पर कितना SAC लगता है?',
        a: 'सिंगल-फेज 1 kW से 2 kW गैर-लाइफलाइन कनेक्शन के लिए अध्याय 5A में 100 मीटर तक ₹1,500 और 100 से 300 मीटर तक ₹3,500 SAC दिया गया है। 300 मीटर से आगे वास्तविक एस्टीमेट लागू होता है, जिसमें ₹3,500 न्यूनतम सीमा है।' },
      { q: 'क्या UPPCL मीटरिंग शुल्क और मासिक फिक्स्ड चार्ज एक ही हैं?',
        a: 'नहीं। मीटरिंग शुल्क नए कनेक्शन की लागत सूची का हिस्सा है। मासिक फिक्स्ड चार्ज कनेक्शन चालू होने के बाद बिजली टैरिफ का हिस्सा है और हर महीने स्वीकृत भार के आधार पर लगता है।' },
      { q: 'क्या PTW या निजी नलकूप कनेक्शन पर यही SAC तालिका लगती है?',
        a: 'नहीं। अध्याय 5A की तालिका विद्युतीकृत क्षेत्रों में 150 kW तक के गैर-PTW भार के लिए है। निजी नलकूप कनेक्शनों पर उनके अपने पैकेज और ट्रांसफॉर्मर प्रावधान लागू होते हैं।' },
      { q: 'अगर मेरा घर नज़दीकी लाइन से 300 मीटर से ज़्यादा दूर है तो क्या होगा?',
        a: 'UPPCL वास्तविक एस्टीमेट बनाता है। आपके भार वाली पंक्ति की अध्याय 5A न्यूनतम राशि और उस काम के लिए बना वास्तविक एस्टीमेट — इन दोनों में से जो अधिक हो, वही देना होता है।' },
    ],
  },
  {
...

  {
    ...
    titleTa: '1.5 டன் AC உங்கள் மின் பில்லில் எவ்வளவு சேர்க்கிறது?',
    metaTitleTa: '1.5 டன் AC மாதாந்திர மின் பில் — யூனிட்கள், செலவு & அடுக்குப் பொறி',
    descriptionTa: '1.5 டன் AC ஒரு மணிக்கும் மாதத்திற்கும் எத்தனை யூனிட் நுகர்கிறது (ஸ்டார் மதிப்பீட்டின்படி), AC யூனிட்கள் ஏன் உங்கள் மிக உயர்ந்த அடுக்கு விகிதத்தில் பட்டியலிடப்படுகின்றன, ஒரு யதார்த்தமான மாதாந்திர செலவு அட்டவணை, மற்றும் வியர்க்காமல் பில்லைக் குறைக்கும் ஐந்து வழிகள்.',
    introTa: `ஒரு நாளைக்கு 8 மணி நேரம் இயங்கும் 1.5 டன் AC உங்கள் மீட்டரில் மாதம் தோறும் தோராயமாக
      <strong>250–370 யூனிட்கள்</strong> சேர்க்கிறது — அதன் ஸ்டார் மதிப்பீடு மற்றும் வயதைப் பொறுத்து — மேலும்
      அடுக்குக் கட்டணங்கள் டெலிஸ்கோபிக் என்பதால், அந்த ஒவ்வொரு யூனிட்டும் சராசரி விகிதத்தில் அல்ல, உங்கள்
      <em>மிக உயர்ந்த</em> பொருந்தும் விகிதத்தில் பட்டியலிடப்படுகிறது. இந்த வழிகாட்டி உண்மையான கணக்கைக் காட்டுகிறது:
      ஸ்டார் மதிப்பீட்டின்படி ஒரு மணிக்கு யூனிட்கள், அது வழக்கமான விளிம்பு விகிதங்களில் எவ்வளவு செலவாகும், மற்றும்
      உண்மையில் எது குறைக்கிறது.`,
    sectionsTa: `
      <section class="seo-section">
        <h2>1.5 டன் AC ஒரு மணிக்கு எத்தனை யூனிட் பயன்படுத்துகிறது?</h2>
        <p>"1.5 டன்" என்பது குளிரூட்டல் வெளியீட்டை (சுமார் 5,100 வாட் வெப்பம் அகற்றப்படுவது) குறிக்கிறது, இழுக்கப்படும்
        மின்சாரத்தை அல்ல. மீட்டர் என்ன பதிவு செய்கிறது என்பது AC-இன் திறனைப் பொறுத்தது — அதன் <strong>ISEER</strong>
        (இந்திய பருவகால ஆற்றல் திறன் விகிதம்), இதையே BEE ஸ்டார் லேபிள் தரப்படுத்துகிறது. பருவகால சராசரி எளிமையானது:</p>
        <p><strong>ஒரு மணிக்கு யூனிட் ≈ குளிரூட்டல் வாட் ÷ ISEER ÷ 1000</strong></p>
        <div class="comparison-table-wrapper"><table class="comparison-table">
          <thead><tr><th>1.5 டன் AC வகை</th><th>வழக்கமான ISEER</th><th>ஒரு மணிக்கு யூனிட் (சராசரி)</th><th>8 மணி/நாள் × 30 நாட்கள்</th></tr></thead>
          <tbody>
            <tr><td>5-ஸ்டார் இன்வெர்ட்டர் (தற்போதைய லேபிள்)</td><td>~5.0+</td><td>≈ 1.0</td><td>≈ 245 யூனிட்கள்</td></tr>
            <tr><td>3-ஸ்டார் இன்வெர்ட்டர்</td><td>~3.9–4.0</td><td>≈ 1.3</td><td>≈ 310 யூனிட்கள்</td></tr>
            <tr><td>பழைய நிலையான-வேக / 2022-க்கு முந்தைய லேபிள்</td><td>~3.0–3.3</td><td>≈ 1.5–1.7</td><td>≈ 370–410 யூனிட்கள்</td></tr>
          </tbody>
        </table></div>
        <p>இவை பருவகால சராசரிகள்: ஒரு இன்வெர்ட்டர் AC முதல் சில நிமிடங்களில் அதிகமாகவும், அறை வெப்பநிலையைத் தக்கவைத்தவுடன்
        மிகக் குறைவாகவும் மின்சாரம் இழுக்கிறது, எனவே மிதமான அமைப்பில் நன்கு காப்பிடப்பட்ட அறை இந்த எண்களை விடக் குறைவாகப்
        பயன்படுத்தலாம், அதே சமயம் 18&nbsp;°C-இல் மேற்கு நோக்கிய அறை இதை மீறும்.</p>
      </section>

      <section class="seo-section">
        <h2>அடுக்குப் பொறி: AC யூனிட்கள் உங்கள் மிக உயர்ந்த விகிதத்தில் பட்டியலிடப்படுகின்றன</h2>
        <p>பெரும்பாலான செலவு மதிப்பீடுகள் தவறாகப் புரிந்துகொள்ளும் பகுதி இதுவே. பெரும்பாலான மாநிலங்களில் வீட்டுக்
        கட்டணங்கள் <strong>டெலிஸ்கோபிக் அடுக்குகள்</strong> — முதல் யூனிட்கள் மலிவானவை, பிந்தைய யூனிட்கள் படிப்படியாக
        அதிக விலை. உங்கள் குளிர்சாதனப் பெட்டி, விசிறிகள், விளக்குகள் ஏற்கனவே மலிவான அடுக்குகளை நிரப்புகின்றன; AC-இன்
        250–400 யூனிட்கள் <em>அதற்கு மேல்</em> அடுக்கி, நீங்கள் தொடும் மிக விலையுயர்ந்த அடுக்குகளில் விழுகின்றன.</p>
        <p>எனவே ஒரு AC-ஐ இயக்குவதன் நேர்மையான செலவு அதன் யூனிட்கள் × உங்கள் <strong>விளிம்பு</strong> விகிதம் — உங்கள்
        மொத்த நுகர்வு அடையும் கடைசி அடுக்கின் விகிதம் — கூட்டல் பெரும்பாலான மாநிலங்கள் மேலே விதிக்கும் எரிபொருள் கூடுதல்
        கட்டணம் (FPPA) மற்றும் மின் வரி. பல மாநிலங்களில், ஒரு AC-ஐச் சேர்ப்பது உங்கள் மொத்த நுகர்வை ஒரு அடுக்கு எல்லையைத்
        தாண்டியும் தள்ளுகிறது, உங்கள் தற்போதைய பயன்பாட்டின் ஒரு பகுதிக்கும் அமைதியாக மறு-விலை நிர்ணயம் செய்கிறது
        (மேலும் டெலிஸ்கோபிக் அல்லாத அல்லது மானிய-வரம்பு கட்டணங்களைக் கொண்ட மாநிலங்களில், வரம்பைக் கடப்பது
        <em>முழு</em> பில்லையும் மறு-விகிதப்படுத்தலாம்).</p>
      </section>

      <section class="seo-section">
        <h2>அது மாதத்திற்கு எவ்வளவு செலவாகும்</h2>
        <p>இன்று இந்தியாவில் விளிம்பு வீட்டு விகிதங்கள் லைஃப்லைன் அடுக்குகளைத் தாண்டியவுடன் பெரும்பாலும் ஒரு யூனிட்டுக்கு
        ₹5 முதல் ₹12 வரை இருக்கும். மேலே உள்ள அட்டவணையைப் பயன்படுத்தி:</p>
        <div class="comparison-table-wrapper"><table class="comparison-table">
          <thead><tr><th>மாதாந்திர AC யூனிட்கள்</th><th>@ ₹6/யூனிட் விளிம்பு</th><th>@ ₹8/யூனிட்</th><th>@ ₹10/யூனிட்</th></tr></thead>
          <tbody>
            <tr><td>245 (5-ஸ்டார், 8 மணி/நாள்)</td><td>₹1,470</td><td>₹1,960</td><td>₹2,450</td></tr>
            <tr><td>310 (3-ஸ்டார், 8 மணி/நாள்)</td><td>₹1,860</td><td>₹2,480</td><td>₹3,100</td></tr>
            <tr><td>400 (பழைய AC / அதிக மணிநேரம்)</td><td>₹2,400</td><td>₹3,200</td><td>₹4,000</td></tr>
          </tbody>
        </table></div>
        <p>உங்கள் மாநிலத்தைப் பொறுத்து FPPA மற்றும் மின் வரிக்கு மேலே தோராயமாக 5–20% சேர்க்கவும். உங்கள் உண்மையான அடுக்கு
        விகிதங்களுக்கு யூகிக்க வேண்டாம் — உங்கள் DISCOM-க்கான <a href="/#calculator">பில் கணிப்பானில்</a> உங்கள் கோடை
        மற்றும் குளிர்கால யூனிட்களை இயக்கிக் கழிக்கவும்: வித்தியாசமே AC உண்மையில் உங்களுக்குச் செலவாகும் தொகை.
        <a href="/electricity-cost-calculator/">சாதன செலவு கணிப்பான்</a> இதே கணக்கை ஒவ்வொரு சாதனத்திற்கும் செய்கிறது.</p>
      </section>

      <section class="seo-section">
        <h2>AC பில்லை உண்மையில் குறைக்கும் ஐந்து விஷயங்கள்</h2>
        <ul>
          <li><strong>18–20 °C அல்ல, 24–26 °C அமைக்கவும்.</strong> ஒவ்வொரு டிகிரி குளிர்ச்சியும் நுகர்வில் தோராயமாக 6%
          சேர்க்கிறது. ஒரு கூரை விசிறியுடன் 24&nbsp;°C 22&nbsp;°C போல உணரப்படுகிறது, 18&nbsp;°C பழக்கத்துடன் ஒப்பிடும்போது
          20–30% சேமிக்கிறது — மிகப்பெரிய இலவச சேமிப்பு.</li>
          <li><strong>கோடைக்கு முன் சர்வீஸ் செய்யுங்கள்.</strong> அடைபட்ட வடிகட்டிகளும் அழுக்கான கண்டென்சர் சுருள்களும்
          கம்ப்ரசரை நீண்ட நேரம் இயங்கச் செய்கின்றன; ₹500 சர்வீஸ் வழக்கமாக 10–15% சேமிக்கிறது.</li>
          <li><strong>அறையை சீல் செய்யுங்கள்.</strong> கதவு இடைவெளிகள், ஒற்றை-கண்ணாடி மேற்கு ஜன்னல்கள், காப்பிடப்படாத
          கூரைகள்தான் "AC இரவு முழுவதும் ஓடுகிறது" என்பதற்குக் காரணம். திரைச்சீலைகளும் டிராஃப்ட் ஸ்ட்ரிப்களும்
          யூனிட்களை விட மலிவானவை.</li>
          <li><strong>டைமர்/ஸ்லீப் பயன்முறையைப் பயன்படுத்தவும்.</strong> ஒரு அறை தன் குளிர்ச்சியைத் தக்கவைக்கிறது; 8
          தொடர் மணிநேரத்திற்குப் பதிலாக ஸ்லீப் வளைவுடன் 5 மணிநேரம் இயக்குவது மூன்றில் ஒரு பங்கு யூனிட்களைக் குறைக்கிறது.</li>
          <li><strong>மாற்றுவதற்கு முன் 5-ஸ்டார் கணக்கைச் செய்யுங்கள்.</strong> ஒரு பழைய நிலையான-வேக AC-ஐ (~1.6 யூனிட்/மணி)
          5-ஸ்டார் இன்வெர்ட்டராக (~1.0) மேம்படுத்துவது 8 மணி/நாள் கோடையில் மாதம் ~145 யூனிட்களைச் சேமிக்கிறது — வழக்கமான
          விளிம்பு விகிதங்களில் மாதம் ₹1,000+, எனவே அதிகம் பயன்படுத்துபவர்கள் இரண்டு அல்லது மூன்று பருவங்களில் விலை
          வித்தியாசத்தை மீட்கிறார்கள். குறைவாகப் பயன்படுத்துபவர்கள் (2–3 மணி/நாள்) அதை ஒருபோதும் மீட்காமல் இருக்கலாம்.</li>
        </ul>
      </section>

      <section class="seo-section">
        <h2>AC உங்கள் பில்லுக்கு என்ன செய்யும் என்பதைச் சரிபார்க்கவும்</h2>
        <p>கடந்த மாதத்தின் யூனிட்களை எடுத்து, மேலே உள்ள அட்டவணையிலிருந்து உங்கள் ஸ்டார் மதிப்பீடு மற்றும் மணிநேரத்திற்கான
        AC மதிப்பீட்டைச் சேர்த்து, இரு எண்களையும் உங்கள் மாநிலத்திற்கான <a href="/#calculator">பில் கணிப்பானில்</a>
        இயக்கவும். வித்தியாசம் — உங்கள் DISCOM-இன் உண்மையான அடுக்குகள், நிலையான கட்டணங்கள், FPPA மற்றும் வரியில்
        கணக்கிடப்பட்டது — வழியில் நீங்கள் கடக்கும் எந்த அடுக்கு எல்லையையும் உள்ளடக்கி, AC-இன் உண்மையான மாதாந்திர செலவாகும்.</p>
      </section>`,
    faqsTa: [
      { q: '1.5 டன் AC ஒரு மணி நேரத்தில் எத்தனை யூனிட் நுகர்கிறது?', a: 'தற்போதைய 5-ஸ்டார் இன்வெர்ட்டர் மாடலுக்கு ஒரு மணிக்கு தோராயமாக 1 யூனிட், 3-ஸ்டார் இன்வெர்ட்டருக்கு சுமார் 1.3 யூனிட், பழைய நிலையான-வேக AC-க்கு 1.5–1.7 யூனிட் — குளிரூட்டல் வாட் (1.5 டன்னுக்கு ≈5,100) BEE லேபிளில் உள்ள ISEER-ஆல் வகுக்கப்பட்டதாகக் கணக்கிடப்பட்ட பருவகால சராசரிகள்.' },
      { q: 'ஒரு நாளைக்கு 8 மணி நேரம் இயங்கும் 1.5 டன் AC-க்கான மாதாந்திர மின் பில் எவ்வளவு?', a: 'ஸ்டார் மதிப்பீடு மற்றும் வயதைப் பொறுத்து மாதம் சுமார் 245–410 யூனிட்கள். ஒரு யூனிட்டுக்கு ₹6–10 விளிம்பு வீட்டு விகிதங்களில் அது தோராயமாக மாதம் ₹1,500–₹4,000, கூடுதலாக எரிபொருள் கூடுதல் கட்டணம் மற்றும் மின் வரி. சரியான எண் உங்கள் மாநில அடுக்குகளைப் பொறுத்தது — AC யூனிட்கள் உங்கள் மிக உயர்ந்த பொருந்தும் அடுக்கு விகிதத்தில் பட்டியலிடப்படுகின்றன.' },
      { q: 'இன்வெர்ட்டர் AC உண்மையில் மின் பில்லைக் குறைக்கிறதா?', a: 'ஆம், தினமும் பல மணிநேரம் AC இயக்குபவர்களுக்கு. ஒரு இன்வெர்ட்டர் கம்ப்ரசர் நிறுத்தி-துவங்குவதற்குப் பதிலாக மட்டப்படுத்துகிறது, எனவே 5-ஸ்டார் இன்வெர்ட்டர் ஒரு மணிக்கு ~1 யூனிட் சராசரி, பழைய நிலையான-வேகத்திற்கு ~1.6 — அதே குளிர்ச்சிக்கு சுமார் 35–40% குறைவான யூனிட்கள்.' },
      { q: 'எந்த AC வெப்பநிலை அமைப்பு அதிக மின்சாரத்தைச் சேமிக்கிறது?', a: '24–26 °C. அதற்குக் கீழே ஒவ்வொரு டிகிரிக்கும் நுகர்வு தோராயமாக 6% உயர்கிறது, எனவே 18 °C 24 °C-ஐ விட சுமார் மூன்றில் ஒரு பங்கு அதிகம் செலவாகும். 24–25 °C-ஐ ஒரு கூரை விசிறியுடன் இணைப்பது மிகக் குளிர்ந்த அமைப்பைப் போன்ற அதே சௌகரியத்தைத் தருகிறது.' },
      { q: 'AC வாங்கிய பிறகு என் பில் ஏன் இரட்டிப்பானது?', a: 'இரண்டு விளைவுகள் அடுக்கப்படுகின்றன: AC 250–400 யூனிட்களைச் சேர்க்கிறது, அந்த யூனிட்கள் உங்கள் மிக உயர்ந்த கட்டண அடுக்குகளில் விழுகின்றன — சில மாநிலங்களில் அவை உங்களை ஒரு மானிய அல்லது அடுக்கு வரம்பைத் தாண்டியும் தள்ளி, தற்போதைய பயன்பாட்டை மறு-விலை நிர்ணயம் செய்கின்றன. இரு விளைவுகளையும் பிரிக்க ஒரு பில் கணிப்பானில் உங்கள் AC-க்கு முந்தைய மற்றும் AC-க்குப் பிந்தைய யூனிட்களை ஒப்பிடுங்கள்.' },
    ],
    titleMr: '1.5 टन AC तुमच्या वीज बिलात किती भर घालतो?',
    metaTitleMr: '1.5 टन AC चे मासिक वीज बिल — युनिट, खर्च आणि स्लॅबचा सापळा',
    descriptionMr: '1.5 टन AC ताशी व दरमहा किती युनिट वापरतो (स्टार रेटिंगनुसार), AC ची युनिट तुमच्या सर्वोच्च स्लॅब दराने का आकारली जातात, एक वास्तववादी मासिक खर्च तक्ता, आणि घाम न गाळता बिल कमी करण्याचे पाच मार्ग.',
    introMr: `दिवसाला 8 तास चालणारा 1.5 टन AC तुमच्या मीटरमध्ये दरमहा साधारण <strong>250–370 युनिट</strong> ची
      भर घालतो — त्याच्या स्टार रेटिंग व वयानुसार — आणि स्लॅब टॅरिफ टेलिस्कोपिक असल्याने, त्या प्रत्येक युनिटला
      सरासरी दराने नव्हे तर तुमच्या <em>सर्वोच्च</em> लागू दराने बिल केले जाते. हे मार्गदर्शक प्रत्यक्ष गणित दाखवते:
      स्टार रेटिंगनुसार ताशी युनिट, ते नेहमीच्या सीमांत दरांवर किती खर्च होते, आणि प्रत्यक्षात काय कमी करते.`,
    sectionsMr: `
      <section class="seo-section">
        <h2>1.5 टन AC ताशी किती युनिट वापरतो?</h2>
        <p>"1.5 टन" हे थंडावा उत्पादन (सुमारे 5,100 वॅट उष्णता काढून टाकणे) दर्शवते, खेचलेली वीज नव्हे. मीटर काय
        नोंदवते हे AC च्या कार्यक्षमतेवर अवलंबून असते — त्याचा <strong>ISEER</strong> (इंडियन सीझनल एनर्जी
        एफिशियन्सी रेशो), जो BEE स्टार लेबल श्रेणीबद्ध करतो. हंगामी सरासरी सोपी आहे:</p>
        <p><strong>ताशी युनिट ≈ थंडावा वॅट ÷ ISEER ÷ 1000</strong></p>
        <div class="comparison-table-wrapper"><table class="comparison-table">
          <thead><tr><th>1.5 टन AC प्रकार</th><th>नेहमीचा ISEER</th><th>ताशी युनिट (सरासरी)</th><th>8 तास/दिवस × 30 दिवस</th></tr></thead>
          <tbody>
            <tr><td>5-स्टार इन्व्हर्टर (सध्याचे लेबल)</td><td>~5.0+</td><td>≈ 1.0</td><td>≈ 245 युनिट</td></tr>
            <tr><td>3-स्टार इन्व्हर्टर</td><td>~3.9–4.0</td><td>≈ 1.3</td><td>≈ 310 युनिट</td></tr>
            <tr><td>जुना फिक्स्ड-स्पीड / 2022-पूर्व लेबल</td><td>~3.0–3.3</td><td>≈ 1.5–1.7</td><td>≈ 370–410 युनिट</td></tr>
          </tbody>
        </table></div>
        <p>या हंगामी सरासरी आहेत: इन्व्हर्टर AC सुरुवातीच्या थंड करण्याच्या मिनिटांत जास्त वीज खेचतो आणि खोली
        तापमान राखल्यावर खूप कमी, त्यामुळे मध्यम सेटिंगवर चांगली इन्सुलेशन असलेली खोली या आकड्यांपेक्षा कमी वापरू
        शकते, तर 18&nbsp;°C वर पश्चिमाभिमुख खोली त्यापेक्षा जास्त वापरेल.</p>
      </section>

      <section class="seo-section">
        <h2>स्लॅबचा सापळा: AC ची युनिट तुमच्या सर्वोच्च दराने आकारली जातात</h2>
        <p>बहुतांश खर्च अंदाज हाच भाग चुकवतात. बहुतेक राज्यांतील घरगुती टॅरिफ <strong>टेलिस्कोपिक स्लॅब</strong>
        असतात — पहिली युनिट स्वस्त, नंतरची युनिट क्रमशः महाग. तुमचा फ्रिज, पंखे व दिवे आधीच स्वस्त स्लॅब भरतात;
        AC ची 250–400 युनिट त्यावर <em>रचली</em> जातात, तुम्ही स्पर्श करता त्या सर्वात महाग स्लॅबमध्ये पडतात.</p>
        <p>म्हणून AC चालवण्याचा खरा खर्च म्हणजे त्याची युनिट × तुमचा <strong>सीमांत</strong> दर — तुमच्या एकूण
        वापराने गाठलेल्या शेवटच्या स्लॅबचा दर — अधिक बहुतेक राज्ये वर लावतात ते इंधन अधिभार (FPPA) व वीज शुल्क.
        अनेक राज्यांत, AC जोडल्याने तुमचा एकूण वापर एका स्लॅब सीमेपलीकडे ढकलला जातो, तुमच्या विद्यमान वापराचा काही
        भागही मुकाट्याने पुन्हा किंमत लावतो (आणि नॉन-टेलिस्कोपिक किंवा सबसिडी-मर्यादा टॅरिफ असलेल्या राज्यांत,
        मर्यादा ओलांडल्याने <em>संपूर्ण</em> बिलाचा दर पुन्हा लागू होऊ शकतो).</p>
      </section>

      <section class="seo-section">
        <h2>त्याचा दरमहा किती खर्च होतो</h2>
        <p>आज भारतातील सीमांत घरगुती दर लाइफलाइन स्लॅबनंतर बहुतांशी प्रति युनिट ₹5 ते ₹12 दरम्यान येतात. वरील
        तक्ता वापरून:</p>
        <div class="comparison-table-wrapper"><table class="comparison-table">
          <thead><tr><th>मासिक AC युनिट</th><th>@ ₹6/युनिट सीमांत</th><th>@ ₹8/युनिट</th><th>@ ₹10/युनिट</th></tr></thead>
          <tbody>
            <tr><td>245 (5-स्टार, 8 तास/दिवस)</td><td>₹1,470</td><td>₹1,960</td><td>₹2,450</td></tr>
            <tr><td>310 (3-स्टार, 8 तास/दिवस)</td><td>₹1,860</td><td>₹2,480</td><td>₹3,100</td></tr>
            <tr><td>400 (जुना AC / जास्त तास)</td><td>₹2,400</td><td>₹3,200</td><td>₹4,000</td></tr>
          </tbody>
        </table></div>
        <p>तुमच्या राज्यानुसार FPPA व वीज शुल्कासाठी वर साधारण 5–20% जोडा. तुमच्या प्रत्यक्ष स्लॅब दरांसाठी अंदाज
        लावू नका — तुमच्या DISCOM साठी <a href="/#calculator">बिल कॅल्क्युलेटर</a> मध्ये तुमची उन्हाळी व हिवाळी
        युनिट चालवा आणि वजा करा: फरक म्हणजे AC चा खरा खर्च. <a href="/electricity-cost-calculator/">उपकरण खर्च
        कॅल्क्युलेटर</a> हेच गणित प्रति-उपकरण करते.</p>
      </section>

      <section class="seo-section">
        <h2>AC चे बिल प्रत्यक्षात कमी करणाऱ्या पाच गोष्टी</h2>
        <ul>
          <li><strong>18–20 °C नव्हे, 24–26 °C ठेवा.</strong> प्रत्येक अंश थंड केल्याने वापरात साधारण 6% भर पडते.
          छतावरील पंख्यासह 24&nbsp;°C 22&nbsp;°C सारखे वाटते आणि 18&nbsp;°C च्या सवयीच्या तुलनेत 20–30% वाचवते —
          सर्वात मोठी मोफत बचत.</li>
          <li><strong>उन्हाळ्यापूर्वी सर्व्हिस करा.</strong> गच्च फिल्टर व घाणेरडे कंडेन्सर कॉइल कॉम्प्रेसरला जास्त
          वेळ चालवायला भाग पाडतात; ₹500 ची सर्व्हिस नियमितपणे 10–15% वाचवते.</li>
          <li><strong>खोली सील करा.</strong> दरवाजाच्या फटी, सिंगल-पेन पश्चिमेकडील खिडक्या व इन्सुलेशन नसलेली छते
          यामुळेच "AC रात्रभर चालतो." पडदे व ड्राफ्ट स्ट्रिप युनिटपेक्षा स्वस्त असतात.</li>
          <li><strong>टायमर/स्लीप मोड वापरा.</strong> खोली आपला थंडावा टिकवते; 8 सलग तासांऐवजी स्लीप कर्व्हसह 5 तास
          चालवल्याने एक-तृतीयांश युनिट कमी होतात.</li>
          <li><strong>बदलण्यापूर्वी 5-स्टारचे गणित करा.</strong> जुना फिक्स्ड-स्पीड AC (~1.6 युनिट/तास) 5-स्टार
          इन्व्हर्टरमध्ये (~1.0) अपग्रेड केल्याने 8 तास/दिवस उन्हाळ्यात दरमहा ~145 युनिट वाचतात — नेहमीच्या सीमांत
          दरांवर दरमहा ₹1,000+, त्यामुळे जास्त वापरणारे दोन-तीन हंगामांत किमतीचा फरक भरून काढतात. कमी वापरणारे
          (2–3 तास/दिवस) कदाचित तो कधीच भरून काढणार नाहीत.</li>
        </ul>
      </section>

      <section class="seo-section">
        <h2>AC तुमच्या बिलावर काय परिणाम करेल ते तपासा</h2>
        <p>मागच्या महिन्याची युनिट घ्या, वरील तक्त्यातून तुमच्या स्टार रेटिंग व तासांसाठी AC चा अंदाज जोडा, आणि
        दोन्ही आकडे तुमच्या राज्यासाठी <a href="/#calculator">बिल कॅल्क्युलेटर</a> मध्ये चालवा. फरक — तुमच्या
        DISCOM च्या खऱ्या स्लॅब, फिक्स्ड चार्ज, FPPA व शुल्कावर मोजलेला — म्हणजे AC चा खरा मासिक खर्च, वाटेत तुम्ही
        ओलांडता ती कोणतीही स्लॅब सीमा धरून.</p>
      </section>`,
    faqsMr: [
      { q: '1.5 टन AC एका तासात किती युनिट वापरतो?', a: 'सध्याच्या 5-स्टार इन्व्हर्टर मॉडेलसाठी साधारण 1 युनिट प्रति तास, 3-स्टार इन्व्हर्टरसाठी सुमारे 1.3 युनिट, आणि जुन्या फिक्स्ड-स्पीड AC साठी 1.5–1.7 युनिट — थंडावा वॅट (1.5 टनसाठी ≈5,100) भागिले BEE लेबलवरील ISEER अशी मोजलेली हंगामी सरासरी.' },
      { q: 'दिवसाला 8 तास चालणाऱ्या 1.5 टन AC चे मासिक वीज बिल किती?', a: 'स्टार रेटिंग व वयानुसार दरमहा सुमारे 245–410 युनिट. प्रति युनिट ₹6–10 च्या सीमांत घरगुती दरांवर ते साधारण ₹1,500–₹4,000 दरमहा, अधिक इंधन अधिभार व वीज शुल्क. नेमका आकडा तुमच्या राज्याच्या स्लॅबवर अवलंबून असतो — AC ची युनिट तुमच्या सर्वोच्च लागू स्लॅब दराने आकारली जातात.' },
      { q: 'इन्व्हर्टर AC खरोखर वीज बिल कमी करतो का?', a: 'होय, दररोज अनेक तास AC चालवणाऱ्या प्रत्येकासाठी. इन्व्हर्टर कॉम्प्रेसर थांबा-सुरू होण्याऐवजी मॉड्युलेट करतो, त्यामुळे 5-स्टार इन्व्हर्टर ~1 युनिट/तास सरासरी काढतो, तर जुना फिक्स्ड-स्पीड ~1.6 — त्याच थंडाव्यासाठी सुमारे 35–40% कमी युनिट.' },
      { q: 'कोणते AC तापमान सेटिंग सर्वात जास्त वीज वाचवते?', a: '24–26 °C. त्याखालील प्रत्येक अंशाला वापर साधारण 6% वाढतो, त्यामुळे 18 °C ला 24 °C पेक्षा सुमारे एक-तृतीयांश जास्त खर्च होतो. 24–25 °C छतावरील पंख्यासह जोडल्याने खूप थंड सेटिंगइतकाच आराम मिळतो.' },
      { q: 'AC घेतल्यावर माझे बिल दुप्पट का झाले?', a: 'दोन परिणाम रचले जातात: AC 250–400 युनिट जोडतो, आणि ती युनिट तुमच्या सर्वोच्च टॅरिफ स्लॅबमध्ये पडतात — काही राज्यांत ती तुम्हाला एका सबसिडी किंवा स्लॅब मर्यादेपलीकडेही ढकलतात जी विद्यमान वापराची पुन्हा किंमत लावते. दोन परिणाम वेगळे करण्यासाठी बिल कॅल्क्युलेटरमध्ये तुमची AC-पूर्व व AC-नंतरची युनिट तुलना करा.' },
    ],
  ...
  },
  {
    ...
    states: ['Uttar Pradesh', 'Maharashtra', 'Kerala', 'Uttarakhand', 'Jammu & Kashmir'],
    ...
    intro: `<strong>WSS</strong> stands for <strong>Web Self Service</strong>, and several Indian DISCOMs
      use that name for their consumer portal — <strong>UPPCL</strong> in Uttar Pradesh,
      <strong>MSEDCL (Mahavitaran)</strong> in Maharashtra, <strong>KSEB</strong> in Kerala,
      <strong>UPCL</strong> in Uttarakhand and <strong>JPDCL</strong> in the Jammu division of
      Jammu &amp; Kashmir. They are separate sites with separate logins, which is why searching for
      "WSS portal" on its own tends to land you on the wrong one — and why
      <strong>UPCL and UPPCL are especially easy to mix up</strong>: one letter apart, neighbouring
    ...
    sections: `
      <section class="seo-section" data-toc="Which is mine?">
        ...
        <div class="comparison-table-wrapper"><table class="comparison-table">
          ...
          <tbody>
            <tr>
              <td><strong>UPPCL</strong></td>
              <td>Uttar Pradesh — DVVNL, MVVNL, PUVVNL, PVVNL and KESCo</td>
              <td><a href="https://consumer.uppcl.org/wss/home" target="_blank" rel="noopener nofollow">consumer.uppcl.org/wss</a></td>
              <td>No, to pay a bill; yes for service requests</td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td>No to pay or complain; yes for the rest</td>
            </tr>
            <tr>
              ...
              <td>No to pay or check status; yes to file</td>
            </tr>
            <tr>
              ...
              <td>Yes — everything is behind the login</td>
            </tr>
          </tbody>
        </table></div>
      </section>
      ...
      <section class="seo-section" data-toc="UPPCL">
        ...
        covers all five UP distribution companies — <strong>DVVNL, MVVNL, PUVVNL, PVVNL and KESCo</strong> —
        so there is no separate site per DISCOM. Paying a bill needs no account; everything in the table
        below does.</p>
        <div class="comparison-table-wrapper"><table class="comparison-table">
          <thead><tr><th>Service</th><th>What it does</th><th>Direct link</th></tr></thead>
          <tbody>
            <tr><td><strong>Load Enhancement</strong></td><td>Raise your sanctioned load. This is the <em>only</em> load option online — see the caution below.</td><td><a href="https://consumer.uppcl.org/wss/consumer-services/service-request/online-load-extension" target="_blank" rel="noopener nofollow">Open</a></td></tr>
            <tr><td><strong>Bill Correction Request</strong></td><td>Challenge a wrong amount, wrong reading or wrong period on a bill.</td><td><a href="https://consumer.uppcl.org/wss/consumer-services/service-request/bill-correction-request" target="_blank" rel="noopener nofollow">Open</a></td></tr>
            <tr><td><strong>Meter Related Complaints</strong></td><td>Report a meter you believe is faulty, stuck, running fast or misread.</td><td><a href="https://consumer.uppcl.org/wss/consumer-services/service-request/meter-related-complaints" target="_blank" rel="noopener nofollow">Open</a></td></tr>
            <tr><td><strong>Category Change Request</strong></td><td>Move the connection between tariff categories — domestic, commercial and so on.</td><td><a href="https://consumer.uppcl.org/wss/consumer-services/service-request/category-change-request" target="_blank" rel="noopener nofollow">Open</a></td></tr>
            <tr><td><strong>Name Correction</strong></td><td>Fix a misspelt or outdated consumer name on the account.</td><td><a href="https://consumer.uppcl.org/wss/consumer-services/service-request/name-correction" target="_blank" rel="noopener nofollow">Open</a></td></tr>
            <tr><td><strong>Address Correction</strong></td><td>Fix the service address held against the connection.</td><td><a href="https://consumer.uppcl.org/wss/consumer-services/service-request/address-correction" target="_blank" rel="noopener nofollow">Open</a></td></tr>
            <tr><td><strong>Connection Transfer</strong></td><td>Transfer the connection to a new owner or occupier.</td><td><a href="https://consumer.uppcl.org/wss/consumer-services/service-request/connection-transfer" target="_blank" rel="noopener nofollow">Open</a></td></tr>
            <tr><td><strong>Connection Disconnection</strong></td><td>Apply to have the connection permanently disconnected.</td><td><a href="https://consumer.uppcl.org/wss/consumer-services/service-request/connection-disconnection" target="_blank" rel="noopener nofollow">Open</a></td></tr>
            <tr><td><strong>Solar Roof</strong></td><td>Apply for a rooftop solar connection and net metering.</td><td><a href="https://consumer.uppcl.org/wss/consumer-services/service-request/solar-roof" target="_blank" rel="noopener nofollow">Open</a></td></tr>
            <tr><td><strong>Self Bill Generation</strong></td><td>Generate your own bill from a self-submitted meter reading.</td><td><a href="https://consumer.uppcl.org/wss/consumer-services/self-bill-generation" target="_blank" rel="noopener nofollow">Open</a></td></tr>
            <tr><td><strong>Service Request Status</strong></td><td>Track anything you have already filed above.</td><td><a href="https://consumer.uppcl.org/wss/consumer-services/service-request-status" target="_blank" rel="noopener nofollow">Open</a></td></tr>
          </tbody>
        </table></div>
        <p class="seo-note">Every link in that table needs you to be signed in. Opened while logged out they
        bounce to the <a href="https://consumer.uppcl.org/wss/auth/login" target="_blank" rel="noopener nofollow">UPPCL
        login</a>, which asks for your district and sends an OTP — so sign in first and the links land where they
        should. If you have no account yet, start at
        <a href="https://consumer.uppcl.org/wss/auth/registration" target="_blank" rel="noopener nofollow">New Registration</a>.</p>
        <p><strong>The one thing this portal will not do is reduce your load.</strong> Enhancement is a form you
        can file in a couple of minutes; reduction is not offered online at all and still means a written
        application at your sub-division office. If UPPCL raised your load automatically after a smart meter
        recorded your demand, read
        <a href="/guides/uppcl-sanctioned-load-increased/">why sanctioned load suddenly increases</a> — the
        portal still helps there, just with the evidence rather than the fix: pull your billing history to see
        the demand pattern, then file a Bill Correction Request or a Meter Related Complaint if the revision
      ...
      <section class="seo-section" data-toc="MSEDCL">
        ...
        <p>One quirk to know before you go looking: MSEDCL splits its services across <strong>two</strong>
        hosts. Bills, payments, readings and complaints live on <code>wss.mahadiscom.in</code>; the
        application-type services — load change, name change, refunds — live on <code>css.mahadiscom.in</code>,
        the Consumer Self Service site. Both are official, and the WSS home page links across to the second, so
        a service missing from one is usually on the other.</p>
        <div class="comparison-table-wrapper"><table class="comparison-table">
          <thead><tr><th>Service</th><th>What it does</th><th>Direct link</th></tr></thead>
          <tbody>
            <tr><td><strong>View / Pay Bill</strong></td><td>Pay with just the 12-digit consumer number. No login.</td><td><a href="https://wss.mahadiscom.in/wss/wss?uiActionName=getViewPayBill" target="_blank" rel="noopener nofollow">Open</a></td></tr>
            <tr><td><strong>Change of Load / Contract Demand</strong></td><td>Apply to change your sanctioned load — <strong>up or down</strong>.</td><td><a href="https://css.mahadiscom.in/UI/LOADCHANGE/LoadChange.aspx" target="_blank" rel="noopener nofollow">Open</a></td></tr>
            <tr><td><strong>Prepaid Meter Recharge</strong></td><td>Top up a prepaid smart meter.</td><td><a href="https://wss.mahadiscom.in/wss/wss?uiActionName=getSmartMeterRechargeLinkLeft" target="_blank" rel="noopener nofollow">Open</a></td></tr>
            <tr><td><strong>Submit Self Reading</strong></td><td>Send your own meter reading when the meter reader has not been.</td><td><a href="https://wss.mahadiscom.in/wss/wss?uiActionName=getSubmitReadingConsumerDetailsLink" target="_blank" rel="noopener nofollow">Open</a></td></tr>
            <tr><td><strong>Complaint Registration</strong></td><td>Raise a supply, billing or meter complaint.</td><td><a href="https://wss.mahadiscom.in/wss/wss?uiActionName=getServiceRequestConsumerDetailsLink" target="_blank" rel="noopener nofollow">Open</a></td></tr>
            <tr><td><strong>Complaint Status</strong></td><td>Track a complaint you have already filed.</td><td><a href="https://wss.mahadiscom.in/wss/wss?uiActionName=getServiceRequestStatusLinkLeft" target="_blank" rel="noopener nofollow">Open</a></td></tr>
            <tr><td><strong>New Connection Request</strong></td><td>Apply for a new supply.</td><td><a href="https://wss.mahadiscom.in/wss/wss?uiActionName=getNewConnectionRequest" target="_blank" rel="noopener nofollow">Open</a></td></tr>
            <tr><td><strong>Change of Name</strong></td><td>Transfer the connection into a new name.</td><td><a href="https://css.mahadiscom.in/UI/CHANGENAME/ChangeNameUploadDoc.aspx" target="_blank" rel="noopener nofollow">Open</a></td></tr>
            <tr><td><strong>Address Correction</strong></td><td>Fix the service address on the account.</td><td><a href="https://css.mahadiscom.in/UI/AC/AddressCorrection.aspx" target="_blank" rel="noopener nofollow">Open</a></td></tr>
            <tr><td><strong>Solar Roof Top</strong></td><td>Apply for rooftop solar and net metering.</td><td><a href="https://css.mahadiscom.in/UI/ROOFTOP/Solar_RTS.aspx" target="_blank" rel="noopener nofollow">Open</a></td></tr>
            <tr><td><strong>Change of Tariff</strong></td><td>Declare a change of activity to move tariff category.</td><td><a href="https://css.mahadiscom.in/UI/TariffChange/TariffChange.aspx" target="_blank" rel="noopener nofollow">Open</a></td></tr>
            <tr><td><strong>Security Deposit Refund</strong></td><td>Claim back a deposit after disconnection.</td><td><a href="https://css.mahadiscom.in/UI/SDREFUND/SdRefund.aspx" target="_blank" rel="noopener nofollow">Open</a></td></tr>
            <tr><td><strong>Re-Connection</strong></td><td>Pay dues and apply to have supply restored.</td><td><a href="https://css.mahadiscom.in/UI/PAYDUES/PayDues.aspx" target="_blank" rel="noopener nofollow">Open</a></td></tr>
            <tr><td><strong>Installment Plan</strong></td><td>Apply to pay a large arrear in instalments.</td><td><a href="https://css.mahadiscom.in/UI/InstallmentPolicy/Installment_Policy.aspx" target="_blank" rel="noopener nofollow">Open</a></td></tr>
          </tbody>
        </table></div>
        <p><strong>Worth noting against UPPCL:</strong> Maharashtra lets you apply to change your load in
        either direction online. Uttar Pradesh only offers enhancement. Same acronym, different powers.</p>
      ...
      <section class="seo-section" data-toc="KSEB">
        ...
        might expect — <strong>Quick Pay and complaint registration both work without an account</strong>, and
        registering mainly buys you billing history and alerts. A new LT connection costs a flat ₹50 to apply
        for, and small loads that need nothing more than a service drop can be energised in as little as two
        working days under KSEB's package connection.</p>
        <div class="comparison-table-wrapper"><table class="comparison-table">
          <thead><tr><th>Service</th><th>What it does</th><th>Direct link</th></tr></thead>
          <tbody>
            <tr><td><strong>Quick Pay</strong></td><td>Pay an energy bill without signing in.</td><td><a href="https://wss.kseb.in/selfservices/quickpay" target="_blank" rel="noopener nofollow">Open</a></td></tr>
            <tr><td><strong>Online Services</strong></td><td>Apply for load change, tariff change and ownership change.</td><td><a href="https://wss.kseb.in/selfservices/otherServices" target="_blank" rel="noopener nofollow">Open</a></td></tr>
            <tr><td><strong>Register Complaint / Service</strong></td><td>Raise a complaint or service request, 24×7, no account needed.</td><td><a href="https://wss.kseb.in/selfservices/showAnonymousComplaint.do" target="_blank" rel="noopener nofollow">Open</a></td></tr>
            <tr><td><strong>Complaint Status</strong></td><td>Track a complaint you have already raised.</td><td><a href="https://wss.kseb.in/selfservices/displayAnonymousComplaintStatus.do" target="_blank" rel="noopener nofollow">Open</a></td></tr>
            <tr><td><strong>New Connection</strong></td><td>Apply for a new LT connection.</td><td><a href="https://wss.kseb.in/selfservices/ncHome" target="_blank" rel="noopener nofollow">Open</a></td></tr>
            <tr><td><strong>Register Mobile / Email</strong></td><td>Get bill and interruption alerts, and bill PDFs.</td><td><a href="https://wss.kseb.in/selfservices/registermobile" target="_blank" rel="noopener nofollow">Open</a></td></tr>
            <tr><td><strong>New User Registration</strong></td><td>Create the account the remaining services need.</td><td><a href="https://wss.kseb.in/selfservices/wss-registerForm" target="_blank" rel="noopener nofollow">Open</a></td></tr>
            <tr><td><strong>User Guide</strong></td><td>KSEB's own instructions for the portal.</td><td><a href="https://wss.kseb.in/selfservices/userGuide" target="_blank" rel="noopener nofollow">Open</a></td></tr>
          </tbody>
        </table></div>
      ...
      <section class="seo-section" data-toc="UPCL">
        ...
        <p>A good deal of it is open without an account — paying a bill, both calculators, and every status
        check below need no login at all.</p>
        <div class="comparison-table-wrapper"><table class="comparison-table">
          <thead><tr><th>Service</th><th>What it does</th><th>Direct link</th></tr></thead>
          <tbody>
            <tr><td><strong>Bill Payment / Recharge</strong></td><td>View and pay a bill, or recharge a prepaid meter.</td><td><a href="https://www.upcl.org/wss/viewBill" target="_blank" rel="noopener nofollow">Open</a></td></tr>
            <tr><td><strong>Load Calculator</strong></td><td>Work out the load your appliances actually need before applying.</td><td><a href="https://www.upcl.org/wss/load-calculator" target="_blank" rel="noopener nofollow">Open</a></td></tr>
            <tr><td><strong>Fixed Cost Estimation Calculator</strong></td><td>Estimate the cost of a new connection up front.</td><td><a href="https://www.upcl.org/wss/fixed-cost-estimator-calculator" target="_blank" rel="noopener nofollow">Open</a></td></tr>
            <tr><td><strong>Before You Apply</strong></td><td>Document checklist and charges for a new connection.</td><td><a href="https://www.upcl.org/wss/before-you-apply-nsc" target="_blank" rel="noopener nofollow">Open</a></td></tr>
            <tr><td><strong>New Connection Status</strong></td><td>Track an application already submitted.</td><td><a href="https://www.upcl.org/wss/new-conn-status" target="_blank" rel="noopener nofollow">Open</a></td></tr>
            <tr><td><strong>Complaint Status</strong></td><td>Track a complaint.</td><td><a href="https://www.upcl.org/wss/view-status" target="_blank" rel="noopener nofollow">Open</a></td></tr>
            <tr><td><strong>Service Request Status</strong></td><td>Track a service request.</td><td><a href="https://www.upcl.org/wss/view-sr-status" target="_blank" rel="noopener nofollow">Open</a></td></tr>
            <tr><td><strong>Other Miscellaneous Payment</strong></td><td>Pay charges that are not on the energy bill.</td><td><a href="https://www.upcl.org/wss/miscellaneousPayment" target="_blank" rel="noopener nofollow">Open</a></td></tr>
            <tr><td><strong>Bill Payment Receipt</strong></td><td>Re-download a receipt for a payment already made.</td><td><a href="https://www.upcl.org/wss/billPaymentReceipt" target="_blank" rel="noopener nofollow">Open</a></td></tr>
            <tr><td><strong>Register for Bill Alerts</strong></td><td>Get told when a new bill is issued.</td><td><a href="https://www.upcl.org/wss/register-for-bill-alert" target="_blank" rel="noopener nofollow">Open</a></td></tr>
            <tr><td><strong>Feeder Outage Report</strong></td><td>Check whether the outage is your feeder rather than your house.</td><td><a href="https://www.upcl.org/wss/feeder-outage-report" target="_blank" rel="noopener nofollow">Open</a></td></tr>
            <tr><td><strong>Form Downloads</strong></td><td>The paper forms, for anything that still needs one.</td><td><a href="https://www.upcl.org/wss/form-downloads" target="_blank" rel="noopener nofollow">Open</a></td></tr>
            <tr><td><strong>Office Contact Details</strong></td><td>Find your distribution office.</td><td><a href="https://www.upcl.org/wss/contactDetails" target="_blank" rel="noopener nofollow">Open</a></td></tr>
            <tr><td><strong>Consumer Login</strong></td><td>Sign in for complaint and service-request registration.</td><td><a href="https://www.upcl.org/wss/login" target="_blank" rel="noopener nofollow">Open</a></td></tr>
          </tbody>
        </table></div>
      ...
      <section class="seo-section" data-toc="JPDCL">
        ...
        <p>There is no table of direct links for JPDCL here, and that is the portal's doing rather than an
        omission: unlike the other four it publishes <strong>no public service pages at all</strong>. Everything
        sits behind the sign-in, so the only honest links are
        <a href="https://wss.jpdcl.co.in/login" target="_blank" rel="noopener nofollow">Login</a>,
        the sign-up beside it, and its
        <a href="https://wss.jpdcl.co.in/faq" target="_blank" rel="noopener nofollow">FAQ</a> and
        <a href="https://wss.jpdcl.co.in/contact-us" target="_blank" rel="noopener nofollow">contact page</a>.
        By its own description the portal covers viewing and downloading bills, payment and consumption
        history, updating consumer details, and managing service requests — but you will not see any of it
        until you have registered.</p>
  ...
  },
  {
    ...
    descriptionHi: 'UPPCL ने जून 2026 के बिलिंग चक्र में 10% ईंधन अधिभार लगाया। यह किस रकम पर लगता है, 150, 300 और 500 यूनिट पर कितने रुपये जोड़ता है, सीमा (कैप) का मतलब क्या है, और अपने बिल पर यह लाइन कैसे जाँचें।',
    introHi: `मई 2026 में UPPCL ने <strong>10% ईंधन एवं विद्युत क्रय समायोजन अधिभार (FPPAS)</strong>
      अधिसूचित किया, जो <strong>जून 2026</strong> के बिलिंग चक्र में वसूला गया। हर सुर्ख़ी ने प्रतिशत
      बताया। लेकिन लोगों का असल सवाल — कि इससे सचमुच के बिल पर कितने रुपये बढ़ते हैं — उसका जवाब लगभग
      किसी ने नहीं दिया, क्योंकि यह इस बात पर निर्भर करता है कि अधिभार किस रकम पर लगता है, और वह रकम
      आपके बिल का कुल योग नहीं है। रुपये-पैसे का हिसाब यहाँ है।`,
    sectionsHi: `
      <section class="seo-section">
        <h2>अधिसूचित असल में क्या हुआ</h2>
        <p>UPPCL ने <strong>मार्च 2026 महीने के लिए 10%</strong> FPPAS मंज़ूर किया, जिसकी वसूली
        <strong>जून 2026 के बिलिंग चक्र</strong> में हुई। यह राज्य की हर वितरण कंपनी पर और हर उपभोक्ता
        श्रेणी पर लागू होता है — घरेलू, व्यावसायिक और औद्योगिक, सब पर। इसका क़ानूनी आधार उत्तर प्रदेश
        विद्युत नियामक आयोग की बहु-वर्षीय टैरिफ़ विनियमावली, 2025 है।</p>
        <p>ख़बरों में दो बातें दब गईं। पहली, यह <strong>टैरिफ़ बढ़ोतरी नहीं है</strong>: आपकी प्रति-यूनिट
        दरें नहीं बदलीं, और इसके लिए किसी नए टैरिफ़ आदेश की ज़रूरत नहीं पड़ी। दूसरी, यह अधिभार एक तय
        बीते महीने का है, जो बाद में बिल में आता है — इसीलिए मार्च का आँकड़ा जून के बिल पर उतरता है।</p>
      </section>

      <section class="seo-section">
        <h2>10% किस रकम पर लगता है</h2>
        <p>ज़्यादातर अनुमान यहीं ग़लत होते हैं। यह अधिभार आपके <strong>फ़िक्स्ड चार्ज और ऊर्जा प्रभार के
        जोड़</strong> का प्रतिशत है — बिल के कुल योग का नहीं, और करों के बाद वाली रकम का भी नहीं। इसके
        बाद बिजली शुल्क (ड्यूटी) बड़ी हो चुकी रकम पर लगता है, यानी ड्यूटी अधिभार पर भी चढ़ जाती है।</p>
        <p>हमारे बिल इंजन से DVVNL के एक शहरी घरेलू कनेक्शन (ST-10B, 2&nbsp;kW स्वीकृत भार, 30 दिन का
        चक्र, वित्त वर्ष 2026-27 की दरें) के लिए निकालने पर जून 2026 का अधिभार ऐसे पड़ता है:</p>
        <div class="comparison-table-wrapper">
          <table class="comparison-table">
            <thead><tr><th>यूनिट</th><th>FPPAS के बिना बिल</th><th>10% FPPAS के साथ</th><th>अतिरिक्त देना पड़ा</th></tr></thead>
            <tbody>
        ...
        <p>300 यूनिट वाली पंक्ति को ध्यान से देखिए। फ़िक्स्ड और ऊर्जा प्रभार मिलकर &#8377;1,945 होते हैं,
        इसलिए बिल पर अधिभार की लाइन <strong>&#8377;194.50</strong> लिखी आती है। लेकिन बिल बढ़ता है
        <strong>&#8377;204</strong> से। बचे हुए &#8377;10 उस 5% बिजली शुल्क के हैं, जो ख़ुद अधिभार पर
        लगता है। जो लाइन आपको दिख रही है, वही पूरी लागत नहीं है।</p>
        <p class="seo-cta-row"><a class="seo-cta" href="/#calculator">इस अधिभार के साथ अपना बिल निकालिए</a></p>
      </section>

      <section class="seo-section">
        <h2>ठीक 10% ही क्यों, और यह अच्छी ख़बर क्यों नहीं</h2>
        <p>दस प्रतिशत संयोग नहीं है — यह <strong>अधिकतम सीमा</strong> है। UPERC की विनियमावली तय करती है
        कि एक बिलिंग चक्र में ईंधन लागत का कितना उतार-चढ़ाव वसूला जा सकता है, और मार्च 2026 के लिए वसूला
        जाने वाला अंतर उस सीमा से बड़ा था।</p>
        <p>बची हुई रकम माफ़ नहीं होती। वह <strong>आगे के महीनों में ले जाई जाती है</strong>। इसलिए ठीक
        सीमा पर अटका हुआ महीना यह संकेत है कि व्यवस्था पर दबाव अब भी बना हुआ है, न कि यह कि वसूली पूरी
        हो गई। फ़रवरी 2026 भी इसी 10% की सीमा पर पहुँची थी।</p>
      </section>

      <section class="seo-section">
        <h2>यह घटता भी है, सिर्फ़ बढ़ता नहीं</h2>
        <p>यह अधिभार दोनों दिशाओं में हिसाब बराबर करता है। जब बिजली-ख़रीद लागत टैरिफ़ की मानी गई लागत से
        कम रहती है, तो FPPAS <strong>ऋणात्मक</strong> हो जाता है और आपको क्रेडिट मिलता है। हमने जिन सोलह
        महीनों की पुष्टि की है, उनमें दस में शुल्क लगा और छह में क्रेडिट मिला।</p>
        <p>जुलाई 2026 — यानी 10% वाले उछाल के ठीक अगला महीना — <strong>&minus;4.43%</strong> का क्रेडिट
        था। मई 2026 में &minus;1.52% था। जून की सुर्ख़ियों से जिसने यह नतीजा निकाला कि यूपी के बिल हमेशा
        के लिए 10% बढ़ गए, उसने ग़लत नतीजा निकाला।</p>
        <p>हमारा <a href="/fuel-surcharge/">ईंधन अधिभार ट्रैकर</a> यूपी की पूरी महीने-दर-महीने शृंखला
        रखता है, साथ में दिल्ली और राजस्थान की मौजूदा दरें भी।</p>
      </section>

      <section class="seo-section">
        <h2>अपने बिल पर इसे कहाँ ढूँढें</h2>
        <p><strong>FPPAS</strong>, <strong>FPPCA</strong>, <strong>ईंधन अधिभार</strong> या
        <strong>Fuel &amp; Power Purchase Adjustment</strong> नाम की लाइन देखिए — यह आमतौर पर ऊर्जा
        प्रभार के नीचे और बिजली शुल्क के ऊपर छपी होती है। अगर यह ड्यूटी वाली लाइन के ऊपर है, तो इस पर
        ड्यूटी लग रही है — और यही सही है।</p>
        <p>रकम जाँचने के लिए: अपना फ़िक्स्ड चार्ज और ऊर्जा प्रभार जोड़िए, उसका 10% निकालिए, और मिलाइए।
        अगर मेल न खाए तो संभावित वजहें हैं — आपके बिलिंग महीने की दर अलग होना, आधे महीने का आनुपातिक
        हिसाब, या सचमुच की कोई ग़लती। UPPCL को विस्तृत गणना अपनी वेबसाइट पर प्रकाशित करनी होती है।</p>
        <p>इसके बाद भी आँकड़ा ग़लत लगे तो
        <a href="/check-my-bill/">बिल अपलोड करके तुरंत स्व-जाँच कीजिए</a> — यह हर लाइन को अधिसूचित दरों
        से दोबारा जोड़कर बताता है कि फ़र्क़ कहाँ है।</p>
      </section>

      <section class="seo-section">
        <h2>इस पर आप क्या कर सकते हैं और क्या नहीं</h2>
        <p>ईंधन अधिभार से बाहर निकलने का विकल्प नहीं होता; यह नियामक से मंज़ूर पास-थ्रू है, डिस्कॉम की
        मनमर्ज़ी का शुल्क नहीं। आप जो कर सकते हैं, वह है उस आधार को घटाना जिस पर यह लगता है — क्योंकि
        प्रतिशत वाला अधिभार आपके फ़िक्स्ड और ऊर्जा प्रभार जितने हैं, उन्हीं को गुणा करता है।</p>
        <ul class="seo-list">
          <li><strong>अपना स्वीकृत भार जाँचिए।</strong> यूपी में फ़िक्स्ड चार्ज प्रति kW लगता है। जो भार
          आप इस्तेमाल नहीं करते, उस पर भी फ़िक्स्ड चार्ज लगता है, और फिर उसके ऊपर अधिभार भी — देखिए
          <a href="/hi/guides/reduce-fixed-charges-sanctioned-load/">फ़िक्स्ड चार्ज घटाना</a>।</li>
          <li><strong>स्लैब की सीमा पर नज़र रखिए।</strong> ज़्यादातर घरों के लिए आधार का बड़ा हिस्सा ऊर्जा
          प्रभार ही होता है, और यूपी के घरेलू स्लैब टेलीस्कोपिक हैं।</li>
          <li><strong>देर से भुगतान मत कीजिए।</strong> विलंब भुगतान अधिभार बिल के कुल योग पर लगता है, और
          उस योग में अब यह ईंधन अधिभार और उस पर लगी ड्यूटी दोनों शामिल हैं।</li>
        </ul>
      </section>`,
    faqsHi: [
      { q: 'क्या 10% ईंधन अधिभार एक टैरिफ़ बढ़ोतरी है?',
        a: 'नहीं। आपकी प्रति-यूनिट दरें और फ़िक्स्ड चार्ज नहीं बदले, और कोई नया टैरिफ़ आदेश जारी नहीं हुआ। FPPAS ईंधन और बिजली-ख़रीद लागत के उतार-चढ़ाव का अलग मासिक पास-थ्रू है, जो UPERC MYT विनियमावली 2025 के तहत लगता है। इसीलिए यह एक महीने 10% हो सकता है और अगले महीने क्रेडिट।' },
      { q: '300 यूनिट वाले यूपी बिल पर 10% FPPAS कितना जोड़ता है?',
        a: 'DVVNL के 2 kW शहरी घरेलू कनेक्शन पर लगभग ₹204। अधिभार की लाइन ख़ुद ₹194.50 है — फ़िक्स्ड और ऊर्जा प्रभार के ₹1,945 का 10% — और बाक़ी ₹10 उस 5% बिजली शुल्क के हैं जो अधिभार पर लगता है। बिल लगभग ₹2,042 से ₹2,246 हो जाता है।' },
      { q: 'क्या यह अधिभार मेरे पूरे बिल पर लगता है?',
        a: 'नहीं, और यही सबसे आम ग़लतफ़हमी है। यह सिर्फ़ फ़िक्स्ड चार्ज और ऊर्जा प्रभार पर लगता है, करों से पहले। यह बिजली शुल्क, बकाया या पिछली शेष राशि पर नहीं लगता — लेकिन ड्यूटी इस अधिभार पर ज़रूर लगती है।' },
      { q: 'क्या 10% हर महीने चलता रहेगा?',
        a: 'नहीं चला। जुलाई 2026 में −4.43% का क्रेडिट था और मई 2026 में −1.52%। दस प्रतिशत हर चक्र की नियामकीय अधिकतम सीमा है, सामान्य स्तर नहीं, और सीमा से ऊपर की रकम माफ़ होने के बजाय आगे के महीनों में ले जाई जाती है।' },
      { q: 'क्या मैं ईंधन अधिभार देने से मना कर सकता हूँ?',
        a: 'नहीं। यह राज्य नियामक से मंज़ूर है और वैध बिल का हिस्सा है, इसलिए इसे न देना बिल न देना ही माना जाता है। अगर आपको लगता है कि रकम ग़लत जोड़ी गई है, तो यह बिलिंग विवाद है — अपने डिस्कॉम को लिखित में दीजिए और FPPAS की गणना माँगिए, जिसे प्रकाशित करना UPPCL के लिए ज़रूरी है।' },
    ],
